// MessageStream.h -- BFME shadow shim. Verbatim ZH GeneralsMD header except one
// GameMessageArgumentDataType inserted after TEAMID: retail NetPacket
// writeGameMessageArgumentToPacket (0x00678430) and readGameMessageArgumentFromPacket
// (0x0067CE30) compare LOCATION..WIDECHAR as 7..11, never 6, and the matched
// NetGameCommandMsg_constructGameMessage.cpp already spells SQUADID at 6.
/*
...
enum GameMessageArgumentDataType 
{
	...
	ARGUMENTDATATYPE_SQUADID,			// BFME: one more type here, so LOCATION..UNKNOWN are one higher
