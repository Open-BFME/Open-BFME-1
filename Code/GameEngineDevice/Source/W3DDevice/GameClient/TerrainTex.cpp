...
//=============================================================================
// ??0TerrainTextureClass@@ present-unmatched
...
//=============================================================================
// ?update@TerrainTextureClass@@ present-unmatched
...
/** Sets the tile bitmap data into the texture.  The tiles are placed with 4
	...
	interpolated, you don't get seams between the tiles.  */
//=============================================================================
// ?updateFlat@TerrainTextureClass@@ present-unmatched
...
//=============================================================================
// ?Apply@TerrainTextureClass@@ present-unmatched
...
//=============================================================================
// ??0AlphaTerrainTextureClass@@ present-unmatched
...
(standard D3D setup, but beyond the scope of W3D). */
//=============================================================================
// ?Apply@LightMapTerrainTextureClass@@ present-unmatched
...
*		
*/
// ??0AlphaEdgeTextureClass@@ present-unmatched
...
// ?update@AlphaEdgeTextureClass@@ present-unmatched
...
// ?Apply@AlphaEdgeTextureClass@@ present-unmatched
...
// ??0CloudMapTerrainTextureClass@@ present-unmatched
...
(standard D3D setup, but beyond the scope of W3D). */
//=============================================================================
// ?Apply@CloudMapTerrainTextureClass@@ present-unmatched
...
understood by w3d. */
//=============================================================================
// ?restore@CloudMapTerrainTextureClass@@ present-unmatched
...
// ??0ScorchTextureClass@@ present-unmatched
...
(standard D3D setup, but beyond the scope of W3D). */
//=============================================================================
// ?Apply@ScorchTextureClass@@ present-unmatched
