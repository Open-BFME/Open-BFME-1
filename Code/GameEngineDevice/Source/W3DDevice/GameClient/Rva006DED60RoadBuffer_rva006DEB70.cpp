...
// Retail 0x006DEB70, the reset the terrain calls on its +0x30B4 child (constructor 0x006DED60),
// uses the same resource-reference shape and STLport
...
void Rva006DED60RoadBuffer::rva006DEB70()
{
	for (Int i = 0; i < 10; ++i)
		m_roadSets[i].clear();
