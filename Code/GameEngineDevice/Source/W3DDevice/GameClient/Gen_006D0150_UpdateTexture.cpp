...
// Retail 0x006D0150 is the one-argument texture-name refresh on the
// BFME height-map terrain subobject.  The paired 0x006D0280 body has the
// same operation with the second terrain slot shifted by four bytes.
...
static inline void Gen006D0150AssignTexture(
...
private:
	char m_padding00[0x3064];
	ShroudTexture m_texture;
	AsciiString m_textureName;
	char m_padding307c[0xc];
	AsciiString m_defaultTextureName;
};

void Gen006D0150Owner::updateTexture(AsciiString textureName)
{
