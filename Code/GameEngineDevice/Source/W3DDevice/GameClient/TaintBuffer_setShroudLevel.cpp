...
// stlport
// TaintBuffer::setShroudLevel, retail 0x00727610: update one BFME taint cell
// and its terrain pixel.
...
// ?setShroudLevel@TaintBuffer@@QAEXHHE_N@Z
void TaintBuffer::setShroudLevel(int x, int y,
