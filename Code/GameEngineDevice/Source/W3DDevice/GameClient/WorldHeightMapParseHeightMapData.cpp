...
// Open-BFME5: BFME WorldHeightMap::ParseHeightMapData at retail 0x0074ECD0.
// Identity: the non-logical branch of the stream loader 0x0074ACB0 registers
// "HeightMapData" through 0x0074A2C0, whose vtable 0x01121AF0 slot 1 reaches
// 0x0074FF10 -> ILT 0x00012229 -> this body; the logical-only branch reaches
// ParseSizeOnly (0x0074EF50) through 0x0074A3B0 instead.
...
// operator new[] 0x00881F70 and scalar delete 0x00881EB0 for the temporary
// byte buffer.
...
{
	protected:
	Bool ParseHeightMapData(DataChunkInput &file, DataChunkInfo *info);
...
// ?ParseHeightMapData@WorldHeightMap@@IAE_NAAVDataChunkInput@@PAUDataChunkInfo@@@Z
Bool WorldHeightMap::ParseHeightMapData(DataChunkInput &file, DataChunkInfo *info)
{
	Int numBorders;
	Int i, j;
	Int sample;
