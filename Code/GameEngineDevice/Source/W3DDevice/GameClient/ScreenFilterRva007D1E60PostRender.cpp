// cl: /DNDEBUG /MD
// Retail 0x007D1610: Rva007D1E60::postRender.
// The BFME filter wrapper forwards a fourth Coord2D* display-size argument;
// This address-qualified owner is tied to ctor 0x007D1E60 and vtable 0x011289B0 slot 3;
// the ScreenBWFilterDOT3 implementation is the semantic source for this body.
...
class Rva007D1E60 : public ScreenBWFilter
{
public:
	virtual Int init();
	virtual Int shutdown();
...
// ?postRender@Rva007D1E60@@UAE_NW4FilterModes@@AAUCoord2D@@AA_NPAU3@@Z
Bool Rva007D1E60::postRender(FilterModes mode, Coord2D &scrollDelta,
	Bool &doExtraRender, Coord2D *displaySize)
{
	...
	unsigned int currentFade =
		((Int)((g_bfmeDefaultBU - Rva007D1E60FadeValue) * g_bfmeScaleB3) << 24) |
		0x00ffffff;
