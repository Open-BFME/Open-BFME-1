// Retail 0x0073C970 -- W3DView::cameraUpdateOneFrame.
//
...
// under the flag at +0x204.  The four per-frame easers of that run --
...
// and what the body provably does: blend one Real field (+0x70) from start to
// end over m_numFrames with the ParabolicEase at +0x1FC.
...
void W3DView::cameraUpdateOneFrame(void)
{
	m_curFrame++;
