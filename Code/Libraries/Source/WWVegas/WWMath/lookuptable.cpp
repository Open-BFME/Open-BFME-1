// cl: /DNDEBUG /ICode/Libraries/Source/WWVegas/WWLib /ICode/Libraries/Source/WWVegas/WWSaveLoad /Isrc/w3d
/*
...
**
***********************************************************************************************/
// ?LookupTableClass::LookupTableClass present-unmatched
...
// ?LookupTableClass::Init present-unmatched
...
**
***********************************************************************************************/
// ?LookupTableMgrClass::Init present-unmatched
...
// ?LookupTableMgrClass::Shutdown present-unmatched
void LookupTableMgrClass::Shutdown(void)
{
	Reset();
}

// ?LookupTableMgrClass::Reset present-unmatched
...
// ?LookupTableMgrClass::Add_Table present-unmatched
bool LookupTableMgrClass::Add_Table(LookupTableClass * table)
{
	return Tables.Add(table);
}

// ?LookupTableMgrClass::Remove_Table present-unmatched
bool LookupTableMgrClass::Remove_Table(LookupTableClass * table)
{
	return Tables.Remove(table);
}

// ?LookupTableMgrClass::Get_Table present-unmatched
