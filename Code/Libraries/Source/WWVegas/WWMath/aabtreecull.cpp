...
**
*************************************************************************/
// ??0AABTreeCullSystemClass@@ present-unmatched
...
// ??1AABTreeCullSystemClass@@ present-unmatched
AABTreeCullSystemClass::~AABTreeCullSystemClass(void)
{
...
// ?Add_Object_Internal@AABTreeCullSystemClass@@ present-unmatched
...
// ?Remove_Object_Internal@AABTreeCullSystemClass@@ present-unmatched
...
// ?Update_Culling@AABTreeCullSystemClass@@ present-unmatched
...
// ?Collect_Objects@AABTreeCullSystemClass@@ present-unmatched
...
// ?Partition_Node_Count@AABTreeCullSystemClass@@ present-unmatched
int AABTreeCullSystemClass::Partition_Node_Count(void) const
{
	return Partition_Node_Count_Recursive(RootNode);
}

// ?Partition_Tree_Depth@AABTreeCullSystemClass@@ present-unmatched
...
// ?Object_Count@AABTreeCullSystemClass@@ present-unmatched
int AABTreeCullSystemClass::Object_Count(void) const
{
	return ObjectCount;
}

// ?Partition_Node_Count_Recursive@AABTreeCullSystemClass@@ present-unmatched
...
// ?Partition_Tree_Depth_Recursive@AABTreeCullSystemClass@@ present-unmatched
...
// ?Add_Object_Recursive@AABTreeCullSystemClass@@ present-unmatched
...
// ?Add_Loaded_Object@AABTreeCullSystemClass@@ present-unmatched
...
// ?Re_Partition@AABTreeCullSystemClass@@ present-unmatched
...
// ?Update_Bounding_Boxes@AABTreeCullSystemClass@@ present-unmatched
void AABTreeCullSystemClass::Update_Bounding_Boxes(void)
{
	Update_Bounding_Boxes_Recursive(RootNode);
}

// ?Get_Bounding_Box@AABTreeCullSystemClass@@ present-unmatched
...
// ?Get_Node_Bounds@AABTreeCullSystemClass@@ present-unmatched
...
// ?Reset_Statistics@AABTreeCullSystemClass@@ present-unmatched
...
// ?Get_Statistics@AABTreeCullSystemClass@@ present-unmatched
const AABTreeCullSystemClass::StatsStruct & AABTreeCullSystemClass::Get_Statistics(void)
{
	return Stats;
}

// ?Collect_Objects_Recursive@AABTreeCullSystemClass@@ present-unmatched
...
// ?Update_Bounding_Boxes_Recursive@AABTreeCullSystemClass@@ present-unmatched
...
// ?Load@AABTreeCullSystemClass@@ present-unmatched
...
// ?Load_Nodes@AABTreeCullSystemClass@@ present-unmatched
...
// ?Save@AABTreeCullSystemClass@@ present-unmatched
...
// ?Save_Nodes@AABTreeCullSystemClass@@ present-unmatched
...
// ?Load_Object_Linkage@AABTreeCullSystemClass@@ present-unmatched
...
// ?Save_Object_Linkage@AABTreeCullSystemClass@@ present-unmatched
...
// ?Re_Index_Nodes@AABTreeCullSystemClass@@ present-unmatched
...
// ?Re_Index_Nodes_Recursive@AABTreeCullSystemClass@@ present-unmatched
...
**
*************************************************************************/
// ??0AABTreeNodeClass@@ present-unmatched
...
// ??1AABTreeNodeClass@@ present-unmatched
AABTreeNodeClass::~AABTreeNodeClass(void)
{
...
// ?Compute_Bounding_Box@AABTreeNodeClass@@ present-unmatched
...
// ?Compute_Local_Bounding_Box@AABTreeNodeClass@@ present-unmatched
...
// ?Compute_Volume@AABTreeNodeClass@@ present-unmatched
float AABTreeNodeClass::Compute_Volume(void)
{
	return Box.Volume();
}

// ?Add_Object@AABTreeNodeClass@@ present-unmatched
...
// ?Remove_Object@AABTreeNodeClass@@ present-unmatched
...
// ?Transfer_Objects@AABTreeNodeClass@@ present-unmatched
...
// ?Object_Count@AABTreeNodeClass@@ present-unmatched
...
// ?Peek_Object@AABTreeNodeClass@@ present-unmatched
...
// ?Partition@AABTreeNodeClass@@ present-unmatched
...
// ?Split_Objects@AABTreeNodeClass@@ present-unmatched
...
// ?Reset@AABTreeIterator@@QAEXXZ present-unmatched
void AABTreeIterator::Reset(void)
{
	CurNodeIndex = 0;
}

// ?Enter_Parent@AABTreeIterator@@ present-unmatched
...
// ?Enter_Sibling@AABTreeIterator@@ present-unmatched
...
// ?Has_Front_Child@AABTreeIterator@@ present-unmatched
...
// ?Enter_Front_Child@AABTreeIterator@@ present-unmatched
...
// ?Has_Back_Child@AABTreeIterator@@ present-unmatched
...
// ?Enter_Back_Child@AABTreeIterator@@ present-unmatched
...
// ?Get_Current_Node_Index@AABTreeIterator@@ present-unmatched
int AABTreeIterator::Get_Current_Node_Index(void)
{
	return CurNodeIndex;
}

// ?Get_Current_Box@AABTreeIterator@@ present-unmatched
void AABTreeIterator::Get_Current_Box(AABoxClass * set_box)
{
	Tree->Get_Node_Bounds(CurNodeIndex,set_box);	
}

// ?validate@AABTreeIterator@@ present-unmatched
