// cl: /DNDEBUG /ICode/Libraries/Source/WWVegas/WWLib /Isrc/w3d
/*
 ...
 *   2/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// Init_From_Box_Points and Init_Random (below) were dead-code-eliminated from
// the retail binary -- nothing in the shipped game calls them. Init_From_Box_Points
// is kept because compiling it is what instantiates the inline
// Matrix3(Vector3,Vector3,Vector3) constructor at 0x5F6910, which DOES survive and
// byte-matches; removing this function removes that constructor from the object and
// breaks its match. The markers below give the declared-unmatched hook their real
// decorated names (their functions.csv rows are status=unmatched, address 0, noted).
// ?Init_From_Box_Points@OBBoxClass@@QAEXPAVVector3@@H@Z absent-from-retail
 ...
 *   4/21/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Init_Random@OBBoxClass@@QAEXMM@Z absent-from-retail
