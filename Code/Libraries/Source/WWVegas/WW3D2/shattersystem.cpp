...
**
***********************************************************************************************/
// ??0MeshMtlParamsClass@@QAE@PAVMeshModelClass@@@Z present-unmatched
...
// ??1MeshMtlParamsClass@@QAE@XZ present-unmatched
...
**
***********************************************************************************************/
// ??0VertexClass@@ present-unmatched
...
// ??4VertexClass@@QAEAAV0@ABV0@@Z present-unmatched
...
// ?Which_Side@VertexClass@@QBEHABVPlaneClass@@@Z present-unmatched
...
**
***********************************************************************************************/
// ??0PolygonClass@@ present-unmatched
...
// ??4PolygonClass@@QAEAAV0@ABV0@@Z present-unmatched
...
// ?Compute_Plane@PolygonClass@@QAEXXZ present-unmatched
...
// ?Which_Side@PolygonClass@@QBEHABVPlaneClass@@@Z present-unmatched
...
// ?Split@PolygonClass@@QBEXABVPlaneClass@@AAV1@1@Z present-unmatched
...
// ?Is_Degenerate@PolygonClass@@QAE_NXZ present-unmatched
...
// ?Salvage_Degenerate@PolygonClass@@QAE_NXZ present-unmatched
...
// ??0BSPClass@@QAE@PAVHTreeClass@@HAAH@Z present-unmatched
...
// ??1BSPClass@@QAE@XZ present-unmatched
...
// ?Set_Plane_From_Transform@BSPClass@@IAEXABVMatrix3D@@@Z present-unmatched
void BSPClass::Set_Plane_From_Transform(const Matrix3D & tm)
{
	Plane.Set(tm.Get_Z_Vector(),tm.Get_Translation());
}

// ?Clip_Polygon@BSPClass@@QAEXABVPolygonClass@@@Z present-unmatched
...
**
***********************************************************************************************/
// ?Init@ShatterSystem@@SAXXZ present-unmatched
...
// ?Shutdown@ShatterSystem@@SAXXZ present-unmatched
...
// ?Shatter_Mesh@ShatterSystem@@SAXPAVMeshClass@@ABVVector3@@1@Z present-unmatched
...
// ?Get_Fragment_Count@ShatterSystem@@SAHXZ present-unmatched
int ShatterSystem::Get_Fragment_Count(void)
{
	return MeshFragments.Count();
}

// ?Get_Fragment@ShatterSystem@@SAPAVRenderObjClass@@H@Z present-unmatched
...
// ?Peek_Fragment@ShatterSystem@@SAPAVRenderObjClass@@H@Z present-unmatched
RenderObjClass * ShatterSystem::Peek_Fragment(int fragment_index)
{
	return MeshFragments[fragment_index];
}

// ?Release_Fragments@ShatterSystem@@SAXXZ present-unmatched
...
// ?Reset_Clip_Pools@ShatterSystem@@KAXXZ present-unmatched
