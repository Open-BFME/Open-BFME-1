 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ??0SphereRenderObjClass@@ present-unmatched
...
// ??1SphereRenderObjClass@@UAE@XZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ??4SphereRenderObjClass@@QAEAAV0@ABV0@@Z present-unmatched
 ...
 *=============================================================================================*/
// ?Generate_Shared_Mesh_Arrays@SphereRenderObjClass@@KAXABUAlphaVectorStruct@@@Z present-unmatched
...
// ?calculate_value_array@SphereRenderObjClass@@IBEXMPAM@Z present-unmatched
 ...
 *   03/08/00    pds : Created.                                                                *
 *=============================================================================================*/
// ?Init_Material@SphereRenderObjClass@@IAEXXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Num_Polys@SphereRenderObjClass@@UBEHXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Texture@SphereRenderObjClass@@QAEXPAVTextureClass@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Name@SphereRenderObjClass@@UBEPBDXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Name@SphereRenderObjClass@@UAEXPBD@Z present-unmatched
 ...
 *=============================================================================================*/
// ?render_sphere@SphereRenderObjClass@@IAEXXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?vis_render_sphere@SphereRenderObjClass@@IAEXAAVSpecialRenderInfoClass@@ABVVector3@@1@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Clone@SphereRenderObjClass@@UBEPAVRenderObjClass@@XZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Class_ID@SphereRenderObjClass@@UBEHXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Render@SphereRenderObjClass@@UAEXAAVRenderInfoClass@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Special_Render@SphereRenderObjClass@@UAEXAAVSpecialRenderInfoClass@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Transform@SphereRenderObjClass@@UAEXABVMatrix3D@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Position@SphereRenderObjClass@@UAEXABVVector3@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?update_cached_box@SphereRenderObjClass@@MAEXXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Obj_Space_Bounding_Sphere@SphereRenderObjClass@@UBEXAAVSphereClass@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Obj_Space_Bounding_Box@SphereRenderObjClass@@UBEXAAVAABoxClass@@@Z present-unmatched
...
// ?Prepare_LOD@SphereRenderObjClass@@UAEXAAVCameraClass@@@Z present-unmatched
...
// ?Increment_LOD@SphereRenderObjClass@@UAEXXZ present-unmatched
void SphereRenderObjClass::Increment_LOD(void)
{
	if (CurrentLOD < SPHERE_NUM_LOD) CurrentLOD++;
}

// ?Decrement_LOD@SphereRenderObjClass@@UAEXXZ present-unmatched
...
// ?Get_Value@SphereRenderObjClass@@UBEMXZ present-unmatched
float SphereRenderObjClass::Get_Value(void) const
{
	return Value[CurrentLOD];
}

// ?Get_Post_Increment_Value@SphereRenderObjClass@@UBEMXZ present-unmatched
float SphereRenderObjClass::Get_Post_Increment_Value(void) const
{
	return Value[CurrentLOD + 1];
}

// ?Set_LOD_Level@SphereRenderObjClass@@UAEXH@Z present-unmatched
...
// ?Get_LOD_Level@SphereRenderObjClass@@UBEHXZ present-unmatched
int SphereRenderObjClass::Get_LOD_Level(void) const
{
	return CurrentLOD;
}

// ?Get_LOD_Count@SphereRenderObjClass@@UBEHXZ present-unmatched
int SphereRenderObjClass::Get_LOD_Count(void) const
{
	return SPHERE_NUM_LOD + 1;	// SPHERE_NUM_LOD doesn't include the null LOD
}

// ?Calculate_Cost_Value_Arrays@SphereRenderObjClass@@UBEHMPAM0@Z present-unmatched
 ...
 *   7/01/02    NH : Created.                                                                  *
 *=============================================================================================*/
// ?Scale@SphereRenderObjClass@@ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Update_Cached_Bounding_Volumes@SphereRenderObjClass@@MBEXXZ present-unmatched
 ...
 *=============================================================================================*/
// ?Get_Default_Color@SphereRenderObjClass@@QBE?AVVector3@@XZ present-unmatched
 ...
 *   3/13/2000    pds : Created.                                                               *
 *=============================================================================================*/
// ?Get_Default_Alpha@SphereRenderObjClass@@QBEMXZ present-unmatched
 ...
 *   3/13/2000    pds : Created.                                                               *
 *=============================================================================================*/
// ?Get_Default_Scale@SphereRenderObjClass@@QBE?AVVector3@@XZ present-unmatched
 ...
 *   3/13/2000    pds : Created.                                                               *
 *=============================================================================================*/
// ?Get_Default_Vector@SphereRenderObjClass@@QBE?AUAlphaVectorStruct@@XZ present-unmatched
 ...
 *   4/04/00    pds : Created.                                                                 *
 *=============================================================================================*/
// ?Update_On_Visibilty@SphereRenderObjClass@@IAEXXZ present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?animate@SphereRenderObjClass@@IAEXXZ present-unmatched
...
*/
// ?Load_W3D@SphereLoaderClass@@UAEPAVPrototypeClass@@AAVChunkLoadClass@@@Z present-unmatched
...
*/
// ??0SpherePrototypeClass@@ present-unmatched
...
// ??1SpherePrototypeClass@@MAE@XZ present-unmatched
SpherePrototypeClass::~SpherePrototypeClass (void)
{
	return ;
}
...
// ?Load@SpherePrototypeClass@@QAE_NAAVChunkLoadClass@@@Z present-unmatched
...
// ?Save@SpherePrototypeClass@@QAE_NAAVChunkSaveClass@@@Z present-unmatched
...
// ?Get_Name@SpherePrototypeClass@@UBEPBDXZ present-unmatched
const char * SpherePrototypeClass::Get_Name(void) const
{
	return Definition.Name;
}

// ?Get_Class_ID@SpherePrototypeClass@@UBEHXZ present-unmatched
int SpherePrototypeClass::Get_Class_ID(void) const
{
	return RenderObjClass::CLASSID_SPHERE;
}
	
// ?Create@SpherePrototypeClass@@UAEPAVRenderObjClass@@XZ present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ??0SphereMeshClass@@ present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Alpha_Vector@SphereMeshClass@@QAEXABUAlphaVectorStruct@@_N11@Z present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?Generate@SphereMeshClass@@QAEXMHH@Z present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ??1SphereMeshClass@@QAE@XZ present-unmatched
SphereMeshClass::~SphereMeshClass(void)
{
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?Free@SphereMeshClass@@AAEXXZ present-unmatched
