 ...
 *=============================================================================================*/
// ?read_dcg@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z matched 770 bytes (Open-BFME5)
__declspec(naked) WW3DErrorType MeshModelClass::read_dcg(ChunkLoadClass &, MeshLoadContextClass *)
{
	__asm
	{
		__emit 0x55;
