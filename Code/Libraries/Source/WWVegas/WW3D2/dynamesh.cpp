...
// ??0DynamicMeshModel@@ present-unmatched
...
// ??1DynamicMeshModel@@UAE@XZ present-unmatched
...
// ?Compute_Plane_Equations@DynamicMeshModel@@UAEXXZ present-unmatched
...
// ?Compute_Vertex_Normals@DynamicMeshModel@@UAEXXZ present-unmatched
...
// ?Compute_Bounds@DynamicMeshModel@@UAEXPAVVector3@@@Z present-unmatched
...
// ?Reset@DynamicMeshModel@@QAEXXZ present-unmatched
...
// ?Render@DynamicMeshModel@@ present-unmatched
...
// ?Initialize_Texture_Array@DynamicMeshModel@@QAEXHHPAVTextureClass@@@Z present-unmatched
...
// ?Initialize_Material_Array@DynamicMeshModel@@QAEXHPAVVertexMaterialClass@@@Z present-unmatched
...
// ?Render@DynamicMeshClass@@UAEXAAVRenderInfoClass@@@Z present-unmatched
...
// ?End_Vertex@DynamicMeshClass@@QAE_NXZ present-unmatched
...
**
*******************************************************************/
// ??0DynamicMeshClass@@ present-unmatched
...
// ?Resize@DynamicMeshClass@@QAEXHH@Z present-unmatched
...
// ??1DynamicMeshClass@@UAE@XZ present-unmatched
DynamicMeshClass::~DynamicMeshClass()
{	
	REF_PTR_RELEASE(Model);
}

// ?Clone@DynamicMeshClass@@UBEPAVRenderObjClass@@XZ present-unmatched
RenderObjClass * DynamicMeshClass::Clone(void) const
{
	return NEW_REF(DynamicMeshClass, (*this));
}

// ?Location@DynamicMeshClass@@UAEXMMM@Z present-unmatched
...
*/
// ?Move_Vertex@DynamicMeshClass@@UAEXHMMM@Z present-unmatched
...
** Get a vertex value.
*/
// ?Get_Vertex@DynamicMeshClass@@UAEXHAAM00@Z present-unmatched
...
*/
// ?Translate_Vertices@DynamicMeshClass@@QAEXABVVector3@@@Z present-unmatched
...
// ?Set_Vertex_Material@DynamicMeshClass@@ present-unmatched
...
// ?Set_Texture@DynamicMeshClass@@ present-unmatched
...
// ?Location@DynamicScreenMeshClass@@UAEXMMM@Z present-unmatched
...
// For moving a vertex after the DynaMesh has already been created.
// ?Move_Vertex@DynamicScreenMeshClass@@UAEXHMMM@Z present-unmatched
...
// Set position
// ?Set_Position@DynamicScreenMeshClass@@UAEXABVVector3@@@Z present-unmatched
void DynamicScreenMeshClass::Set_Position(const Vector3 &v)	
{ 
	DynamicMeshClass::Set_Position(Vector3(v.X * 2, -(v.Y * 2 * Aspect), 0)); 
}

// ?Reset@DynamicScreenMeshClass@@UAEXXZ present-unmatched
