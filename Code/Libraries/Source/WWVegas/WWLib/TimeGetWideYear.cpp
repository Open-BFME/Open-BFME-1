...
// stlport
// Focused wide time_get year specialization with retail call boundaries.
#define private public
#include <locale>
#undef private

typedef _STL::istreambuf_iterator<wchar_t, _STL::char_traits<wchar_t> >
	BfmeWideYearIterator;

template <>
BfmeWideYearIterator
_STL::time_get<wchar_t, BfmeWideYearIterator>::do_get_year(
	BfmeWideYearIterator first, BfmeWideYearIterator last,
