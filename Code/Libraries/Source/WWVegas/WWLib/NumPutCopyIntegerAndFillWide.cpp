...
// stlport
// STLport 4.5.3 __copy_integer_and_fill specialization for wchar_t and
// ostreambuf_iterator<wchar_t>, retail 0x00835C40. The explicit inlining
...
template WideOutputIter __cdecl
__copy_integer_and_fill<BfmeWchar, WideOutputIter>(const BfmeWchar *,
	ptrdiff_t, WideOutputIter, ios_base::fmtflags, streamsize,
	BfmeWchar, BfmeWchar, BfmeWchar);
