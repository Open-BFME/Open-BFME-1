// cl: /O2 /MD
// STLport 4.5.3 decimal parser body at retail 0x008396D0.
// The retail ABI is a raw wide-character pointer range and a long-double result
// (VC7 represents long double in the same eight-byte x87 format as double):
// the first and last iterator references point at two-byte code units, while
// the result is written with fstp qword.  This is kept separate from the
// fabricated narrow iterator/unsigned-long label formerly attached to 0x00839600.
...
namespace _STL
{
	...
	typedef unsigned short * WidePointer;
	template bool __get_integer<WidePointer, long double>(
		WidePointer &, WidePointer &, int, long double &, int, bool, char,
