...
// stlport
//
// STLport 4.5.3 wide ostreambuf_iterator num_put::do_put(long long).
// The retail body is slot 3 of the vtable at VA 0x0112EA2C, whose RTTI
...
typedef ostreambuf_iterator<wchar_t, char_traits<wchar_t> >
	BfmeWideLongLongPutIterator;

template <>
BfmeWideLongLongPutIterator
num_put<wchar_t, BfmeWideLongLongPutIterator>::do_put(
	BfmeWideLongLongPutIterator output, ios_base &stream, wchar_t fill,
