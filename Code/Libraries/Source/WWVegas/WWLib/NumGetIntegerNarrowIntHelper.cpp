// cl: /O2 /MD
// STLport 4.5.3 narrow signed-int __get_integer at retail 0x008392A0.
// The matched __get_decimal_integer caller at 0x008391D0 and the narrow
// iterator layout identify this specialization. The wide signed-int sibling
// supplies the same algorithm, with the narrow cache ending at offset +6.
...
namespace _STL
{
	...
	template bool __get_integer<NarrowIterator, int>(
		NarrowIterator &, NarrowIterator &, int, int &, int, bool, char,
