...
// stlport
//
// STLport 4.5.3 narrow ostreambuf_iterator num_put::do_put(unsigned long).
// The retail body is slot 6 of the vtable at VA 0x0112E9B0, whose RTTI
// complete object locator names the narrow num_put, and it calls the
// __write_integer_backward instantiation at 0x00835800 whose value type is
// unsigned long.  It formats into a local 64-byte buffer and then applies
...
typedef ostreambuf_iterator<char, char_traits<char> >
	BfmeNarrowUnsignedLongPutIterator;

template <>
BfmeNarrowUnsignedLongPutIterator
num_put<char, BfmeNarrowUnsignedLongPutIterator>::do_put(
	BfmeNarrowUnsignedLongPutIterator output, ios_base &stream, char fill,
