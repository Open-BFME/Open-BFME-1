...
// the four-argument form, at retail 0x0033F690.  Near-twin of
...
private:
	...
	friend struct ::BfmeRbTreeInsertRva0033F690AnchorHelper;
};
...
struct Rva0033F690Value
{
	unsigned char m_data[8];
};

typedef _STL::pair<const Rva0019BC70Key, Rva0033F690Value> Rva0033F690Pair;

typedef _STL::_Rb_tree<Rva0019BC70Key, Rva0033F690Pair,
	_STL::_Select1st<Rva0033F690Pair>, _STL::less<Rva0019BC70Key>,
	_STL::allocator<Rva0033F690Pair> > Rva0033F690Tree;

// retail 0x0033F690
Rva0033F690Tree::iterator BfmeRbTreeInsertRva0033F690( Rva0033F690Tree *tree,
	_STL::_Rb_tree_node_base *x, _STL::_Rb_tree_node_base *y,
	const Rva0033F690Pair &v, _STL::_Rb_tree_node_base *w )
{
	return BfmeRbTreeInsertRva0033F690AnchorHelper::run( tree, x, y, v, w );
}
