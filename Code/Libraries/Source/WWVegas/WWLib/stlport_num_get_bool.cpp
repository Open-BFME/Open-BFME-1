...
// The retail body is slot 11 of the vtable at VA 0x0112E97C, whose RTTI
// complete object locator names the narrow num_get.  MSVC writes an overload
// set into the vtable backwards, so slot 11 holds the first do_get declared in
// vendor/stlport/stl/_num_get.h and that one reads a bool.
//
// The body itself is the vendored template in vendor/stlport/stl/_num_get.c.
...
num_get<char, BfmeNarrowGetIterator>::do_get(BfmeNarrowGetIterator,
