...
// stlport
// STLport 4.5.3 num_get<wchar_t, istreambuf_iterator<wchar_t>>::do_get(double&)
// at 0x0083A9E0 (247B).  The retail body calls the matched wide
// _M_read_float<unsigned short>, the matched global bfmeGo1128B double
