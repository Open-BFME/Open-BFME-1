...
// stlport
// STLport 4.5.3 __get_decimal_integer<char> @ 0x000083B0D0 (205B): the unsigned int instantiation, byte-twin of stlport_decimal_integer.cpp (tools/twin_scan.py); its __get_integer callee is the dump at 0x000083B1A0.
...
namespace _STL
{
	...
	template bool __get_decimal_integer<NarrowIterator, unsigned int>(
		NarrowIterator &, NarrowIterator &, unsigned int &);
}
