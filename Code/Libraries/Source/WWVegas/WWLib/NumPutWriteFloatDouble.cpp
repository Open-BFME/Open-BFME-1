...
// stlport
// STLport 4.6.2 double floating-point writer for BFME's string ABI.
...
static char *bfmeEcvt(double value, int digits,
	int *decimal, int *negative, char *)
{
	return _ecvt(value, digits, decimal, negative);
}

static char *bfmeFcvt(double value, int digits,
	int *decimal, int *negative, char *)
{
