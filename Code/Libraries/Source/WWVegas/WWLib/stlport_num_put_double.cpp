...
// are do_put overloads of those two classes.  Slot 5 of each table calls the
// _M_do_put_float instantiation whose value type is double, which is the
