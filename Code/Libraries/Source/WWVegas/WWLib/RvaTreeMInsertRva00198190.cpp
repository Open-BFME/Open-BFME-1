...
// the four-argument form, at retail 0x00198190.  Near-twin of
...
private:
	...
	friend struct ::BfmeRbTreeInsertRva00198190AnchorHelper;
};
...
// retail 0x00198190
Rva00198190Tree::iterator BfmeRbTreeInsertRva00198190( Rva00198190Tree *tree,
	_STL::_Rb_tree_node_base *x, _STL::_Rb_tree_node_base *y,
	const Rva00198190Pair &v, _STL::_Rb_tree_node_base *w )
{
	return BfmeRbTreeInsertRva00198190AnchorHelper::run( tree, x, y, v, w );
}
