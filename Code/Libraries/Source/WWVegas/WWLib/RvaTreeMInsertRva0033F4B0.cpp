...
// the four-argument form, at retail 0x0033F4B0.  Near-twin of
// RvaTreeMInsertArmorMap00140EA0.cpp: node = 16-byte base + 0x10-byte
...
private:
	...
	friend struct ::BfmeRbTreeInsertRva0033F4B0AnchorHelper;
};
...
struct Rva0033F4B0Value
{
	unsigned char m_data[12];
};

typedef _STL::pair<const Rva0019BC70Key, Rva0033F4B0Value> Rva0033F4B0Pair;

typedef _STL::_Rb_tree<Rva0019BC70Key, Rva0033F4B0Pair,
	_STL::_Select1st<Rva0033F4B0Pair>, _STL::less<Rva0019BC70Key>,
	_STL::allocator<Rva0033F4B0Pair> > Rva0033F4B0Tree;

// retail 0x0033F4B0
Rva0033F4B0Tree::iterator BfmeRbTreeInsertRva0033F4B0( Rva0033F4B0Tree *tree,
	_STL::_Rb_tree_node_base *x, _STL::_Rb_tree_node_base *y,
	const Rva0033F4B0Pair &v, _STL::_Rb_tree_node_base *w )
{
	return BfmeRbTreeInsertRva0033F4B0AnchorHelper::run( tree, x, y, v, w );
}
