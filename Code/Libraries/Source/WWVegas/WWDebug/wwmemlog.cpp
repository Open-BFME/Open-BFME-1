...
// ?Get_Category_Count@WWMemoryLogClass@@SAHXZ present-unmatched
...
// ?Push_Active_Category@WWMemoryLogClass@@KAXH@Z present-unmatched
...
// ?Pop_Active_Category@WWMemoryLogClass@@KAXXZ present-unmatched
...
// ?Reset_Counters@WWMemoryLogClass@@SAXXZ present-unmatched
...
// ?Get_Allocate_Count@WWMemoryLogClass@@SAHXZ present-unmatched
...
// Return allocate count since last reset
// ?Get_Free_Count@WWMemoryLogClass@@SAHXZ present-unmatched
int WWMemoryLogClass::Get_Free_Count()
{
	return FreeCount;
}

// ?Init@WWMemoryLogClass@@SAXXZ present-unmatched
