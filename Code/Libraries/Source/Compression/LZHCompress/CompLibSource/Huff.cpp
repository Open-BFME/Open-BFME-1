...
// ??1HuffStat@@QAE@XZ present-unmatched -- ten bytes (`delete[]` through the
// vector-deleting stub), which retail holds in at least eleven places and none
// of them is attributable to this TU.
HuffStat::~HuffStat()
    {
    delete [] stat;
    }
