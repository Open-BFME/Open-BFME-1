// cl: /O2 /MD
// STLport 4.5.3 __copy_grouped_digits wide istreambuf_iterator @ 0x0083A7E0 (303B).
...
bool __get_fdigit_or_sep(unsigned short &c, unsigned short sep, const unsigned short *digits);
