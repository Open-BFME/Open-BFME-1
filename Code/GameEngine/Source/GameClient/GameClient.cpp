...
//-------------------------------------------------------------------------------------------------
// ?init@GameClient@@ present-unmatched
...
// ?update@GameClient@@ present-unmatched
...
observer, etc.*/
// ?updateFakeDrawables@GameClient@@ present-unmatched
...
// ?loadMap@GameClient@@ present-unmatched
...
// ?unloadMap@GameClient@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setTimeOfDay@GameClient@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?assignSelectedDrawablesToGroup@GameClient@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?selectDrawablesInGroup@GameClient@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?addTextBearingDrawable@GameClient@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?flushTextBearingDrawables@GameClient@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?evaluateContextCommand@GameClient@@ present-unmatched
...
// ?getRayEffectData@GameClient@@ present-unmatched
...
// ?removeFromRayEffects@GameClient@@ present-unmatched
...
// ?releaseShadows@GameClient@@ present-unmatched
...
// ?allocateShadows@GameClient@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadAssets@GameClient@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findTOCEntryById@GameClient@@ present-unmatched
 ...
 */
// ------------------------------------------------------------------------------------------------
// ?xfer@GameClient@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@GameClient@@ present-unmatched
