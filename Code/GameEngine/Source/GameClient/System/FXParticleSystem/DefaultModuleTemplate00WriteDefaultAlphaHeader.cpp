...
// The ILT at 0x00008094 names this 337-byte DefaultModuleTemplate alpha
// header writer. Retail selects module category 2 for the header key.
...
// ?writeDefaultAlphaHeader@FXParticleSystem@@YAXPBXPAVFile@@PAI@Z
namespace FXParticleSystem
{
void writeDefaultAlphaHeader(const void *self, File *file,
	unsigned int *flags)
{
	...
	reinterpret_cast<StreamWriter *>(&stream)->append(
		FXParticleSystem::GetKey(FXParticleSystem::MODULE_CATEGORY_ALPHA));
