...
// reverse/symbols.csv at ILT 0x0000C955 as ?handle@Gen0000C955@@QAEX_N@Z.
...
// upstream layout: reference/shims/nat/GameNetwork/GameSpy/PeerThread.h
class PeerRequest
{
public:
	PeerRequest();
...
// Pinned at ILT 0x0000C955 in reverse/symbols.csv; the retail body sits at
