...
// BfmeAptScreenOnlineCustomMatch::applySlotTeam, retail 0x0053D170.
...
bool BfmeAptScreenOnlineCustomMatch::applySlotTeam( GameSlot *slot, int team )
{
	if( !TheGameSpyInfo )
		return false;
	...
	{
		AsciiString options;
		options.format( AsciiString( "Team=%d" ), teamNumber );
