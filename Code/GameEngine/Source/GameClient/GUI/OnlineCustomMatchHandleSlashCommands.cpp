...
//
// BfmeAptScreenOnlineCustomMatch::handleSlashCommands, retail 0x00539E60,
// 473 bytes. Apt-hosted /host and /me only. Named by the thiscall at
// 0x0053A67F (chat-entry submit on this+0x194): copy the gadget text and
// call this; a false return falls through to GameSpyInfo sendChat +0xF8.
// String-anchored on "Hosting qr2:%d thread:%d", "host", "me".
...
bool BfmeAptScreenOnlineCustomMatch::handleSlashCommands( UnicodeString uText )
{
	AsciiString message;
