...
// FontSubstitution INI parser at 0x004779C0 writes -- reverse/symbols.csv pins
...
// looked green because reverse/symbols.csv carries an additive candidate
// `??4AsciiString@@QAEAAV0@ABV0@@Z,0x00887C90,folded with UnicodeString::set
// per-TU copy` alongside the real 0x0005C500 row in reverse/functions.csv, and
...
// Code/GameEngine/Source/GameClient/GUI/INIFontSubstitution.cpp; the
// Rva004779C0Vector spelling is the one reverse/symbols.csv already uses in
