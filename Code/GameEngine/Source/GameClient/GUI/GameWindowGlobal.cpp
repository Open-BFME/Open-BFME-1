...
/** draw image, coord are in screen and should be kepth within 
	* that box specified */
//=============================================================================
// ?winDrawImage@GameWindowManager@@UAEXPBVImage@@HHHHH@Z present-unmatched
...
//=============================================================================
// ?winFillRect@GameWindowManager@@UAEXHMHHHH@Z present-unmatched
...
//=============================================================================
// ?winOpenRect@GameWindowManager@@UAEXHMHHHH@Z present-unmatched
...
//=============================================================================
// ?winDrawLine@GameWindowManager@@UAEXHMHHHH@Z present-unmatched
...
//=============================================================================
// ?winFindImage@GameWindowManager@@UAEPBVImage@@PBD@Z present-unmatched
...
//=============================================================================
// ?winFormatText@GameWindowManager@@UAEXPAVGameFont@@VUnicodeString@@HHHHH@Z present-unmatched
...
//=============================================================================
// ?winGetTextSize@GameWindowManager@@UAEXPAVGameFont@@VUnicodeString@@PAH2H@Z present-unmatched
...
//=============================================================================
// ?winIsDigit@GameWindowManager@@UAEHH@Z present-unmatched
...
//=============================================================================
// ?winIsAscii@GameWindowManager@@UAEHH@Z present-unmatched
...
//=============================================================================
// ?winIsAlNum@GameWindowManager@@UAEHH@Z present-unmatched
