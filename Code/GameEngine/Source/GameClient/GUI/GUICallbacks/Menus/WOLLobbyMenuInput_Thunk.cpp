...
// pin in reverse/symbols.csv offers that address.  That failure predates this
...
// upstream values: reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Include/GameClient/GameWindow.h
enum { GWM_CHAR = 0x15 };
