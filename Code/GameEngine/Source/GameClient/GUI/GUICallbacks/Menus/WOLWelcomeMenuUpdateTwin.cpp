...
// INCLUDES ///////////////////////////////////////////////////////////////////////////////////////
// Open-BFME7: retail 0x0050CA80 (1164 bytes) is a byte twin of WOLWelcomeMenuUpdate
// compiled with STLport exceptions off; it cannot be the port TU itself (that one
// keeps its EH funclet rows), so this TU holds the whole menu source inside a
// namespace with the define, and only the update body is claimed.  Its file-local
// helpers and statics resolve to the retail copies through autopinned relocations.
