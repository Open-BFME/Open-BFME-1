...
// stlport
// Open-BFME: deque<PeerResponse>::_M_push_back_aux, retail 0x00648920 (214 B).
...
// same STLport growth body, sized for the 0x330-byte PeerResponse element
// (see Code/GameEngine/Source/GameNetwork/GameSpy/Thread/PeerResponseDequePopFront.cpp,
// which names the element from its own destructor). The destructor call goes
// through the ILT at 0x00044733 to the byte-identical ??1PeerResponse@@QAE@XZ
// body at 0x004DAC70; the copy ctor call goes through the ILT at 0x0001E74F to
// the still-dumped body at 0x004FB2E0; the map-reserve call goes through the
// ILT at 0x000040A2 to the shared _M_reallocate_map body at 0x00645C10.
