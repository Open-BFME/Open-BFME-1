...
/* Open-BFME7: retail 0x00861470 (108 bytes) is the reloc-masked byte twin of
   chatEnumChannelBansA (0x00860F80): the same send-and-wait shape with its own
   command string and filter (autopinned to the retail copies). */
int ciAddFilterRva00861470(CHAT,const char*,void*,void*);
void chatRva00861470A(CHAT chat, const char *channel, void *callback,
	void *param, int blocking)
{
	...
	ID = ciAddFilterRva00861470(chat, channel, callback, param);
