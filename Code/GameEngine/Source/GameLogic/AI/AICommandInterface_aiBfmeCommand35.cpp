...
// stlport
// Open-BFME: AICommandInterface command 0x35, retail 0x00153480, 219 bytes.
//
...
// (0x35 here, not 0x19). Address-derived name pending the real command
// enumerator/caller.
...
enum AICommandType { AICMD_BFME_35 = 0x35 };
