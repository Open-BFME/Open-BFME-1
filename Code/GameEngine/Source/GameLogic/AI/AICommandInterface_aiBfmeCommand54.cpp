...
// AICommandInterface_aiBfmeCommand19.cpp), retail 0x000FFB80, 219 bytes.
// Byte-identical shape; the only difference is the command number pushed
// before the AICommandParms ctor call: 0x36 (54) here instead of 0x19 (25).
...
enum AICommandType { AICMD_BFME_54 = 0x36 };
...
// address-derived: real ZH command name not recovered
