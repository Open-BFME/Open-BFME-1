...
// stlport
// Open-BFME: AICommandInterface::aiFacePosition, retail 0x002A7F40, 219 bytes.
// BFME's face-position command is 0x47 in this translation unit.
...
enum AICommandType { AICMD_FACE_POSITION = 0x47 };
