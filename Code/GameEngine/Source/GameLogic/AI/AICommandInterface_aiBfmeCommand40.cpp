...
// stlport
// Open-BFME: AICommandInterface command 0x40, retail 0x0025D270, 219 bytes.
//
...
// (0x40 here, not 0x19). Address-derived name pending the real command
// enumerator/caller.
...
enum AICommandType { AICMD_BFME_40 = 0x40 };
