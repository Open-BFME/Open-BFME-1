...
// Open-BFME: AICommandParmsStorage::store, retail 0x001805B0, 270 bytes.
// BFME keeps the team prototype name and owner name in adjacent storage
// strings, and its DamageInfo input begins four bytes later in storage than
// in the live command parameters.
