...
// stlport
// Open-BFME: AICommandInterface path-command, retail 0x00153120, 220 bytes.
//
// 220B twin of aiFollowExitProductionPath
// (AICommandInterface_aiFollowExitProductionPath.cpp, retail 0x00165C30):
// byte-identical build-parms/copy-path/set-object/aiDoCommand shape, only
// the AICMD constant differs (9 here, not 0x0A). Address-derived name
// pending the real command enumerator/caller.
...
enum AICommandType { AICMD_BFME_9 = 9 };
