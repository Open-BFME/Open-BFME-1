...
//-------------------------------------------------------------------------------------------------
// ?onObjectCreated@PhysicsBehavior@@UAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1PhysicsBehavior@@MAE@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setIgnoreCollisionsWith@PhysicsBehavior@@QAEXPBVObject@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isIgnoringCollisionsWith@PhysicsBehavior@@QBE_NW4ObjectID@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getAerodynamicFriction@PhysicsBehavior@@IBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getForwardFriction@PhysicsBehavior@@IBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getLateralFriction@PhysicsBehavior@@IBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getZFriction@PhysicsBehavior@@IBEMXZ present-unmatched
 ...
 */
// ?applyForce@PhysicsBehavior@@QAEXPBUCoord3D@@@Z present-unmatched
 ...
 */
// ?applyShock@PhysicsBehavior@@QAEXPBUCoord3D@@@Z present-unmatched
 ...
 */
// ?applyRandomRotation@PhysicsBehavior@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isMotive@PhysicsBehavior@@QBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?applyMotiveForce@PhysicsBehavior@@QAEXPBUCoord3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?resetDynamicPhysics@PhysicsBehavior@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?applyGravitationalForces@PhysicsBehavior@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?applyFrictionalForces@PhysicsBehavior@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?handleBounce@PhysicsBehavior@@IAE_NMMMPAUCoord3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setPitchRate@PhysicsBehavior@@QAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setRollRate@PhysicsBehavior@@QAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setYawRate@PhysicsBehavior@@QAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?applyYPRDamping@PhysicsBehavior@@IAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setBounceSound@PhysicsBehavior@@QAEXPBVAudioEventRTS@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calcSleepTime@PhysicsBehavior@@IBE?AW4UpdateSleepTime@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getVelocityMagnitude@PhysicsBehavior@@QBEMXZ present-unmatched
 ...
 */
// ?getForwardSpeed2D@PhysicsBehavior@@QBEMXZ present-unmatched
 ...
 * If velocity is opposite facing vector, the returned value will be negative.
 */
// ?getForwardSpeed3D@PhysicsBehavior@@QBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isCurrentlyOverlapped@PhysicsBehavior@@QBE_NPAVObject@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?wasPreviouslyOverlapped@PhysicsBehavior@@QBE_NPAVObject@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?scrubVelocityZ@PhysicsBehavior@@QAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?scrubVelocity2D@PhysicsBehavior@@QAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?addOverlap@PhysicsBehavior@@QAEXPAVObject@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?transferVelocityTo@PhysicsBehavior@@QBEXPAV1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?addVelocityTo@PhysicsBehavior@@QAEXPBUCoord3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAngles@PhysicsBehavior@@QAEXMMM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMass@PhysicsBehavior@@QBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doBounceSound@PhysicsBehavior@@IAEXABUCoord3D@@@Z present-unmatched
...
// ?onCollide@PhysicsBehavior@@UAEXPAVObject@@PBUCoord3D@@1@Z present-unmatched
 ...
 */
//-------------------------------------------------------------------------------------------------
// ?checkForOverlapCollision@PhysicsBehavior@@IAE_NPAVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?testStunnedUnitForDestruction@PhysicsBehavior@@IAEXXZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@PhysicsBehavior@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@PhysicsBehavior@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@PhysicsBehavior@@MAEXXZ present-unmatched
