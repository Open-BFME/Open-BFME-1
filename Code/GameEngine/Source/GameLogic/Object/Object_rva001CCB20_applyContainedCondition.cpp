...
// stlport
// Open-BFME: address-derived Object-layout body, retail 0x001CCB20, 400 bytes.
// The method identity is not proven; the address token is intentionally kept.
...
{
	volatile UnsignedInt m_bits[10];
