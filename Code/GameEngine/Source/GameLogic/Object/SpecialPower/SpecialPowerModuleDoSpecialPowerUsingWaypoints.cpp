// cl: /DNDEBUG /MD
//
// SpecialPowerModuleInterface::doSpecialPowerUsingWaypoints, retail RVA 0x0026A690.
//
// This is the SpecialPowerModule base implementation, shared by every concrete
// special power: the same body sits in slot 14 of the
...
//
// The shape is upstream's SpecialPowerModule::doSpecialPowerUsingWaypoints
// (reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameLogic/
// Object/SpecialPower/SpecialPowerModule.cpp:730) instruction for
...
{
public:
	void doSpecialPowerUsingWaypoints(const Coord3D *loc, UnsignedInt mid, UnsignedInt commandOptions);
