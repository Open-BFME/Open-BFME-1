...
protected:
	virtual ~DarknessSpecialPower();
};

DarknessSpecialPower::DarknessSpecialPower( Thing *thing, const ModuleData *moduleData )
	: SpecialPowerModule( thing, moduleData )
{
}

DarknessSpecialPower::~DarknessSpecialPower()
{
}
