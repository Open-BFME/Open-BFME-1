...
// DelayedDeathBodyModuleData's constructor, retail 0x00212C10.
//
...
class DelayedDeathBodyModuleDataBase
{
public:
	DelayedDeathBodyModuleDataBase();
...
class DelayedDeathBodyModuleData : public DelayedDeathBodyModuleDataBase
{
public:
