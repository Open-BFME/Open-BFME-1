...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??1BodyParticleSystem@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?onDelete@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?setCorrectDamageState@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?setDamageState@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?validateArmorAndDamageFX@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?estimateDamage@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?doDamageFX@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?attemptDamage@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?shouldRetaliateAgainstAggressor@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?shouldRetaliate@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?attemptHealing@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setInitialHealth@ActiveBody@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?evaluateVisualCondition@ActiveBody@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?createParticleSystems@ActiveBody@@ present-unmatched
...
*/
//-------------------------------------------------------------------------------------------------
// ?internalChangeHealth@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?internalAddSubdualDamage@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?canBeSubdued@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?onSubdualChange@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?isSubdued@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?getMaxHealth@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?getSubdualDamageHealRate@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?hasAnySubdualDamage@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?getInitialHealth@ActiveBody@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?onVeterancyLevelChanged@ActiveBody@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?setAflame@ActiveBody@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@ActiveBody@@ present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@ActiveBody@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@ActiveBody@@ present-unmatched
