...
{
protected:
	void doNamedAssignTeam(const AsciiString &unitName, const AsciiString &teamName);
};

void ScriptActions::doNamedAssignTeam(const AsciiString &unitName, const AsciiString &teamName)
{
