...
// Open-BFME7: the +0x24 twin (retail 0x00359030, 59 bytes) of ScriptsParseActionDataChunkThunk.cpp:
// the same parse over the list head four bytes further into the Script (the false-action list).
// readable body of ?ParseActionDataChunk00359030@ScriptAction@@SA_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX@Z: Code/GameEngine/Source/GameLogic/ScriptEngine/Scripts.cpp
// Open-BFME7: isolated port of Scripts.cpp's ScriptAction::ParseActionDataChunk00359030
...
//
// The packet ties this address between ParseActionDataChunk00359030 and its
...
// ParseActionDataChunk00359030. Only the difference between the two offsets is proven
...
{
public:
	static bool ParseActionDataChunk00359030(DataChunkInput &file, DataChunkInfo *info, void *userData);
...
private:
	unsigned char _bfme_head[0x24];
	ScriptAction *m_action;
};

bool ScriptAction::ParseActionDataChunk00359030(DataChunkInput &file, DataChunkInfo *info, void *userData)
{
