...
//
// Convert of gen-dump ?d_002f40e0@@YAXXZ at 0x002F40E0 (67 bytes).
// Same TheAudio / ScriptEngine vslot 22 skeleton as 0x002F4080, then a
// tail-jump through AudioManager vslot 88.
...
public:
	...
	virtual void applyNamed(void *item);
};

extern ScriptEngine *TheScriptEngine;
extern AudioManager *TheAudio;

void __stdcall d_002f40e0(const AsciiString &name)
{
	if (TheAudio)
	{
		void *item = TheScriptEngine->lookupByValue(name);
		if (item)
			TheAudio->applyNamed(item);
	}
}
