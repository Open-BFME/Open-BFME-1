// Open-BFME5: ScriptEngine::isSpeechComplete, retail 0x0034E810, 482 bytes.
// The BFME body uses LOGICFRAMES_PER_MSEC_REAL (5 logic frames per second).
// Its completion-list slot is the retail ScriptEngine vtable slot +0xB0 and
// the pair-list head is witnessed at this TU-local mirror's +0x17268.
...
class Rva0034E810ScriptEngine : public SubsystemInterface, public Snapshot
{
public:
	virtual ~Rva0034E810ScriptEngine();
...
// ?isSpeechComplete@ScriptEngine@@UAE_NABVAsciiString@@_N@Z
bool Rva0034E810ScriptEngine::isSpeechComplete(const AsciiString &testSpeech, bool removeFromList)
{
