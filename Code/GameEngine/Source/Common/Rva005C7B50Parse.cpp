...
// Address-derived model for the retail static cdecl INI field callback at 0x005C7B50.
...
public:
	...
	const char *m_name;
	const char *m_key;
	Rva005C7B50Factory *m_next;
};

class Rva005C7B50ModuleTemplate
{
public:
	virtual void destroy(unsigned int flags);
};

class Rva005C7B50Parse
{
public:
	static void parse(INI *ini, void *data, void *store, const void *userData);
};

// ?parse@Rva005C7B50Parse@@SAXPAVINI@@PAX1PBX@Z
void Rva005C7B50Parse::parse(INI *ini, void *data, void *, const void *)
{
	const char *token = ini->getNextToken(0);
	BFMERetailAsciiString name(token);
	Rva005C7B50Factory *factory = *reinterpret_cast<Rva005C7B50Factory **>(0x012F64F0);
	...
	void *old = *reinterpret_cast<void **>((char *)data + 0xA8);
	if (old)
		((Rva005C7B50ModuleTemplate *)old)->destroy(1);
	*reinterpret_cast<void **>((char *)data + 0xA8) = created;
}
