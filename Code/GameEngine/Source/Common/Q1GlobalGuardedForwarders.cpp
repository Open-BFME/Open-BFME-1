// Ten twenty-one-byte __cdecl functions with one shape:
//
...
//
// TWO AXES: the global and the callee.  NINE of the ten load the SAME global
// and reach NINE DIFFERENT callees; the tenth (Rva005091B0) loads a different
...
// argument is spelled `int`; a pointer compiles the same.  The nine methods
