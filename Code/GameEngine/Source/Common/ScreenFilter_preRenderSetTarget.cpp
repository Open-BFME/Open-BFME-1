// cl: /DNDEBUG /MD
//
// Retail 0x007D4A80: thiscall preRender-shaped body.  skipRender=false, bind
// this+0x1C as a render target, Clear(color only), scenePassMode=6, return true.
...
class ScreenFilterPreRenderHost
{
public:
...
bool ScreenFilterPreRenderHost::preRender(bool &skipRender, int &scenePassMode)
{
	skipRender = false;
