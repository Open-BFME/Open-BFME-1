...
// Address-derived model for the retail static cdecl INI field callback at 0x005C7EB0.
...
public:
	...
	const char *m_name;
	const char *m_key;
	Rva005C7EB0Factory *m_next;
};

class Rva005C7EB0ModuleTemplate
{
public:
	virtual void destroy(unsigned int flags);
};

class Rva005C7EB0Parse
{
public:
	static void parse(INI *ini, void *data, void *store, const void *userData);
};

// ?parse@Rva005C7EB0Parse@@SAXPAVINI@@PAX1PBX@Z
void Rva005C7EB0Parse::parse(INI *ini, void *data, void *, const void *)
{
	...
	void *old = *reinterpret_cast<void **>((char *)data + 0xB4);
	if (old)
		((Rva005C7EB0ModuleTemplate *)old)->destroy(1);
	*reinterpret_cast<void **>((char *)data + 0xB4) = created;
}
