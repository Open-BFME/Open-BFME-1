...
// readable body of ?getUnicodeBuildTime@Version@@QAE?AVUnicodeString@@XZ: Code/GameEngine/Source/Common/version.cpp
//
// Retail 0x000AF080, 292 bytes. ZH body: translate m_buildDate and m_buildTime
// into locals, format them through TheGameText->fetch("Version:BuildTime")
...
// ?getUnicodeBuildTime@Version@@QAE?AVUnicodeString@@XZ
