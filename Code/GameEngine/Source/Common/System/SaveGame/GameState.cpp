...
// ------------------------------------------------------------------------------------------------
// ?populateSaveGameListbox@GameState@@QAEXPAVGameWindow@@W4SaveLoadLayoutType@@@Z matched 1286 bytes (Open-BFME5)
__declspec(naked) void GameState::populateSaveGameListbox(GameWindow *, SaveLoadLayoutType)
{
	__asm
	{
		__emit 0x6a;
