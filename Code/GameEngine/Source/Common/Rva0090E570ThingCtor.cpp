...
// Byte-twin of Rva0090E470ThingCtor.cpp (tools/twin_scan.py); only the vftable differs. The base body is the already matched BfmeThingSJ constructor at 0x0090E3D0.
...
class Rva0090E570Thing : public BfmeThingSJ
{
public:
	Rva0090E570Thing(const char *name, int what, int field);
...
Rva0090E570Thing::Rva0090E570Thing(const char *name, int what, int field)
	: BfmeThingSJ(what),
	  m_name(name, false)
{
	m_field = field;
