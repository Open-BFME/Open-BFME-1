...
// Open-BFME: hash_map<AsciiString, Rva000F6B50Mapped *>::hashtable::erase,
// retail 0x000F6B50, 154 bytes; byte-twin of AsciiStringParticleHashErase.cpp (tools/twin_scan.py), the mapped type is address-derived.  The body is the iterator unlink path for the
...
typedef _STL::pair<const AsciiString, Rva000F6B50Mapped *> Rva000F6B50ParticlePair;
typedef _STL::hashtable<Rva000F6B50ParticlePair, AsciiString, rts::hash<AsciiString>,
	_STL::_Select1st<Rva000F6B50ParticlePair>, _STL::equal_to<AsciiString>,
	_STL::allocator<Rva000F6B50ParticlePair> > Rva000F6B50ParticleHashtable;

template void Rva000F6B50ParticleHashtable::erase(const Rva000F6B50ParticleHashtable::const_iterator &);
