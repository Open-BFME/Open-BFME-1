...
// Open-BFME: hash_map<AsciiString, ParticleSystemTemplate *>::hashtable::erase,
// retail 0x00614C50, 154 bytes.  The body is the iterator unlink path for the
...
typedef _STL::pair<const AsciiString, ParticleSystemTemplate *> BfmeParticlePair;
typedef _STL::hashtable<BfmeParticlePair, AsciiString, rts::hash<AsciiString>,
	_STL::_Select1st<BfmeParticlePair>, _STL::equal_to<AsciiString>,
	_STL::allocator<BfmeParticlePair> > BfmeParticleHashtable;

template void BfmeParticleHashtable::erase(const BfmeParticleHashtable::const_iterator &);
