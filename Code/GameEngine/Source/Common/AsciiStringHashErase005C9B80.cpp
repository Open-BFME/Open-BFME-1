...
// Open-BFME: hash_map<AsciiString, Rva005C9B80Mapped *>::hashtable::erase,
// retail 0x005C9B80, 154 bytes; byte-twin of AsciiStringParticleHashErase.cpp (tools/twin_scan.py), the mapped type is address-derived.  The body is the iterator unlink path for the
...
typedef _STL::pair<const AsciiString, Rva005C9B80Mapped *> Rva005C9B80ParticlePair;
typedef _STL::hashtable<Rva005C9B80ParticlePair, AsciiString, rts::hash<AsciiString>,
	_STL::_Select1st<Rva005C9B80ParticlePair>, _STL::equal_to<AsciiString>,
	_STL::allocator<Rva005C9B80ParticlePair> > Rva005C9B80ParticleHashtable;

template void Rva005C9B80ParticleHashtable::erase(const Rva005C9B80ParticleHashtable::const_iterator &);
