// cl: /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /Ob1 /Ireference/shims/iniexception /Ireference/shims/ini
//
...
#include "Common/AsciiString.h"	// reference/shims/ini: isEmpty and str() inline, as retail emits them
