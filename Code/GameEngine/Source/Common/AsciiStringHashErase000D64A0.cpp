...
// Open-BFME: hash_map<AsciiString, Rva000D64A0Mapped *>::hashtable::erase,
...
typedef _STL::pair<const AsciiString, Rva000D64A0Mapped *> Rva000D64A0ParticlePair;
typedef _STL::hashtable<Rva000D64A0ParticlePair, AsciiString, rts::hash<AsciiString>,
	_STL::_Select1st<Rva000D64A0ParticlePair>, _STL::equal_to<AsciiString>,
	_STL::allocator<Rva000D64A0ParticlePair> > Rva000D64A0ParticleHashtable;

template void Rva000D64A0ParticleHashtable::erase(const Rva000D64A0ParticleHashtable::const_iterator &);
