...
// readable body of ?getUnicodeBuildLocation@Version@@QAE?AVUnicodeString@@XZ: Code/GameEngine/Source/Common/version.cpp
//
// Retail 0x000AF220, 273 bytes. ZH body: translate a copy of m_buildLocation
// into a local, format it through TheGameText->fetch("Version:BuildMachine")
...
// ?getUnicodeBuildLocation@Version@@QAE?AVUnicodeString@@XZ
