...
// RVA 0x009AB990: select one 128-byte block and copy two short values.
struct Rva009AB990Context
{
    int m_unused;
...
void __cdecl Rva009AB990Select(Rva009AB990Context *context,
                               Rva009AB990Output *output, unsigned int block)
{
