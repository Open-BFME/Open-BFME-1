...
typedef BfmeSubBIA OverridableFC10;

class BfmeKindOfFC10
{
public:
...
public:
	...
	virtual void slot31() = 0; virtual void slot32() = 0; virtual void slot33() = 0;
...
void Gen_0021FC10::bfmeMode2(void *a, void *b, int mode)
{
	if (mode != 2)
		return;
	OverridableFC10 *volatile *base = *(OverridableFC10 *volatile **)((char *)this - 0x24);
	base += 1;
	OverridableFC10 *ovr = *base;
	if (ovr != 0 && ovr->m_nextOverride != 0)
		ovr = (BfmeSubBIA *)ovr->m_nextOverride->ask();
	if ((((BfmeKindOfFC10 *)ovr)->m_kindOf & 0x4000) != 0)
		return;
