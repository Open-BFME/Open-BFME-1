...
// stlport
// Retail at 0x00151B00.  STLport list<8-byte>::push_back: 16-byte node via
...
struct Rva00151B00Elem
{
	void *m_a;
	void *m_b;
};

class Rva00151B00List
{
public:
	void push_back(Rva00151B00Elem const &value);

private:
	_STL::list<Rva00151B00Elem> m_list;
};

void Rva00151B00List::push_back(Rva00151B00Elem const &value)
{
