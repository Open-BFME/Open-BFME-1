...
// Open-BFME: hash_map<AsciiString, Rva00460A70Mapped *>::hashtable::erase,
// retail 0x00460A70, 154 bytes; byte-twin of AsciiStringParticleHashErase.cpp (tools/twin_scan.py), the mapped type is address-derived.  The body is the iterator unlink path for the
...
typedef _STL::pair<const AsciiString, Rva00460A70Mapped *> Rva00460A70ParticlePair;
typedef _STL::hashtable<Rva00460A70ParticlePair, AsciiString, rts::hash<AsciiString>,
	_STL::_Select1st<Rva00460A70ParticlePair>, _STL::equal_to<AsciiString>,
	_STL::allocator<Rva00460A70ParticlePair> > Rva00460A70ParticleHashtable;

template void Rva00460A70ParticleHashtable::erase(const Rva00460A70ParticleHashtable::const_iterator &);
