...
// boundary (reverse/carved.csv line "0x003BEC30,167,rel32-call/jmp;ghidra-start").
// The symbol ?finish@Rva003BEED0@@QAEXXZ is the existing reverse/symbols.csv pin
