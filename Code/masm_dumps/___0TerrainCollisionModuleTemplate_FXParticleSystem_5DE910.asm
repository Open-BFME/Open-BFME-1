...
; Retail @ 0x005DE910 size 340
_TEXT SEGMENT
public ??0TerrainCollisionModuleTemplate@FXParticleSystem@@QAE@ABV01@@Z
??0TerrainCollisionModuleTemplate@FXParticleSystem@@QAE@ABV01@@Z PROC
    db 6Ah,0FFh,68h,98h,0AFh,03h,01h,64h
    ...
    db 8Dh,7Eh,0Ch,50h,8Bh,0CFh,0E8h,63h
    db 9Fh,0A2h,0FFh,8Bh,4Ch,24h,0Ch,0C7h
    db 07h,24h,13h,11h,01h,0C7h,06h,10h
    db 13h,11h,01h,0C7h,46h,04h,0Ch,13h
    ...
    db 0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh
    db 0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh
    db 56h,8Bh,0F1h,0E8h,28h,9Ah,0A5h,0FFh
    db 0F6h,44h,24h,08h,01h,74h,09h,56h
    db 0E8h,0BBh,34h,2Ah,00h,83h,0C4h,04h
    db 8Bh,0C6h,5Eh,0C2h,04h,00h,0CCh,0CCh
    db 0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh
    db 0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh,0CCh
    db 53h,8Ah,5Ch,24h,08h,0F6h,0C3h,02h
    db 56h,8Bh,0F1h,74h,2Bh,8Bh,46h,0FCh
    db 57h,68h,10h,84h,43h,00h,8Dh,7Eh
    db 0FCh,50h,6Ah,28h,56h,0E8h,44h,83h
    db 41h,00h,0F6h,0C3h,01h,74h,09h,57h
    db 0E8h,0B3h,34h,2Ah,00h,83h,0C4h,04h
    db 8Bh,0C7h,5Fh,5Eh,5Bh,0C2h,04h,00h
    db 8Bh,0CEh,0E8h,0C1h,99h,0A5h,0FFh,0F6h
    db 0C3h,01h,74h,09h,56h,0E8h,56h,34h
    db 2Ah,00h,83h,0C4h,04h,8Bh,0C6h,5Eh
    db 5Bh,0C2h,04h,00h
??0TerrainCollisionModuleTemplate@FXParticleSystem@@QAE@ABV01@@Z ENDP
_TEXT ENDS
END
