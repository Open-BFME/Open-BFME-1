...
; Retail @ 0x00851EE0 size 180
_TEXT SEGMENT
public ?parseFXList@INI@@SAXPAV1@PAX1PBX@Z
?parseFXList@INI@@SAXPAV1@PAX1PBX@Z PROC
    db 6Ah, 0FFh, 68h, 48h, 64h, 05h, 01h, 64h
    db 0A1h, 00h, 00h, 00h, 00h, 50h, 64h, 89h
    db 25h, 00h, 00h, 00h, 00h, 51h, 8Bh, 4Ch
    db 24h, 14h, 8Dh, 04h, 24h, 50h, 0E8h, 0DDh
    db 0F7h, 0FFh, 0FFh, 8Bh, 4Ch, 24h, 1Ch, 50h
    db 0C7h, 44h, 24h, 10h, 00h, 00h, 00h, 00h
    db 0E8h, 7Bh, 5Dh, 03h, 00h, 8Dh, 0Ch, 24h
    db 0C7h, 44h, 24h, 0Ch, 0FFh, 0FFh, 0FFh, 0FFh
    db 0E8h, 1Bh, 5Ah, 03h, 00h, 8Bh, 4Ch, 24h
    db 04h, 64h, 89h, 0Dh, 00h, 00h, 00h, 00h
