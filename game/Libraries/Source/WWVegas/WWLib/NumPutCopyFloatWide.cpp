...
// stlport
// STLport 4.5.3 wide __copy_float_and_fill specialization.
// Retail address: 0x0083C420, size: 300 bytes.
...
template BfmeWideFloatFillIterator __cdecl
__copy_float_and_fill<BfmeWchar, BfmeWideFloatFillIterator>(
	const BfmeWchar *, const BfmeWchar *, BfmeWideFloatFillIterator,
