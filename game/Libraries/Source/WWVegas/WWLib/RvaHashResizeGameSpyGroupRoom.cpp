...
typedef _STL::hashtable<GameSpyGroupRoom, AsciiString, rts::hash<AsciiString>,
    Rva00389E10ExtractKey, _STL::equal_to<AsciiString>,
    _STL::allocator<GameSpyGroupRoom> > Rva00389E10Table;

template void Rva00389E10Table::resize(unsigned int);
