...
// Open-BFME5: _STL::hashtable<pair<const UnsignedInt, void *>>::_M_insert, retail
// 0x00431070, 111 bytes. The body carried only a machine byte-dump row;
...
template <class T1, class T2>
void _Construct(T1 *p, const T2 &value);			// ILT 0x0003CF92
...
typedef pair<const UnsignedInt, void *> BfmeUnsignedPtrPair;

template BfmeUnsignedPtrPair &hashtable<BfmeUnsignedPtrPair, UnsignedInt, hash<UnsignedInt>,
	_Select1st<BfmeUnsignedPtrPair>, equal_to<UnsignedInt>,
	allocator<BfmeUnsignedPtrPair> >::_M_insert(const BfmeUnsignedPtrPair &);
