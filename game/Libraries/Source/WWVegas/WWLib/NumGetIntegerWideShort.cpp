// cl: /O2 /MD
// STLport 4.5.3 unsigned-short __get_integer<wchar_t> @ 0x00834C90 (399B).
...
namespace _STL
{
	...
	template bool __get_integer<WideIterator, unsigned short>(
		WideIterator &, WideIterator &, int, unsigned short &, int, bool, char,
