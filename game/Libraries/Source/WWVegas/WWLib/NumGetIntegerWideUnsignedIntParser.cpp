// cl: /O2 /MD
// STLport 4.5.3 wide unsigned-int __get_integer at retail 0x008349D0.
// BFME's wchar_t ABI is unsigned short; this is the unsigned 32-bit facet
// parser called by the named wide unsigned-int _M_do_get_integer at 0x008348D0.
...
namespace _STL
{
	...
	{
		static unsigned int max() { return 0xffffffffU; }
	};
	...
	template bool __get_integer<WideIterator, unsigned int>(
		WideIterator &, WideIterator &, int, unsigned int &, int, bool, char,
