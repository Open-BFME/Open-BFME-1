// cl: /O2 /MD
// STLport 4.5.3 wide signed-int __get_integer at retail 0x0083B1A0.
// The wide iterator cache layout and the shared grouping validator identify
// this instantiation.
...
namespace _STL
{
	...
	template bool __get_integer<WideIterator, int>(
		WideIterator &, WideIterator &, int, int &, int, bool, char,
