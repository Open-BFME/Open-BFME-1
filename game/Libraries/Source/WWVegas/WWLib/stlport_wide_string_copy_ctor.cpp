...
// Open-BFME5: _STL::basic_string<wchar>::basic_string(const basic_string &),
// retail 0x004FB220, 86 bytes. The body carried only a machine byte-dump row;
...
void BfmeWideStringCopyAnchor(void *storage,
	const _STL::basic_string<unsigned short, _STL::char_traits<unsigned short>,
		_STL::allocator<unsigned short> > &other)
{
	new (storage) _STL::basic_string<unsigned short,
		_STL::char_traits<unsigned short>, _STL::allocator<unsigned short> >(other);
}
