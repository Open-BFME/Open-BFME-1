...
// Open-BFME5: _STL::hashtable<pair<const Int, void *>>::_M_insert, retail
// 0x000D3600, 111 bytes. The body carried only a machine byte-dump row;
...
template <class T1, class T2>
void _Construct(T1 *p, const T2 &value);			// ILT 0x0001AB59
...
private:
	void resize(size_type numElementsHint);			// ILT 0x0001F028
...
typedef pair<const Int, void *> BfmeIntPtrPair;

template BfmeIntPtrPair &hashtable<BfmeIntPtrPair, Int, hash<Int>,
	_Select1st<BfmeIntPtrPair>, equal_to<Int>,
	allocator<BfmeIntPtrPair> >::_M_insert(const BfmeIntPtrPair &);
