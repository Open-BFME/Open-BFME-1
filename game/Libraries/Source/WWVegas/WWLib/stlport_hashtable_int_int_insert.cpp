...
typedef pair<const Int, Int> BfmeIntIntPair;

template BfmeIntIntPair &hashtable<BfmeIntIntPair, Int, hash<Int>,
	_Select1st<BfmeIntIntPair>, equal_to<Int>,
	allocator<BfmeIntIntPair> >::_M_insert(const BfmeIntIntPair &);
