...
template basic_ios<unsigned short, char_traits<unsigned short> > &basic_ios<unsigned short, char_traits<unsigned short> >::copyfmt(const basic_ios<unsigned short, char_traits<unsigned short> > &);
