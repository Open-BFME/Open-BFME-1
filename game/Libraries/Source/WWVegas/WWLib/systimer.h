...
#include "always.h"
// <windows.h> omitted: SysTimeClass uses only plain types; the winmm timer
// entry points come from the mmsys.h shim (toolchain ships no Platform SDK).
#include "mmsys.h"
...
**
*/
// upstream layout: inputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWLib/systimer.h
class SysTimeClass
{
