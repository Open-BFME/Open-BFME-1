...
// Open-BFME5: _STL::_Rb_tree<Int, pair<const Int, GameSpyGroupRoom> >::_M_insert,
// retail 0x00633AD0, 176 bytes. The body carried only a machine byte-dump row;
...
//
// The node is 0x34 bytes: colour, parent, left and right, then the 36-byte
...
void _Construct(T1 *p, const T2 &value);			// ILT 0x0001EC8B
...
struct BfmeRbTreeInsertAnchorHelper
{
	typedef _STL::pair<const Int, GameSpyGroupRoom> Value;
