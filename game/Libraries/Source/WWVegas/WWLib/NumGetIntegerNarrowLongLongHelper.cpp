// cl: /O2 /MD
// STLport 4.5.3 narrow signed __int64 __get_integer<__true_type> at
// retail 0x00832EC0 (537B).
// The narrow streambuf uses the VC7 int_type ABI: sbumpc returns int
// (QAEH), while the iterator cache remains the four-byte narrow layout.
...
namespace _STL
{
	...
	template bool __get_integer<NarrowIterator, __int64>(
		NarrowIterator &, NarrowIterator &, int, __int64 &, int, bool, char,
