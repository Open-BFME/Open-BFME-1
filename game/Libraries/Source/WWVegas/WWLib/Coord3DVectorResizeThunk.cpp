...
//
// Not compiled from inputs/vendor/stlport: the retail body ends `ret 0x10`, so it pops
...
// loaded with `mov`.  Compiled against inputs/vendor/stlport/stl/_vector.h, whose
