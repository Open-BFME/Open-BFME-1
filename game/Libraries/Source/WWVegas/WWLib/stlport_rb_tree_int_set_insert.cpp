...
// Open-BFME5: _STL::_Rb_tree<Int, Int, _Identity<Int> >::_M_insert, retail
// 0x002348E0, 179 bytes. The body carried only a machine byte-dump row;
...
//
// The tree is a set of Int, so _Identity makes the key the value itself at
// node+0x10, and the node is 20 bytes: colour, parent, left and right, then
// the value.
//
...
struct BfmeRbTreeInsertAnchorHelper
{
	typedef _STL::_Rb_tree<Int, Int, _STL::_Identity<Int>, _STL::less<Int>,
		_STL::allocator<Int> > Tree;

	static Tree::iterator run(Tree *tree, _STL::_Rb_tree_node_base *x,
		_STL::_Rb_tree_node_base *y, const Int &v, _STL::_Rb_tree_node_base *w)
	{
