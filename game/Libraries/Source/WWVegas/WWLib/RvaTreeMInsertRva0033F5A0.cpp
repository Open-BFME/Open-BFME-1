...
// the four-argument form, at retail 0x0033F5A0.  Near-twin of
...
struct BfmeRbTreeInsertRva0033F5A0AnchorHelper;
...
private:
	...
	friend struct ::BfmeRbTreeInsertRva0033F5A0AnchorHelper;
};
...
struct Rva0033F5A0Value
{
	unsigned char m_data[8];
};

typedef _STL::pair<const Rva0019BC70Key, Rva0033F5A0Value> Rva0033F5A0Pair;

typedef _STL::_Rb_tree<Rva0019BC70Key, Rva0033F5A0Pair,
	_STL::_Select1st<Rva0033F5A0Pair>, _STL::less<Rva0019BC70Key>,
	_STL::allocator<Rva0033F5A0Pair> > Rva0033F5A0Tree;

// retail 0x0033F5A0
Rva0033F5A0Tree::iterator BfmeRbTreeInsertRva0033F5A0( Rva0033F5A0Tree *tree,
	_STL::_Rb_tree_node_base *x, _STL::_Rb_tree_node_base *y,
	const Rva0033F5A0Pair &v, _STL::_Rb_tree_node_base *w )
{
	return BfmeRbTreeInsertRva0033F5A0AnchorHelper::run( tree, x, y, v, w );
}
