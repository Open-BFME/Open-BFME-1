...
// stlport
// BFME's STLport 4.5.3 narrow _M_do_put_float<long double> specialization.
...
_M_do_put_float<char, BfmeNarrowNumPutIterator, long double>(
	BfmeNarrowNumPutIterator, ios_base &, char, long double);
