...
*/
// ??0PrimitivePrototypeClass@@ present-unmatched
...
// ??1PrimitivePrototypeClass@@ present-unmatched
...
// ?Get_Name@PrimitivePrototypeClass@@ present-unmatched
const char * PrimitivePrototypeClass::Get_Name(void) const			
{ 
	return Proto->Get_Name(); 
}	

// ?Get_Class_ID@PrimitivePrototypeClass@@ present-unmatched
int PrimitivePrototypeClass::Get_Class_ID(void) const	
{ 
	return Proto->Class_ID(); 
}

// ?Create@PrimitivePrototypeClass@@ present-unmatched
 ...
 *   7/28/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Load_W3D@MeshLoaderClass@@ present-unmatched
 ...
 *   7/28/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Load_W3D@HModelLoaderClass@@ present-unmatched
