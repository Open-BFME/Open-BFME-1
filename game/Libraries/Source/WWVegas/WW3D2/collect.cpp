 ...
 *   23/8/00    GTH : Created.                                                                 *
 *=============================================================================================*/
// ??0CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ??4CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ??1CollectionClass@@ present-unmatched
CollectionClass::~CollectionClass(void)
{
	Free();
}
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Clone@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Free@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Class_ID@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Num_Polys@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Render@CollectionClass@@ present-unmatched
 ...
 *   3/2/99     GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Special_Render@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Num_Sub_Objects@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Sub_Object@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Add_Sub_Object@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Remove_Sub_Object@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Cast_Ray@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Cast_AABox@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Cast_OBBox@CollectionClass@@ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Intersect_AABox@CollectionClass@@ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Intersect_OBBox@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Obj_Space_Bounding_Sphere@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Obj_Space_Bounding_Box@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Snap_Point_Count@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Snap_Point@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Scale@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Update_Obj_Space_Bounding_Volumes@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Update_Sub_Object_Transforms@CollectionClass@@ present-unmatched
 ...
 *   4/28/99    PDS : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Proxy@CollectionClass@@ present-unmatched
 ...
 *   4/28/99    PDS : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Proxy_Count@CollectionClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ??0CollectionDefClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ??1CollectionDefClass@@ present-unmatched
CollectionDefClass::~CollectionDefClass(void)
{
	Free();
}
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Free@CollectionDefClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Name@CollectionDefClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Load@CollectionDefClass@@ present-unmatched
 ...
 *   12/8/98    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Load_W3D@CollectionLoaderClass@@ present-unmatched
