...
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WWLib/buff.cpp
...
// ?Set_H_Line@Buffer@@ present-unmatched
...
// ??1BW_Render@@ present-unmatched
BW_Render::~BW_Render()
{
}

// ?Fill@BW_Render@@ present-unmatched
...
// ?Set_Vertex_Locations@BW_Render@@ present-unmatched
void BW_Render::Set_Vertex_Locations(Vector2* vertices_,int count)
{
	vertices=vertices_;

	float half_scale=pixel_buffer.Scale()*0.5f;
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WWMath/vp.cpp
...
// ?Render_Triangle_Strip@BW_Render@@ present-unmatched
...
// ?Render_Triangles@BW_Render@@ present-unmatched
...
// ?Render_Preprocessed_Triangle@BW_Render@@ present-unmatched
