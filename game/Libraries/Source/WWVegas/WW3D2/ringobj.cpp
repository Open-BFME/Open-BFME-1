 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ??0RingRenderObjClass@@ present-unmatched
 ...
 *=============================================================================================*/
// ??1RingRenderObjClass@@UAE@XZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ??4RingRenderObjClass@@QAEAAV0@ABV0@@Z present-unmatched
 ...
 *=============================================================================================*/
// ?Generate_Shared_Mesh_Arrays@RingRenderObjClass@@KAXXZ present-unmatched
...
// ?calculate_value_array@RingRenderObjClass@@IBEXMPAM@Z present-unmatched
 ...
 *   03/08/00    pds : Created.                                                                *
 *=============================================================================================*/
// ?Init_Material@RingRenderObjClass@@IAEXXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Num_Polys@RingRenderObjClass@@UBEHXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Texture@RingRenderObjClass@@QAEXPAVTextureClass@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Name@RingRenderObjClass@@UBEPBDXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Name@RingRenderObjClass@@UAEXPBD@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?render_ring@RingRenderObjClass@@IAEXAAVRenderInfoClass@@ABVVector3@@1@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Clone@RingRenderObjClass@@UBEPAVRenderObjClass@@XZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Class_ID@RingRenderObjClass@@UBEHXZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Render@RingRenderObjClass@@UAEXAAVRenderInfoClass@@@Z present-unmatched
 ...
 *=============================================================================================*/
// ?Get_Default_Color@RingRenderObjClass@@QBE?AVVector3@@XZ present-unmatched
 ...
 *   3/13/2000    pds : Created.                                                               *
 *=============================================================================================*/
// ?Get_Default_Alpha@RingRenderObjClass@@QBEMXZ present-unmatched
 ...
 *   3/13/2000    pds : Created.                                                               *
 *=============================================================================================*/
// ?Get_Default_Inner_Scale@RingRenderObjClass@@QBE?AVVector2@@XZ present-unmatched
 ...
 *   3/13/2000    pds : Created.                                                               *
 *=============================================================================================*/
// ?Get_Default_Outer_Scale@RingRenderObjClass@@QBE?AVVector2@@XZ present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Transform@RingRenderObjClass@@UAEXABVMatrix3D@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Set_Position@RingRenderObjClass@@UAEXABVVector3@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Obj_Space_Bounding_Sphere@RingRenderObjClass@@UBEXAAVSphereClass@@@Z present-unmatched
 ...
 *   1/19/00    gth : Created.                                                                 *
 *=============================================================================================*/
// ?Get_Obj_Space_Bounding_Box@RingRenderObjClass@@UBEXAAVAABoxClass@@@Z present-unmatched
...
// ?Get_LOD_Level@RingRenderObjClass@@UBEHXZ present-unmatched
int RingRenderObjClass::Get_LOD_Level(void) const
{
	return CurrentLOD;
}

// byte-exact reconstruction: game/Libraries/Source/WWVegas/WWSaveLoad/parameter.cpp
...
// ?Calculate_Cost_Value_Arrays@RingRenderObjClass@@UBEHMPAM0@Z present-unmatched
 ...
 *   7/01/02    NH : Created.                                                                  *
 *=============================================================================================*/
// ?Scale@RingRenderObjClass@@ present-unmatched
 ...
 *   4/04/00    pds : Created.                                                                 *
 *=============================================================================================*/
// ?Update_On_Visibilty@RingRenderObjClass@@IAEXXZ present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?animate@RingRenderObjClass@@IAEXXZ present-unmatched
...
*/
// ?Load_W3D@RingLoaderClass@@UAEPAVPrototypeClass@@AAVChunkLoadClass@@@Z present-unmatched
...
*/
// ??0RingPrototypeClass@@ present-unmatched
...
// ??1RingPrototypeClass@@MAE@XZ present-unmatched
RingPrototypeClass::~RingPrototypeClass (void)
{
	return ;
}

// ?Get_Name@RingPrototypeClass@@UBEPBDXZ present-unmatched
const char * RingPrototypeClass::Get_Name(void) const
{
	return Definition.Name;
}

// ?Get_Class_ID@RingPrototypeClass@@UBEHXZ present-unmatched
...
// ?Load@RingPrototypeClass@@QAE_NAAVChunkLoadClass@@@Z present-unmatched
...
// ?Save@RingPrototypeClass@@QAE_NAAVChunkSaveClass@@@Z present-unmatched
...
// ?Create@RingPrototypeClass@@UAEPAVRenderObjClass@@XZ present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ??0RingMeshClass@@ present-unmatched
...
// ?Set_Tiling@RingMeshClass@@QAEXH@Z present-unmatched
...
// ?Scale@RingMeshClass@@QAEXABVVector2@@0@Z present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?Generate@RingMeshClass@@QAEXMH@Z present-unmatched
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ??1RingMeshClass@@QAE@XZ present-unmatched
RingMeshClass::~RingMeshClass(void)
{
	Free();
}
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
// ?Free@RingMeshClass@@AAEXXZ present-unmatched
