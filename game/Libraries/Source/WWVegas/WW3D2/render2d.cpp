...
** Render2DClass
*/
// ??0Render2DClass@@QAE@PAVTextureClass@@@Z present-unmatched
...
// ??1Render2DClass@@UAE@XZ present-unmatched
Render2DClass::~Render2DClass()
{
	REF_PTR_RELEASE(Texture);	
}

// ?Set_Screen_Resolution@Render2DClass@@SAXABVRectClass@@@Z present-unmatched
...
ShaderClass
// ?Get_Default_Shader@Render2DClass@@SA?AVShaderClass@@XZ present-unmatched
...
// ?Reset@Render2DClass@@UAEXXZ present-unmatched
...
// ?Enable_Grayscale@Render2DClass@@QAEX_N@Z present-unmatched
void Render2DClass::Enable_Grayscale(bool b)
{
	IsGrayScale = b;
}	

// ?Enable_Alpha@Render2DClass@@QAEX_N@Z present-unmatched
...
// ?Enable_Additive@Render2DClass@@QAEX_N@Z present-unmatched
...
// ?Enable_Texturing@Render2DClass@@QAEX_N@Z present-unmatched
...
// ?Move@Render2DClass@@QAEXABVVector2@@@Z present-unmatched
...
// ?Force_Alpha@Render2DClass@@QAEXM@Z present-unmatched
...
// ?Force_Color@Render2DClass@@QAEXH@Z present-unmatched
...
// ?Internal_Add_Quad_UVs@Render2DClass@@IAEXABVRectClass@@@Z present-unmatched
...
// ?Internal_Add_Quad_Colors@Render2DClass@@IAEXK@Z present-unmatched
...
// ?Internal_Add_Quad_VColors@Render2DClass@@IAEXKK@Z present-unmatched
...
// ?Internal_Add_Quad_HColors@Render2DClass@@IAEXKK@Z present-unmatched
...
// ?Internal_Add_Quad_Indicies@Render2DClass@@IAEXH_N@Z present-unmatched
...
// ?Add_Quad_Backfaced@Render2DClass@@QAEXABVVector2@@000ABVRectClass@@K@Z present-unmatched
...
// ?Add_Rect@Render2DClass@@QAEXABVRectClass@@MKK@Z present-unmatched
...
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WW3D2/Render2DRenderThunk.cpp
...
** Render2DTextClass
*/
// ??0Render2DTextClass@@QAE@PAVFont3DInstanceClass@@@Z present-unmatched
...
// ??1Render2DTextClass@@UAE@XZ present-unmatched
Render2DTextClass::~Render2DTextClass()
{
	REF_PTR_RELEASE(Font);
}

// ?Reset@Render2DTextClass@@UAEXXZ present-unmatched
...
// ?Set_Font@Render2DTextClass@@QAEXPAVFont3DInstanceClass@@@Z present-unmatched
...
**
*/
// ?Draw_Char@Render2DTextClass@@AAEXGK@Z present-unmatched
...
// ?Draw_Block@Render2DTextClass@@QAEXABVRectClass@@K@Z present-unmatched
...
// ?Get_Text_Extents@Render2DTextClass@@QAE?AVVector2@@PBG@Z present-unmatched
