...
public:
	...
	// (game/Libraries/Source/WWVegas/WW3D2/VertexSplitTableConstructorBFME.cpp).
...
struct BfmeRigidMeshSortLayout
{
	char prefix[0x18];
	int flags;
	char sort_level;
...
__declspec(noinline) void Add_Rigid_Mesh_To_Container(FVFCategoryList *container_list, unsigned fvf, MeshModelClass *mmc)
{
	...
	BfmeRigidMeshSortLayout *mesh = reinterpret_cast<BfmeRigidMeshSortLayout *>(mmc);
	bool sorting = (mesh->flags & MeshModelClass::SORT)
...
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WW3D2/DX8MeshRendererClass_Flush.cpp
...
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WW3D2/DX8MeshRendererClass_Invalidate_Thunk.cpp
