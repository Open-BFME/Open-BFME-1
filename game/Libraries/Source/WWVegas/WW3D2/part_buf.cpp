...
// readable body of ?classifyObjectFootprint@Pathfinder@@IAEXPAVObject@@_N@Z: game/GameEngine/Source/GameLogic/AI/AIPathfind.cpp
...
// BFME's emitter omits the Zero Hour slot immediately before Emit.
#define BFME_PARTICLE_EMITTER_EIGHT_SLOTS(a, b, c, d, e, f, g, h) \
...
class BfmeParticleEmitterView
{
public:
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(000, 001, 002, 003, 004, 005, 006, 007)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(008, 009, 010, 011, 012, 013, 014, 015)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(016, 017, 018, 019, 020, 021, 022, 023)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(024, 025, 026, 027, 028, 029, 030, 031)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(032, 033, 034, 035, 036, 037, 038, 039)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(040, 041, 042, 043, 044, 045, 046, 047)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(048, 049, 050, 051, 052, 053, 054, 055)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(056, 057, 058, 059, 060, 061, 062, 063)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(064, 065, 066, 067, 068, 069, 070, 071)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(072, 073, 074, 075, 076, 077, 078, 079)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(080, 081, 082, 083, 084, 085, 086, 087)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(088, 089, 090, 091, 092, 093, 094, 095)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(096, 097, 098, 099, 100, 101, 102, 103)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(104, 105, 106, 107, 108, 109, 110, 111)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(112, 113, 114, 115, 116, 117, 118, 119)
	BFME_PARTICLE_EMITTER_EIGHT_SLOTS(120, 121, 122, 123, 124, 125, 126, 127)
	virtual void Slot_128(void);
	virtual void Slot_129(void);
	virtual void Emit(void);
};

#undef BFME_PARTICLE_EMITTER_EIGHT_SLOTS
...
// ?ParticleBufferClass::Get_Num_Polys present-unmatched
...
// ?ParticleBufferClass::Get_Particle_Count present-unmatched
...
void ParticleBufferClass::On_Frame_Update(void)
{
	...
	if (Emitter) {
		((BfmeParticleEmitterView *)Emitter)->Emit();
	}
...
// ?ParticleBufferClass::Notify_Added present-unmatched
...
// ?ParticleBufferClass::Notify_Removed present-unmatched
...
// ?ParticleBufferClass::Get_LOD_Level present-unmatched
int ParticleBufferClass::Get_LOD_Level(void) const
{
	return((LodCount - 1) - DecimationThreshold);
}

// ?ParticleBufferClass::Get_LOD_Count present-unmatched
...
// ?ParticleBufferClass::Get_Line_Texture_Mapping_Mode present-unmatched
...
// ?ParticleBufferClass::Is_Merge_Intersections present-unmatched
...
// ?ParticleBufferClass::Is_Sorting_Disabled present-unmatched
...
// ?ParticleBufferClass::Are_End_Caps_Enabled present-unmatched
...
// ?ParticleBufferClass::Get_Subdivision_Level present-unmatched
...
// ?ParticleBufferClass::Get_Noise_Amplitude present-unmatched
