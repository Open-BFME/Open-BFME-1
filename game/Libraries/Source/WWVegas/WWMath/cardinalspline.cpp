...
*/
// ?Add_Key@CardinalSpline3DClass@@ present-unmatched
...
// ?Remove_Key@CardinalSpline3DClass@@ present-unmatched
...
// ?Clear_Keys@CardinalSpline3DClass@@ present-unmatched
...
// ?Set_Tightness@CardinalSpline3DClass@@ present-unmatched
...
// ?Get_Tightness@CardinalSpline3DClass@@ present-unmatched
float CardinalSpline3DClass::Get_Tightness(int i)
{
	return Tightness[i];
}

// ?Update_Tangents@CardinalSpline3DClass@@ present-unmatched
...
// ?Load@CardinalSpline3DClass@@ present-unmatched
...
*/
// ?Add_Key@CardinalSpline1DClass@@ present-unmatched
...
// ?Remove_Key@CardinalSpline1DClass@@ present-unmatched
...
// ?Clear_Keys@CardinalSpline1DClass@@ present-unmatched
...
// ?Set_Tightness@CardinalSpline1DClass@@ present-unmatched
...
// ?Get_Tightness@CardinalSpline1DClass@@ present-unmatched
float CardinalSpline1DClass::Get_Tightness(int i)
{
	return Tightness[i];
}

// ?Update_Tangents@CardinalSpline1DClass@@ present-unmatched
...
// ?Load@CardinalSpline1DClass@@ present-unmatched
