...
// ??0ShdRendererClass@@ present-unmatched
ShdRendererClass::ShdRendererClass()
{
}

// ??1ShdRendererClass@@ present-unmatched
ShdRendererClass::~ShdRendererClass()
{
}
...
/////////////////////////////////////////////////////////////////////////////////////
// ?Init@ShdRendererClass@@ present-unmatched
...
// ?Init_Shaders@ShdRendererClass@@ present-unmatched
...
// ?Shutdown_Shaders@ShdRendererClass@@ present-unmatched
...
// ??0RendererListContainerClass@@ present-unmatched
RendererListContainerClass::RendererListContainerClass(int pass) : Pass(pass)
{
}

// ??1RendererListContainerClass@@ present-unmatched
RendererListContainerClass::~RendererListContainerClass()
{
	Unregister_All();
}

// ?Register_Renderer@RendererListContainerClass@@ present-unmatched
...
// ?Unregister_All@RendererListContainerClass@@ present-unmatched
...
// ?Flush@RendererListContainerClass@@ present-unmatched
...
// upstream layout: inputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/wwshade/shdrenderer.h
...
/////////////////////////////////////////////////////////////////////////////////////
// ??0ShdDX8RendererClass@@ present-unmatched
...
// ??1ShdDX8RendererClass@@ present-unmatched
ShdDX8RendererClass::~ShdDX8RendererClass()
{
	for (int i=0;i<SHDDEF_CLASSID_LAST;++i) 
	{
...
// ?Greater_Than@ShdDX8RendererNodeClass@@ present-unmatched
...
// ?Similar_Enough@ShdDX8RendererNodeClass@@ present-unmatched
...
/////////////////////////////////////////////////////////////////////////////////////
// ?Flush@ShdDX8RendererClass@@ present-unmatched
...
/////////////////////////////////////////////////////////////////////////////////////
// ??0MeshContainerClass@@ present-unmatched
ShdDX8RendererClass::MeshContainerClass::MeshContainerClass()
{
}

// ??1MeshContainerClass@@ present-unmatched
ShdDX8RendererClass::MeshContainerClass::~MeshContainerClass()
{
...
/////////////////////////////////////////////////////////////////////////////////////
// ?Flush@MeshContainerClass@@ present-unmatched
...
// ??1ShdDX8RendererNodeClass@@ present-unmatched
ShdDX8RendererNodeClass::~ShdDX8RendererNodeClass()
{
	unsigned stream_count=SubMesh->Peek_Shader()->Get_Vertex_Stream_Count();
	unsigned n;
 ...
 *   6/02/2002  kjm : Added light environment handling
 *=============================================================================================*/
// ?Render@ShdDX8RendererNodeClass@@ present-unmatched
...
// ?Flush@ShdDX8RendererNodeClass@@ present-unmatched
...
// ?Apply_Shared_Shader_Settings@ShdDX8RendererNodeClass@@ present-unmatched
