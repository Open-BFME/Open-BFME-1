...
// readable body of ?getWaypointByName@TerrainLogic@@UAEPAVWaypoint@@VAsciiString@@@Z: game/GameEngine/Source/GameLogic/Map/TerrainLogic.cpp
// readable body of ?getClosestWaypointOnPath@TerrainLogic@@UAEPAVWaypoint@@PBUCoord3D@@VAsciiString@@@Z: game/GameEngine/Source/GameLogic/Map/TerrainLogic.cpp
// readable body of ?isPurposeOfPath@TerrainLogic@@UAE_NPAVWaypoint@@VAsciiString@@@Z: game/GameEngine/Source/GameLogic/Map/TerrainLogic.cpp
// readable body of ?getWaterHandleByName@TerrainLogic@@UAEPBVWaterHandle@@VAsciiString@@@Z: game/GameEngine/Source/GameLogic/Map/TerrainLogic.cpp
