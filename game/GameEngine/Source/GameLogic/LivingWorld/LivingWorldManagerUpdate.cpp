...
public:
	...
	// methods targets/game/reverse/symbols.csv gives this class -- report, run, after,
...
// void * mapped type: targets/game/reverse/symbols.csv pins retail's shared hashtable::begin
