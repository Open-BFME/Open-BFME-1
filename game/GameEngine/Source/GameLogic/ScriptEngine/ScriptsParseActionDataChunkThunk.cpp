...
// readable body of ?ParseActionDataChunk@ScriptAction@@SA_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX@Z: game/GameEngine/Source/GameLogic/ScriptEngine/Scripts.cpp
