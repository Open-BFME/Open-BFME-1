...
// stlport
// Retail RVA 0x002E8C30, 508 bytes.  The Lua registration at 0x002EC990
// binds ILT 0x0003C53D to this callback as ObjectBroadcastEventToUnits.
...
struct Rva002E8C30Entry
{
	Object *object;
	unsigned unknown04;
};

struct Rva002E8C30ResultData
{
	std::vector<Rva002E8C30Entry> entries;
	Rva002E8C30Entry *current;
	int references;
};

struct BfmeWideResult
{
	Rva002E8C30ResultData *value;
