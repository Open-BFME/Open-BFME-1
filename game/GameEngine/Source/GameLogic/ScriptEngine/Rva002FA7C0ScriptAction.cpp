...
// stlport
// Opaque owner for the retail body at RVA 0x002FA7C0.
// ScriptActions::executeAction template 427 reaches this body through an ILT.
...
class Rva002FA7C0ScriptActionOwner
{
protected:
	void apply(const AsciiString &unitName, const AsciiString &commandAbility);
};

// ?apply@Rva002FA7C0ScriptActionOwner@@IAEXABVAsciiString@@0@Z
void Rva002FA7C0ScriptActionOwner::apply(
