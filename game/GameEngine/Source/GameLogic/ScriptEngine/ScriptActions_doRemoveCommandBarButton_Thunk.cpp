// cl: /DNDEBUG /MD /EHsc
// Open-BFME5: lift MASM dump ScriptActions::doRemoveCommandBarButton to C++ thunk.
...
__declspec(naked) void ScriptActions::doRemoveCommandBarButton(const AsciiString &, const AsciiString &)
{
__asm {
        __emit 0x83
        __emit 0xec
