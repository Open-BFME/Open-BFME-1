// cl: /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /D_STLP_USE_STATIC_LIB /Iinputs/reference/shims/stringbaseascii /Iinputs/reference/shims/asciistring_downloadmanager /Iinputs/reference/shims/sweep /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Include /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Include /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWLib
// stlport
...
// The record is only ever a full-expression temporary: the pair is built from it
// inside the insert call, so both live until insert returns (pair destroyed
// first, record second, as retail does) and MSVC addresses the record through
// the sret pointer the helper returns in eax.
struct Rva0033F870Record : Rva0033F870Pair
{
	Rva0033F870Record(const BfmeOtherDPB &o)
		: Rva0033F870Pair(*(const AsciiString *)&o.m_bfmeHead, *(const Rva0033F870Value *)&o.m_bfmeVal) {}
};
...
void ScriptEngine::setHumanImpassableArea(const AsciiString &name, bool blocked)
{
	...
	if (found != m_humanImpassableAreas.header()) {
		*(char *)((char *)found + 0x14) = blocked;
		...
		m_humanImpassableAreas.insert(Rva0033F870Record(bfmeGoDPB(name, blocked)));
	}
}
