...
// stlport
// Retail RVA 0x002E8950, 577 bytes.  The Lua registration at 0x002EC990
// binds ILT 0x0002D614 to this callback as ObjectBroadcastEventToCivilians.
...
struct Rva002E8950Entry
{
	Object *object;
	unsigned unknown04;
};

struct Rva002E8950ResultData
{
	std::vector<Rva002E8950Entry> entries;
	Rva002E8950Entry *current;
	int references;
};

struct BfmeWideResult
{
	Rva002E8950ResultData *value;
...
int ObjectBroadcastEventToCivilians(lua_State *state)
{
	...
	PartitionFilterRelationship relationship(object, 2, false);
