...
// (game/GameEngine/Source/GameLogic/ScriptEngine/ScriptActions_doSpeechPlay.cpp,
...
// the pin note on targets/game/reverse/symbols.csv:10765) and the same four callees
