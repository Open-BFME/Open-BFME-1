...
//-------------------------------------------------------------------------------------------------
// ?buildFieldParse@FlightDeckBehaviorModuleData@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??0FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?buildInfo@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?purgeDead@FlightDeckBehavior@@ present-unmatched
...
// ?hasReservedSpace@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getSpaceIndex@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?findPPI@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?findEmptyPPI@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// note: called from client, so MUST NOT modify self in any way, or desyncs will occur
// ?shouldReserveDoorWhenQueued@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// note: called from client, so MUST NOT modify self in any way, or desyncs will occur
// ?hasAvailableSpaceFor@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reserveSpace@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?validateAssignments@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calcPPInfo@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?releaseSpace@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getRunwayReservation@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?transferRunwayReservationToNextInLineForTakeoff@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reserveRunway@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?releaseRunway@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isAbleToGiveUpParkingSpace@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isInPositionToTakeoff@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isAbleToMoveForward@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calcBestParkingAssignment@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?resetWakeFrame@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setHealee@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?defectAllParkedUnits@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?killAllParkedUnits@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onDie@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reserveDoorForExit@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?exitObjectViaDoor@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?unreserveDoorForExit@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?aiDoCommand@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?propagateOrdersToPlanes@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?hasTakeoffOrders@FlightDeckBehavior@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?propagateOrderToSpecificPlane@FlightDeckBehavior@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@FlightDeckBehavior@@ present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@FlightDeckBehavior@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@FlightDeckBehavior@@ present-unmatched
