// ?rva001B5A30@Locomotor@@QBEMPAVObject@@W4BodyDamageType@@@Z
...
{
public:
	Real rva001B5A30(Object *object, BodyDamageType condition) const;
...
Real Locomotor::rva001B5A30(Object *object, BodyDamageType condition) const
{
