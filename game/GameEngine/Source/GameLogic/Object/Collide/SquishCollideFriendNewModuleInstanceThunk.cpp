// cl: /DNDEBUG /MD /EHsc
// Open-BFME5: SquishCollide::friend_newModuleInstance factory, retail 0x0011EBA0,
// converted out of a machine byte dump and repointed off 0x0011E2D0.
//
// The registration block pairs the AsciiString "SquishCollide" with this address, and
...
//
// The constructor is reached through link thunk 0x0003B16A, which lands on
// 0x00216BA0.
...
{
public:
	SquishCollide(Thing *, const ModuleData *);
...
Module *SquishCollide::friend_newModuleInstance(Thing *thing, const ModuleData *data)
{
	return (Module *)new SquishCollide(thing, data);
}
