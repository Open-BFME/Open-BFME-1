...
// module data (+4) and object (+8) are read at -0xC and -8. The Player::addRadar
// identity at 0x000CBFA0 follows from the matched caller and Boolean argument.
// BFME's module lookup is the protected Object::findModule.
