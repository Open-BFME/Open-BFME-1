...
//-------------------------------------------------------------------------------------------------
// ??0LocomotorTemplate@@QAE@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1LocomotorTemplate@@MAE@XZ present-unmatched
LocomotorTemplate::~LocomotorTemplate()
{
...
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/Object/Locomotor_ctor_template_Thunk.cpp
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@Locomotor@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@Locomotor@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@Locomotor@@MAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?startMove@Locomotor@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMaxSpeedForCondition@Locomotor@@QBEMW4BodyDamageType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMaxTurnRate@Locomotor@@QBEMW4BodyDamageType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMaxAcceleration@Locomotor@@QBEMW4BodyDamageType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getBraking@Locomotor@@QBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMaxLift@Locomotor@@QBEMW4BodyDamageType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?locoUpdate_moveTowardsAngle@Locomotor@@QAEXPAVObject@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?rotateTowardsPosition@Locomotor@@IAE?AW4PhysicsTurningType@@PAVObject@@ABUCoord3D@@PAM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setPhysicsOptions@Locomotor@@QAEXPAVObject@@@Z present-unmatched
...
// Body in Locomotor_locoUpdate_moveTowardsPosition.asm (exact 1103B retail).

//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionTreads@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionWheels@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?fixInvalidPosition@Locomotor@@IAE_NPAVObject@@PAVPhysicsBehavior@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calcMinTurnRadius@Locomotor@@QBEMW4BodyDamageType@@PAM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionLegs@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionClimb@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionWings@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionHover@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionThrust@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?rotateObjAroundLocoPivot@Locomotor@@IAE?AW4PhysicsTurningType@@PAVObject@@ABUCoord3D@@MPAM@Z present-unmatched
...
*/
// ?handleBehaviorZ@Locomotor@@IAE_NPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveTowardsPositionOther@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@ABUCoord3D@@MM@Z present-unmatched
...
/*
	...
	resting on the ground), false if not (eg, we are hovering or circling)
*/
// ?locoUpdate_maintainCurrentPosition@Locomotor@@QAE_NPAVObject@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?maintainCurrentPositionThrust@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?maintainCurrentPositionWings@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?maintainCurrentPositionHover@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?maintainCurrentPositionOther@Locomotor@@IAEXPAVObject@@PAVPhysicsBehavior@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??4LocomotorSet@@AAEAAV0@ABV0@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1LocomotorSet@@QAE@XZ present-unmatched
LocomotorSet::~LocomotorSet()
{
	clear();
}
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@LocomotorSet@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@LocomotorSet@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@LocomotorSet@@MAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?xferSelfAndCurLocoPtr@LocomotorSet@@QAEXPAVXfer@@PAPAVLocomotor@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?clear@LocomotorSet@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// findLocomotor: matched via game/GameEngine/Source/GameLogic/Object/LocomotorAccessors.cpp
