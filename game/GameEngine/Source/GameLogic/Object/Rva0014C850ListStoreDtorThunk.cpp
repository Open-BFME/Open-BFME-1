...
// ??1Rva001B0820Store@@UAE@XZ (game/GameEngine/Source/GameLogic/Object/
...
// (game/gen_small/tgrid_105.cpp), not a hash_map clear, and after it the
// body manually frees the list's own dummy head node via
// _M_deallocate(node, 0x10) (game/Libraries/Source/WWVegas/WWLib/
...
// (game/gen_small/tgrid_105.cpp) so the list's own destructor chain matches.
