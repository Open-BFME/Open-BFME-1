...
// readable body of ?aiDoCommand@AIUpdateInterface@@: game/GameEngine/Source/GameLogic/Object/Update/AIUpdate.cpp
...
protected:
	...
	virtual void privateMoveToPosition(const Coord3D *position, CommandSourceType source) = 0;
	virtual void bfmePrivateCommand01(Object *object, CommandSourceType source) = 0;
	virtual void bfmePrivateCommand3F(const Coord3D *position, CommandSourceType source) = 0;
	virtual void dispatch_38(Object *object, CommandSourceType source) = 0;
	virtual void bfmePrivateCommand1C(const Coord3D *position, CommandSourceType source) = 0;
	virtual void bfmePrivateCommand1D(const Coord3D *position, CommandSourceType source) = 0;
	virtual void bfmePrivateCommand1E(const Coord3D *position, CommandSourceType source) = 0;
	virtual void bfmePrivateCommand37(const Coord3D *position, CommandSourceType source) = 0;
	...
	virtual void bfmePrivateCommand1B(const Coord3D *position, CommandSourceType source) = 0;
	...
	virtual void dispatch_c0(const Coord3D *position, CommandSourceType source) = 0;
	...
	virtual void dispatch_d8(const Coord3D *position, Int value, CommandSourceType source) = 0;
	...
	virtual void privateGuardRetaliate(Object *object, const Coord3D *position, Int value, CommandSourceType source) = 0;
	virtual void privateGuardAreaFromPosition(const PolygonTrigger *polygon, Int value, CommandSourceType source, const Coord3D *position) = 0;
	...
	virtual void dispatch_f4(const Coord3D *position, CommandSourceType source) = 0;
	virtual void dispatch_f8() = 0;
	virtual void privateCommandButton(const CommandButton *button, CommandSourceType source) = 0;
	virtual void privateCommandButtonPosition(const CommandButton *button, const Coord3D *position, CommandSourceType source) = 0;
