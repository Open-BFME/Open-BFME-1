...
// ??0DozerActionMoveToActionPosState@@QAE@PAVStateMachine@@W4DozerTask@@@Z
DozerActionMoveToActionPosState::DozerActionMoveToActionPosState(StateMachine *machine, DozerTask task) :
