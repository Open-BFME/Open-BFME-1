...
//
// Identity: the constructor at 0x002BEC00 -- already in the ledger as
// ??0AIGiantBirdFollowThruState@@QAE@PAX_N@Z, and self-naming with the literal
// "AIGiantBirdFollowThruState" -- stores vftable 0x010C7968, whose slot 5 is
// this body.
//
// The state clears all four flight-condition groups, rebuilds the ground goal,
// then resets the attached locomotor's landing state.
...
// ?onExit@AIGiantBirdFollowThruState@@UAEXW4StateExitType@@@Z
