// cl: /DNDEBUG /MD /EHsc
// WorkerAIUpdate::findGoodBuildOrRepairPosition, retail RVA 0x002C8A20 (1154 bytes).
...
// The retail call site cleans its own three arguments, so this is the free
// __cdecl findPositionAround already pinned at ILT 0x00026C4C, which jumps to
// the body at RVA 0x001AF610. The return value is ignored here.
...
bool WorkerAIUpdate::findGoodBuildOrRepairPosition(const Object*me,const Object*target,Coord3D&positionOut){
 ...
 bool spotFound=findNearestLabeledContactPointOnTarget((Object*)target,&bestPosition,&workingPosition,skipCollideTest);
 if(g_bfmeDockingTraceActive&&TheCRCParameterCheck)
