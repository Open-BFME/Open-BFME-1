// cl: /DNDEBUG /MD /EHsc
// Open-BFME5: lift the BloodthirstyUpdate constructor to clean C++.
...
class BloodthirstyUpdate : public UpdateModule,
    public BloodthirstyUpdateIface
{
public:
    BloodthirstyUpdate(Thing *, const ModuleData *);
...
// ??0BloodthirstyUpdate@@QAE@PAVThing@@PBVModuleData@@@Z
