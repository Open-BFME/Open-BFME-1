...
class LargeGroupAudioUpdateInterface { public: virtual void anchor(); };
class LargeGroupAudioUpdate : public UpdateModule, public LargeGroupAudioUpdateInterface
{
public:
...
// ?forceDestructorEmission@LargeGroupAudioUpdate@@SAXXZ absent-from-retail
void LargeGroupAudioUpdate::forceDestructorEmission()
{
	// A local instance makes MSVC emit the protected scalar-deleting destructor.
	LargeGroupAudioUpdate value;
}
