// cl: /DNDEBUG /MD /EHsc
// readable body of ??0HordeUpdateModuleData@@: game/GameEngine/Source/GameLogic/Object/Update/HordeUpdate.cpp
...
// `?set@AsciiString@@QAEXPBDH@Z` (see targets/game/reverse/symbols.csv). +0x04 is a gap
