...
// Retail 0x002D25E0, 342 bytes: SupplyCenterProductionExitUpdate::getNaturalRallyPoint.
...
bool SupplyCenterProductionExitUpdate::getNaturalRallyPoint(Coord3D &rallyPoint, bool offset) const
{
	const SupplyCenterProductionExitUpdateModuleData *data =
		*reinterpret_cast<const SupplyCenterProductionExitUpdateModuleData *const *>(
