// cl: /DNDEBUG /MD /EHsc
// Open-BFME5: DetachableRiderUpdate::friend_newModuleInstance factory, retail 0x0011CAF0,
...
// "DetachableRiderUpdate" and pushes this factory's address as the argument beside
// it, the way addModule takes them.
//
// Retail allocates 0x24 bytes here, which is sizeof(DetachableRiderUpdate), and calls
// the constructor through link thunk 0x0004773F.
...
Module *DetachableRiderUpdate::friend_newModuleInstance(Thing *thing, const ModuleData *data)
{
	return (Module *)new DetachableRiderUpdate(thing, data);
}
