...
public:
	...
	// Body: game/masm_dumps/AttackNugget_create_1D7BC0.asm (exact 334B @ 0x1D7BC0)
	// Retail: AI@Object+0x204, fields +0x34/+0x38/+0x3c, setWeaponLock on Object, ret 0x10.
	virtual Object* create( const Object* primaryObj, const Coord3D *primary, const Coord3D* secondary, Real angle, UnsignedInt lifetimeFrames = 0 ) const;

	// ?parse@AttackNugget@@SAXPAVINI@@PAX1PBX@Z
	// Body: game/masm_dumps/AttackNugget_parse_1D8770.asm
...
public:
	...
	// Body: game/masm_dumps/DeliverPayloadNugget_parsePayload_29FCC0.asm
...
public:
	...
	// Body: game/masm_dumps/GenericObjectCreationNugget_parseDebris_1DAE40.asm
...
// Body: game/masm_dumps/GenericObjectCreationNugget_dtor_1D8220.asm
...
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/ObjectCreationListStoreDestructorThunk.cpp
