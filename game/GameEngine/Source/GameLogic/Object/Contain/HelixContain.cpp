...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0HelixContainModuleData@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?buildFieldParse@HelixContainModuleData@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1HelixContain@@ present-unmatched
...
// ?onObjectCreated@HelixContain@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?update@HelixContain@@ present-unmatched
...
// ?redeployOccupants@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?createPayload@HelixContain@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?onBodyDamageStateChange@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?getPortableStructure@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onDie@HelixContain@@ present-unmatched
...
// ?onDie@TransportContain@@ present-unmatched
	TransportContain::onDie( damageInfo );//extend base class
}

//-------------------------------------------------------------------------------------------------
// ?onDelete@HelixContain@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?onCapture@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?addToContainList@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?addToContain@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?removeFromContain@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isValidContainerFor@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?friend_getRider@HelixContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isEnclosingContainerFor@HelixContain@@ present-unmatched
...
// ?clientVisibleContainedFlashAsSelected@HelixContain@@ present-unmatched
...
// ?isPassengerAllowedToFire@HelixContain@@ present-unmatched
...
// ?isPassengerAllowedToFire@TransportContain@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onContaining@HelixContain@@ present-unmatched
...
// ?onRemoving@HelixContain@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@HelixContain@@ present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@HelixContain@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@HelixContain@@ present-unmatched
