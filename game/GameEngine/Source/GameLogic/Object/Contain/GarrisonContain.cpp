...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/GarrisonContainModuleDataCtorThunk.cpp
...
// ------------------------------------------------------------------------------------------------
// ?getObjectGarrisonPointIndex@GarrisonContain@@IAEHPAVObject@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calcBestGarrisonPosition@GarrisonContain@@MAE_NPAUCoord3D@@PBU2@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/GarrisonContainCtorThunk.cpp
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1GarrisonContain@@MAE@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?isValidContainerFor@GarrisonContain@@UBE_NPBVObject@@_N@Z present-unmatched
...
/** Are there any objects in the center that have now obtained targets and need to move to
	* a garrison point */
	// ------------------------------------------------------------------------------------------------
// ?addValidObjectsToGarrisonPoints@GarrisonContain@@IAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?updateEffects@GarrisonContain@@IAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?matchObjectsToGarrisonPoints@GarrisonContain@@IAEXXZ present-unmatched
...
/** enforce that everybody stays at their pre-assigned space */
// ------------------------------------------------------------------------------------------------
// ?positionObjectsAtStationGarrisonPoints@GarrisonContain@@IAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?pickAStationForMe@GarrisonContain@@IAE_NPBVObject@@@Z present-unmatched
...
// ?removeObjectFromStationPoint@GarrisonContain@@IAEXPBVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?onDamage@GarrisonContain@@UAEXPAVDamageInfo@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?healObjects@GarrisonContain@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onSelling@GarrisonContain@@UAEXXZ present-unmatched
...
/** Remove all contents of this container.  We will try to do so with intelligent garrison
	...
	* call is complete */
// ------------------------------------------------------------------------------------------------
// ?removeAllContained@GarrisonContain@@UAEX_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?exitObjectViaDoor@GarrisonContain@@UAEXPAVObject@@W4ExitDoorType@@@Z matched 732 bytes (Open-BFME5)
__declspec(naked) void GarrisonContain::exitObjectViaDoor( Object *, ExitDoorType )
{
	__asm
	{
		__emit 0x6a;
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?onRemoving@GarrisonContain@@UAEXPAVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?isPassengerAllowedToFire@GarrisonContain@@UBE_NW4ObjectID@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?moveObjectsWithMe@GarrisonContain@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?onBodyDamageStateChange@GarrisonContain@@UAEXPBVDamageInfo@@W4BodyDamageType@@1@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@GarrisonContain@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/GarrisonContain_xfer_Thunk.cpp
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@GarrisonContain@@MAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?loadStationGarrisonPoints@GarrisonContain@@IAEXXZ present-unmatched
