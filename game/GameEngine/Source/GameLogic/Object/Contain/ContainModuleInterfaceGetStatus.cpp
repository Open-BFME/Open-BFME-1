// Retail 0x0022B480: ContainModuleInterface::getStatus(Object *) const.
...
class RiderChangeContainModuleData : public OpenContainModuleData
{
};

class RiderChangeContain : public ContainModuleInterface
{
public:
	virtual Rva221A50Triple getStatus(Object *object) const;
	...
	{
		return *(RiderChangeContainModuleData **)((char *)this - 0x1c);
	}
...
Rva221A50Triple RiderChangeContain::getStatus(Object *object) const
{
