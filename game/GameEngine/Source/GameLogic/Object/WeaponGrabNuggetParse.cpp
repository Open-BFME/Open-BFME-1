...
// stlport
//
// The INI `Weapon` block's `GrabNugget = ` field callback (the exe's
// FieldParse table at 0x0109FE18 maps that token to 0x001E5FD0), a 166-byte
...
// targets/game/reverse/symbols.csv and keep their address-derived names.
...
{
	Rva002DCBA0 *m = new Rva002DCBA0;
	m->m_owner = weapon;
	q4Notify001E5FD0( ini, m, 0, 0 );
