...
// ManTheWallsSpecialPowerModuleData's constructor, retail 0x00261260. Eighteen bytes: the
...
class ManTheWallsSpecialPowerModuleData : public BfmeSpecialPowerModuleDataBase
{
public:
	ManTheWallsSpecialPowerModuleData();
};

ManTheWallsSpecialPowerModuleData::ManTheWallsSpecialPowerModuleData()
{
}
