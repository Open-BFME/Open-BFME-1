// cl: /DNDEBUG /MD /EHsc
// Open-BFME5: EvacuateDamage::friend_newModuleInstance factory, retail 0x0011EA10,
...
// "EvacuateDamage" and pushes this factory's address as the argument beside
// it, the way addModule takes them.
//
// Retail allocates 0x18 bytes here, which is sizeof(EvacuateDamage), and calls
// the constructor through link thunk 0x0003BD40.
...
Module *EvacuateDamage::friend_newModuleInstance(Thing *thing, const ModuleData *data)
{
	return (Module *)new EvacuateDamage(thing, data);
}
