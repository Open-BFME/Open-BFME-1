...
//-------------------------------------------------------------------------------------------------
// ?testWeaponSetFlag@WeaponTemplateSet@@QBE_NW4WeaponSetType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??0WeaponSet@@QAE@XZ present-unmatched
WeaponSet::WeaponSet()
{
...
//-------------------------------------------------------------------------------------------------
// ??1WeaponSet@@QAE@XZ — body in game/masm_dumps/WeaponSet_destructor.asm (0x1EAD40, 95B)
// Retail: 4 weapon slots (not ZH's 3), scalar-deleting virtual delete, Snapshot vtbl restore.

// ------------------------------------------------------------------------------------------------
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@WeaponSet@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@WeaponSet@@MAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?weaponSetOnWeaponBonusChange@WeaponSet@@QAEXPBVObject@@@Z present-unmatched
...
// ?getAbleToUseWeaponAgainstTarget@WeaponSet@@QBE?AW4CanAttackResult@@W4AbleToAttackType@@PBVObject@@1PBUCoord3D@@W4CommandSourceType@@W4WeaponSlotType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?chooseBestWeaponForTarget@WeaponSet@@QAE_NPBVObject@@0W4WeaponChoiceCriteria@@W4CommandSourceType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMostPercentReadyToFireAnyWeapon@WeaponSet@@QBEIXZ present-unmatched
...
// ?setWeaponLock@WeaponSet@@QAE_NW4WeaponSlotType@@W4WeaponLockType@@@Z present-unmatched
...
// ?releaseWeaponLock@WeaponSet@@QAEXW4WeaponLockType@@@Z present-unmatched
...
// ?clearLeechRangeModeForAllWeapons@WeaponSet@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isSharedReloadTime@WeaponSet@@QBE_NXZ present-unmatched
