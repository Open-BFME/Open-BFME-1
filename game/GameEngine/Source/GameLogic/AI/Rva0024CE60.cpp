...
// only because the targets/game/reverse/functions.csv row was landed under it, and renaming
...
// object: targets/game/reverse/functions.csv rows for 0x0024BA90 and 0x0024CDB0, reached
