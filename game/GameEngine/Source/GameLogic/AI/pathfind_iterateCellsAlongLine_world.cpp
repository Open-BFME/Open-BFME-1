...
// readable body of ?iterateCellsAlongLine@Pathfinder@@: game/GameEngine/Source/GameLogic/AI/AIPathfind.cpp
...
// targets/game/reverse/symbols.csv both show the cell-space walk taking four arguments with
