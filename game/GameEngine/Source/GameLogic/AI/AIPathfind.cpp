...
//-----------------------------------------------------------------------------------
// ??0PathNode@@QAE@XZ present-unmatched
PathNode::PathNode() :
	m_nextOpti(0),
	m_next(0),
	m_prev(0),
...
//-----------------------------------------------------------------------------------
// ??1PathNode@@MAE@XZ present-unmatched
PathNode::~PathNode()
{
}
								 
//-----------------------------------------------------------------------------------
// ?setNextOptimized@PathNode@@QAEXPAV1@@Z present-unmatched
...
// ?prependToList@PathNode@@QAEPAV1@PAV1@@Z present-unmatched
...
/// @todo optimize this
// ?appendToList@PathNode@@QAEPAV1@PAV1@@Z present-unmatched
...
// ?append@PathNode@@QAEXPAV1@@Z present-unmatched
 ...
 */
// ?computeDirectionVector@PathNode@@ present-unmatched
...
//-----------------------------------------------------------------------------------
// ??0Path@@QAE@XZ present-unmatched
Path::Path():
m_path(NULL),
m_pathTail(NULL),
m_isOptimized(FALSE), 
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@Path@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@Path@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@Path@@MAEXXZ present-unmatched
 ...
 */
// ?prependNode@Path@@QAEXPBUCoord3D@@W4PathfindLayerEnum@@@Z present-unmatched
 ...
 * Create a new node at the tail of the path
 */
// ?updateLastNode@Path@@QAEXPBUCoord3D@@@Z present-unmatched
...
// Body in AIPathfind_Path_optimize.asm (exact 669B retail @ 0x401660).
// Queue 0x433E7A was INSIDE unrelated FUN_00833dc0; BFME Path is single-vptr (m_path@+4).

/**
 * Optimize the path by checking line of sight
 */
// ?optimizeGroundPath@Path@@QAEX_NH@Z present-unmatched
 ...
 */
// ?computePointOnPath@Path@@QAEXPBVObject@@ABVLocomotorSet@@ABUCoord3D@@AAUClosestPointOnPathInfo@@@Z present-unmatched
 ...
 */
// ?computeFlightDistToGoal@Path@@QAEMPBUCoord3D@@AAU2@@Z present-unmatched
 ...
 */
// ?releaseCellInfos@PathfindCellInfo@@SAXXZ present-unmatched
 ...
 */
// ?getACellInfo@PathfindCellInfo@@SAPAV1@PAVPathfindCell@@ABUICoord2D@@@Z present-unmatched
 ...
 */
// ?releaseACellInfo@PathfindCellInfo@@SAXPAV1@@Z present-unmatched
 ...
 * Constructor
 */
// ??0PathfindCell@@QAE@XZ present-unmatched
 ...
 * Destructor
 */
// ??1PathfindCell@@QAE@XZ present-unmatched
 ...
 */
// ?allocateInfo@PathfindCell@@QAE_NABUICoord2D@@@Z present-unmatched
 ...
 */
// ?releaseInfo@PathfindCell@@QAEXXZ present-unmatched
 ...
 */
// ?setGoalUnit@PathfindCell@@QAEXW4ObjectID@@ABUICoord2D@@@Z present-unmatched
 ...
 */
// ?setGoalAircraft@PathfindCell@@QAEXW4ObjectID@@ABUICoord2D@@@Z present-unmatched
 ...
 */
// ?setPosUnit@PathfindCell@@QAEXW4ObjectID@@ABUICoord2D@@@Z present-unmatched
 ...
 */
// ?setType@PathfindCell@@QAEXW4CellType@1@@Z present-unmatched
 ...
 */
// ?removeObstacle@PathfindCell@@QAE_NPAVObject@@@Z present-unmatched
...
// ?putOnSortedOpenList@PathfindCell@@QAEPAV1@PAV1@@Z present-unmatched
...
// ?removeFromOpenList@PathfindCell@@QAEPAV1@PAV1@@Z present-unmatched
...
// ?releaseOpenList@PathfindCell@@SAHPAV1@@Z present-unmatched
...
// ?releaseClosedList@PathfindCell@@SAHPAV1@@Z present-unmatched
...
// ?putOnClosedList@PathfindCell@@QAEPAV1@PAV1@@Z present-unmatched
...
// ?removeFromClosedList@PathfindCell@@QAEPAV1@PAV1@@Z present-unmatched
...
// ?costToGoal@PathfindCell@@QAEIPAV1@@Z present-unmatched
...
//------------------------  ZoneBlock  -------------------------------
// ??0ZoneBlock@@QAE@XZ present-unmatched
...
// ??1ZoneBlock@@QAE@XZ present-unmatched
ZoneBlock::~ZoneBlock()  
{
	freeZones();
}

// byte-exact reconstruction: game/GameEngine/Source/GameClient/System/FXParticleSystem/fx_particle_system_bulk.cpp
...
// ?blockCalculateZones@ZoneBlock@@QAEXPAPAVPathfindCell@@QAVPathfindLayer@@ABUIRegion2D@@@Z present-unmatched
...
//
// ?getEffectiveZone@ZoneBlock@@QBEGH_NG@Z present-unmatched
...
// ?allocateZones@ZoneBlock@@IAEXXZ present-unmatched
...
// ?freeZones@PathfindZoneManager@@AAEXXZ present-unmatched
...
/* Allocate zone equivalency arrays large enough to hold m_maxZone entries.  If the arrays are already
large enough, just return. */
// ?allocateZones@PathfindZoneManager@@AAEXXZ present-unmatched
...
// ?markZonesDirty@PathfindZoneManager@@QAEX_N@Z present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/PathfindZoneManagerCalculateZones.cpp
 ...
 */
// ?updateZonesForModify@PathfindZoneManager@@QAEXPAPAVPathfindCell@@QAVPathfindLayer@@ABUIRegion2D@@2@Z present-unmatched
...
//
// ?clearPassableFlags@PathfindZoneManager@@QAEXXZ present-unmatched
...
//
// ?setAllPassable@PathfindZoneManager@@QAEXXZ present-unmatched
...
//
// ?setPassable@PathfindZoneManager@@QAEXHH_N@Z present-unmatched
...
//
// ?isPassable@PathfindZoneManager@@QBE_NHH@Z present-unmatched
...
// Get the passable flag for the block at this location.
//
// ?clipIsPassable@PathfindZoneManager@@QBE_NHH@Z present-unmatched
...
//
// ?setBridge@PathfindZoneManager@@QAEXHH_N@Z present-unmatched
...
// Set the bridge flag for the block at this location.
//
// ?interactsWithBridge@PathfindZoneManager@@QBE_NHH@Z present-unmatched
...
// Return the zone at this location.
//
// ?getBlockZone@PathfindZoneManager@@QBEGH_NHHPAPAVPathfindCell@@@Z present-unmatched
...
// Return the zone at this location.
//
// ?getEffectiveTerrainZone@PathfindZoneManager@@QBEGG@Z present-unmatched
...
// Return the zone at this location.
//
// ?getEffectiveZone@PathfindZoneManager@@QBEGH_NG@Z present-unmatched
...
//-------------------- PathfindLayer ----------------------------------------
// ??0PathfindLayer@@QAE@XZ present-unmatched
...
// ??1PathfindLayer@@QAE@XZ present-unmatched
 ...
 */
// ?reset@PathfindLayer@@QAEXXZ present-unmatched
 ...
 * Returns true if the layer is avaialble for use.
 */
// ?isUnused@PathfindLayer@@QAE_NXZ present-unmatched
 ...
 */
#if defined _DEBUG || defined _INTERNAL
// ?doDebugIcons@PathfindLayer@@ present-unmatched
 ...
 */
// ?allocateCells@PathfindLayer@@QAEXPBUIRegion2D@@@Z present-unmatched
 ...
 */
// ?allocateCellsForWallLayer@PathfindLayer@@QAEXPBUIRegion2D@@PAW4ObjectID@@H@Z present-unmatched
 ...
 */
// ?classifyWallCells@PathfindLayer@@QAEXPAW4ObjectID@@H@Z present-unmatched
 ...
 */
// ?applyZone@PathfindLayer@@QAEXXZ present-unmatched
 ...
 */
// ?getBridgeID@PathfindLayer@@QAE?AW4ObjectID@@XZ present-unmatched
 ...
 */
// ?classifyLayerMapCell@PathfindLayer@@IAEXHHPAVPathfindCell@@PAVBridge@@@Z present-unmatched
 ...
 * Classify the given map cell as clear, or not, etc.
 */
// ?classifyWallMapCell@PathfindLayer@@IAEXHHPAVPathfindCell@@PAW4ObjectID@@H@Z present-unmatched
...
// ??0Pathfinder@@QAE@XZ present-unmatched
...
// ??1Pathfinder@@QAE@XZ present-unmatched
 ...
 */
// ?addWallPiece@Pathfinder@@QAEXPAVObject@@@Z present-unmatched
 ...
 */
// ?removeWallPiece@Pathfinder@@QAEXPAVObject@@@Z present-unmatched
 ...
 */
// ?isPointOnWall@Pathfinder@@QAE_NPBUCoord3D@@@Z present-unmatched
 ...
 */
// ?updateLayer@Pathfinder@@QAEXPAVObject@@W4PathfindLayerEnum@@@Z present-unmatched
 ...
 */
// ?classifyFence@Pathfinder@@IAEXPAVObject@@_N@Z present-unmatched
 ...
 * If 'insert' is false, object is being removed 
 */
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WW3D2/part_buf.cpp
 ...
 */
// ?newMap@Pathfinder@@QAEXXZ present-unmatched
 ...
 */
// ?classifyMap@Pathfinder@@IAEXXZ present-unmatched
 ...
 */
// ?forceMapRecalculation@Pathfinder@@QAEXXZ present-unmatched
 ...
 */
// ?debugShowSearch@Pathfinder@@IAEX_N@Z present-unmatched
...
//
// ?validMovementTerrain@Pathfinder@@QAE_NW4PathfindLayerEnum@@PBVLocomotor@@PBUCoord3D@@@Z present-unmatched
...
//
// ?cleanOpenAndClosedLists@Pathfinder@@QAEXXZ present-unmatched
...
// Return true if we can move onto this position
//
// ?validMovementPosition@Pathfinder@@ present-unmatched
 ...
 */
// ?checkDestination@Pathfinder@@IAE_NPBVObject@@HHW4PathfindLayerEnum@@H_N@Z present-unmatched
 ...
 * Assumes your locomotor already said you can go there.
 */
// ?checkForMovement@Pathfinder@@IAE_NPBVObject@@AAUTCheckMovementInfo@@@Z present-unmatched
...
// ?checkForLanding@Pathfinder@@IAE_NHHW4PathfindLayerEnum@@H_NPAUCoord3D@@@Z present-unmatched
 ...
 */
// ?adjustToLandingDestination@Pathfinder@@QAE_NPAVObject@@PAUCoord3D@@@Z present-unmatched
 ...
 * Returns false if there are no spots available within a reasonable radius.
 */
// ?adjustDestination@Pathfinder@@QAE_NPAVObject@@ABVLocomotorSet@@PAUCoord3D@@PBU4@@Z present-unmatched
 ...
 * Returns false if there are no spots available within a reasonable radius.
 */
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/Pathfinder_adjustTargetDestination.cpp
...
// ?checkForPossible@Pathfinder@@IAE_N_NH0ABVLocomotorSet@@HHW4PathfindLayerEnum@@PAUCoord3D@@0@Z present-unmatched
 ...
 * Returns false if there are no spots available within a reasonable radius.
 */
// ?adjustToPossibleDestination@Pathfinder@@QAE_NPAVObject@@ABVLocomotorSet@@PAUCoord3D@@@Z present-unmatched
...
#if defined _DEBUG || defined _INTERNAL
// ?doDebugIcons@Pathfinder@@ present-unmatched
 ...
 */
// ?getAircraftPath@Pathfinder@@QAEPAVPath@@PBVObject@@PBUCoord3D@@@Z present-unmatched
...
// ?examineNeighboringCells@Pathfinder@@ present-unmatched
 ...
 * Uses A* algorithm.
 */
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/PathfinderFindPathThunk.cpp
 ...
 * Uses A* algorithm.
 */
// byte-exact reconstruction: game/masm_dumps/internalFindPath_Pathfinder_3F0340.asm
 ...
 */
// ?clearCellForDiameter@Pathfinder@@QAEH_NHHW4PathfindLayerEnum@@H@Z present-unmatched
 ...
 */
// ?buildGroundPath@Pathfinder@@IAEPAVPath@@_NPBUCoord3D@@PAVPathfindCell@@0H@Z present-unmatched
 ...
 * Work backwards from goal cell to construct final path.
 */
// ?buildHierachicalPath@Pathfinder@@IAEPAVPath@@PBUCoord3D@@PAVPathfindCell@@@Z present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/Common/Pathfinder_moveAlliesAwayFromDestination_Thunk.cpp
 ...
 * Uses A* algorithm.
 */
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/AIPathfind_findGroundPath.asm
 ...
 * Uses A* algorithm.
 */
// ?processHierarchicalCell@Pathfinder@@IAEXABUICoord2D@@0PAVPathfindCell@@1GPAGAAH_N3@Z present-unmatched
 ...
 * Uses A* algorithm.
 */
// ?findHierarchicalPath@Pathfinder@@IAEPAVPath@@_NABVLocomotorSet@@PBUCoord3D@@20@Z present-unmatched
 ...
 * Uses A* algorithm.
 */
// ?findClosestHierarchicalPath@Pathfinder@@IAEPAVPath@@_NABVLocomotorSet@@PBUCoord3D@@20@Z present-unmatched
 ...
 * Uses A* algorithm.
 */
// ?internal_findHierarchicalPath@Pathfinder@@IAEPAVPath@@_NHPBUCoord3D@@100@Z present-unmatched
 ...
 */
// ?findBrokenBridge@Pathfinder@@QAE_NABVLocomotorSet@@PBUCoord3D@@1PAW4ObjectID@@@Z present-unmatched
 ...
 */
// ?clientSafeQuickDoesPathExist@Pathfinder@@QAE_NABVLocomotorSet@@PBUCoord3D@@1@Z present-unmatched
 ...
 */
// ?slowDoesPathExist@Pathfinder@@QAE_NPAVObject@@PBUCoord3D@@1W4ObjectID@@@Z present-unmatched
 ...
 * Work backwards from goal cell to construct final path.
 */
// ?buildActualPath@Pathfinder@@IAEPAVPath@@PBVObject@@HPBUCoord3D@@PAVPathfindCell@@_N3@Z present-unmatched
 ...
 * Work backwards from goal cell to construct final path.
 */
// ?prependCells@Pathfinder@@IAEXPAVPath@@PBUCoord3D@@PAVPathfindCell@@_N@Z present-unmatched
 ...
 */
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/pathfind_iterateCellsAlongLine_world.cpp
...
//-----------------------------------------------------------------------------
// ?isViewBlockedByObstacle@Pathfinder@@QAE_NPBVObject@@0@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?segmentIntersectsTallBuilding@Pathfinder@@IAE_NPBVPathNode@@PAV2@W4ObjectID@@PAUCoord3D@@33@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?circleClipsTallBuilding@Pathfinder@@IAE_NPBUCoord3D@@0MW4ObjectID@@PAU2@@Z present-unmatched
 ...
 * Uses Bresenham line algorithm from www.gamedev.net.
 */
// ?isLinePassable@Pathfinder@@QAE_NPBVObject@@HW4PathfindLayerEnum@@ABUCoord3D@@2_N3@Z present-unmatched
 ...
 * Uses Bresenham line algorithm from www.gamedev.net.
 */
// ?isGroundPathPassable@Pathfinder@@QAE_N_NABUCoord3D@@W4PathfindLayerEnum@@1H@Z present-unmatched
 ...
 */
// ?updateGoal@Pathfinder@@QAEXPAVObject@@PBUCoord3D@@W4PathfindLayerEnum@@@Z present-unmatched
 ...
 * Updates the goal cell for an ai unit.
 */
// ?updateAircraftGoal@Pathfinder@@QAEXPAVObject@@PBUCoord3D@@@Z present-unmatched
 ...
 */
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WWLib/W3DRadarBuildTerrainTextureThunk.cpp
 ...
 */
// ?updatePos@Pathfinder@@QAEXPAVObject@@PBUCoord3D@@@Z present-unmatched
 ...
 * Uses A* algorithm.
 */
// ?getMoveAwayFromPath@Pathfinder@@QAEPAVPath@@PAVObject@@0PAV2@01@Z present-unmatched
...
// ?patchPath@Pathfinder@@EAEPAVPath@@PBVObject@@ABVLocomotorSet@@PAV2@_N@Z present-unmatched
...
// ?findAttackPath@Pathfinder@@EAEPAVPath@@PBVObject@@ABVLocomotorSet@@PBUCoord3D@@02PBVWeapon@@@Z present-unmatched
...
// ?findSafePath@Pathfinder@@EAEPAVPath@@PBVObject@@ABVLocomotorSet@@PBUCoord3D@@22M@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?crc@Pathfinder@@UAEXPAVXfer@@@Z present-unmatched
