...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0AIPlayer@@QAE@PAVPlayer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/AIPlayerOnStructureProducedThunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/AIPlayer_checkForSupplyCenter_Thunk.cpp
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?buildStructureNow@AIPlayer@@IAEPAVObject@@PBVThingTemplate@@PAVBuildListInfo@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?buildStructureWithDozer@AIPlayer@@IAEPAVObject@@PBVThingTemplate@@PAVBuildListInfo@@@Z present-unmatched
...
/** Build our base. */
// ------------------------------------------------------------------------------------------------
// ?processBaseBuilding@AIPlayer@@MAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?aiPreTeamDestroy@AIPlayer@@QAEXPBVTeam@@@Z present-unmatched
...
/** Guard supply center */
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/AIPlayer_guardSupplyCenter_Thunk.cpp
...
//-------------------------------------------------------------------------------------------------
// ?isSupplySourceAttacked@AIPlayer@@QAE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isLocationSafe@AIPlayer@@QAE_NPBUCoord3D@@PBVThingTemplate@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?onUnitProduced@AIPlayer@@UAEXPAVObject@@0@Z present-unmatched
 ...
 */
// ?computeSuperweaponTarget@AIPlayer@@UAE_NPBVSpecialPowerTemplate@@PAUCoord3D@@HM@Z present-unmatched
 ...
 */
// ?getPlayerSuperweaponValue@AIPlayer@@KAHPAUCoord3D@@HM_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findFactory@AIPlayer@@IAEPAVObject@@PBVThingTemplate@@_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?isPossibleToBuildTeam@AIPlayer@@IAE_NPAVTeamPrototype@@_NAA_N@Z present-unmatched
...
// Body in game/masm_dumps/_sa14__isAGoodIdeaToBuildTeam_AIPlayer__MAE_NPAVTeamPrototype___Z_167E80.asm (exact 786B retail @ 0x00167E80).
// ------------------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------------------
// ?buildSpecificAIBuilding@AIPlayer@@UAEXABVAsciiString@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?buildBySupplies@AIPlayer@@QAEXHABVAsciiString@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?calcClosestConstructionZoneLocation@AIPlayer@@QAE_NPBVThingTemplate@@PAUCoord3D@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?buildSpecificBuildingNearestTeam@AIPlayer@@QAEXABVAsciiString@@PBVTeam@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findSupplyCenter@AIPlayer@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?buildAIBaseDefense@AIPlayer@@UAEX_N@Z present-unmatched
...
/** Build a base defense. */
// ------------------------------------------------------------------------------------------------
// ?buildAIBaseDefenseStructure@AIPlayer@@UAEXABVAsciiString@@_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?repairStructure@AIPlayer@@UAEXW4ObjectID@@@Z present-unmatched
...
// Body in AIPlayer_recruitSpecificAITeam.asm (exact 1654B retail).

// ------------------------------------------------------------------------------------------------
/** Train our teams. */
// ------------------------------------------------------------------------------------------------
// ?processTeamBuilding@AIPlayer@@MAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?queueUnits@AIPlayer@@IAEXXZ present-unmatched
 ...
 */
// ?doBaseBuilding@AIPlayer@@MAEXXZ present-unmatched
 ...
 */
// ?checkQueuedTeams@AIPlayer@@MAEXXZ present-unmatched
 ...
 */
// ?doTeamBuilding@AIPlayer@@MAEXXZ present-unmatched
...
// ?update@AIPlayer@@UAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?computeCenterAndRadiusOfBase@AIPlayer@@IAEXPAUCoord3D@@PAM@Z present-unmatched
 ...
 */
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/AI/AIPlayer_dozerInQueue.cpp
...
//-------------------------------------------------------------------------------------------------
// ?getAIDifficulty@AIPlayer@@QBE?AW4GameDifficulty@@XZ present-unmatched
 ...
 */
// ?findDozer@AIPlayer@@MAEPAVObject@@PBUCoord3D@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@AIPlayer@@MAEXPAVXfer@@@Z present-unmatched
...
// Body in AIPlayer_xfer.asm (exact 1170B retail).
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?isMinimumBuilt@TeamInQueue@@QAE_NXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?includesADozer@TeamInQueue@@QAE_NXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?areBuildsComplete@TeamInQueue@@QAE_NXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/TeamInQueue_disbandMethodThunk.cpp
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TeamInQueue@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method 
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@TeamInQueue@@MAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?validateFactory@WorkOrder@@QAEXPAVPlayer@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@WorkOrder@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@WorkOrder@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@WorkOrder@@MAEXXZ present-unmatched
 ...
 */
// ?getPlayerStructureBounds@AIPlayer@@KAXPAURegion2D@@H_N@Z present-unmatched
