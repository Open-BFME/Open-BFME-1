...
// AIPlayer::getPlayerSuperweaponValue (inputs/reference/CnC_Generals_Zero_Hour/Generals/
// game/GameEngine/Source/GameLogic/AI/AIPlayer.cpp): the radius clamp to
