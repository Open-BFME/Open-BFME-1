...
// readable body of ??0NetCommandRef@@QAE@PAVNetCommandMsg@@@Z: game/GameEngine/Source/GameNetwork/NetCommandRef.cpp
...
// MemoryPoolObject, and any file under inputs/reference/shims/ forces the full gate.
