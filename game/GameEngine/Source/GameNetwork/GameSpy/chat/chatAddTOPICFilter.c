...
typedef void *CHAT;
typedef void (*chatGetChannelTopicCallback)(CHAT chat, int success,
	const char *channel, const char *topic, void *param);
...
int ciAddTOPICFilter(CHAT chat, const char *channel,
	chatGetChannelTopicCallback callback, void *param)
{
	return ciAddFilter(chat, 2, channel, 0, (void *)callback, 0, param, 0);
}
