...
// byte-exact reconstruction: game/GameEngine/Source/GameNetwork/GameSpy/Thread/GameResultsThread.cpp
...
// ?endThread@GameSpyBuddyMessageQueue@@UAEXXZ present-unmatched
...
// ?isConnected@GameSpyBuddyMessageQueue@@UAE_NXZ present-unmatched
Bool GameSpyBuddyMessageQueue::isConnected( void )
{
	return (m_thread) ? m_thread->isConnected() : false;
}

// ?isConnecting@GameSpyBuddyMessageQueue@@UAE_NXZ present-unmatched
...
// ?getThread@GameSpyBuddyMessageQueue@@QAEPAVBuddyThreadClass@@XZ present-unmatched
BuddyThreadClass* GameSpyBuddyMessageQueue::getThread( void )
{
	return m_thread;
}

// byte-exact reconstruction: game/GameEngine/Source/GameNetwork/GameSpy/Thread/BuddyGetLocalProfileIDThunk.cpp
...
// byte-exact reconstruction: game/GameEngine/Source/GameNetwork/GameSpy/Thread/BuddyThreadFunctionThunk.cpp
...
// byte-exact reconstruction: game/GameEngine/Source/Common/RTS/BuddyThreadClassErrorCallbackThunk.cpp
...
// byte-exact reconstruction: game/GameEngine/Source/Common/RTS/BuddyThreadClassConnectCallbackThunk.cpp
