...
// ??0LoadScreen@@ present-unmatched
LoadScreen::LoadScreen( void )
{
	m_loadScreen = NULL;		
}

// ??1LoadScreen@@ present-unmatched
LoadScreen::~LoadScreen( void )
{
	//if(m_loadScreen)
	//	delete (m_loadScreen);
...
//-----------------------------------------------------------------------------
// ??0SinglePlayerLoadScreen@@ present-unmatched
...
// ??1SinglePlayerLoadScreen@@ present-unmatched
SinglePlayerLoadScreen::~SinglePlayerLoadScreen( void )
{
	m_progressBar = NULL;
	m_percent = NULL;
...
// ?moveWindows@SinglePlayerLoadScreen@@ present-unmatched
...
// ?init@SinglePlayerLoadScreen@@ present-unmatched
...
// ?reset@SinglePlayerLoadScreen@@ present-unmatched
...
// ?update@SinglePlayerLoadScreen@@ present-unmatched
...
// ?setProgressRange@SinglePlayerLoadScreen@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ??0ChallengeLoadScreen@@ present-unmatched
...
// ??1ChallengeLoadScreen@@ present-unmatched
ChallengeLoadScreen::~ChallengeLoadScreen( void )
{
	m_progressBar = NULL;
	if(m_videoBuffer)
...
// ?activatePieces@ChallengeLoadScreen@@ present-unmatched
...
// ?activatePiecesMinSpec@ChallengeLoadScreen@@ present-unmatched
...
// ?init@ChallengeLoadScreen@@ present-unmatched
...
// ?reset@ChallengeLoadScreen@@ present-unmatched
...
// ?update@ChallengeLoadScreen@@ present-unmatched
...
// ?setProgressRange@ChallengeLoadScreen@@ present-unmatched
...
// ??1ShellGameLoadScreen@@ present-unmatched
ShellGameLoadScreen::~ShellGameLoadScreen( void )
{
...
// ?reset@ShellGameLoadScreen@@ present-unmatched
...
// ?update@ShellGameLoadScreen@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ??0MultiPlayerLoadScreen@@ present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/MultiPlayerLoadScreen_destructor_Thunk.cpp
...
// ?reset@MultiPlayerLoadScreen@@ present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/GameClient/GUI/MultiPlayerLoadScreenUpdate.cpp
...
//-----------------------------------------------------------------------------
// ??0GameSpyLoadScreen@@ present-unmatched
...
// ??1GameSpyLoadScreen@@ present-unmatched
GameSpyLoadScreen::~GameSpyLoadScreen( void )
{
	for(Int i = 0; i < MAX_SLOTS; ++i)
	{
...
// ?reset@GameSpyLoadScreen@@ present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/GameClient/GUI/GameSpyLoadScreenUpdate.cpp
...
//-----------------------------------------------------------------------------
// ??0MapTransferLoadScreen@@ present-unmatched
...
// ?reset@MapTransferLoadScreen@@ present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/GameClient/GUI/MapTransferLoadScreenUpdate.cpp
...
// ?processProgress@MapTransferLoadScreen@@ present-unmatched
...
// ?processTimeout@MapTransferLoadScreen@@ present-unmatched
...
// byte-exact reconstruction: game/GameEngine/Source/Common/MapTransferLoadScreenSetCurrentFilenameThunk.cpp
