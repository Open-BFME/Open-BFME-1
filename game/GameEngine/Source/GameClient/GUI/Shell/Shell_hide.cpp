// cl: /DNDEBUG /MD /EHsc
// readable body of ?hide@Shell@@QAEX_N@Z: game/GameEngine/Source/GameClient/GUI/Shell/Shell.cpp

// Open-BFME5: Shell::hide, retail 0x0057F5B0, 118 bytes. The body carried only
// a machine byte-dump row; targets/game/reverse/reloc_names.csv holds the name with
// identity=real.
//
