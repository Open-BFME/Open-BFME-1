// cl: /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /Iinputs/reference/shims/stringbaseascii /Iinputs/reference/shims/sweep /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Include /Iinputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Include /Igame/Libraries/Source/WWVegas/WWLib

// FILE: ControlBarPrintPositions.cpp /////////////////////////////////////////
//
// PrintOffsetsFromControlBarParent, retail 0x004AAC50. No port of Zero Hour's
// ControlBarPrintPositions.cpp existed under game/; the body is Zero Hour's
