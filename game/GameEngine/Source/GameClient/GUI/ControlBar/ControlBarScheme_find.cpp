...
// stlport
// readable body of ?findControlBarScheme@ControlBarSchemeManager@@QAEPAVControlBarScheme@@VAsciiString@@@Z: game/GameEngine/Source/GameClient/GUI/ControlBar/ControlBarScheme.cpp
