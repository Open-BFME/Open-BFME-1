...
// Rva0009E830Prefs::getPreferredMap at retail RVA 0x0009E830, 377B (a third
// preferences class whose name is not recovered; the body is a byte-twin of the
// Skirmish one). Three levers made it exact (docs/shape_levers.md):
...
// Same shape as the ZH source (inputs/reference/.../LanLobbyMenu.cpp:160), but the
...
// game/GameEngine/Source/Common/Gen_0009E3D0_Rva0009E830Prefs_getPreferredColor.cpp.
...
// inputs/reference/shims/stringinline/StringInline.h shape: by-value temporaries are
...
class Rva0009E830Prefs : public UserPreferences
{
public:
	AsciiString getPreferredMap(void);
};

// ?getPreferredMap@Rva0009E830Prefs@@QAE?AVAsciiString@@XZ
AsciiString Rva0009E830Prefs::getPreferredMap(void)
{
	AsciiString ret;
