...
// inputs/reference/shims/buddythread), and setLocalProfileID sits at vtable slot 0x6C
// rather than 0x50 because BFME's GameSpyInfoInterface carries seven extra
// virtuals ahead of it (see inputs/reference/shims/peerdefs). Rather than change the
