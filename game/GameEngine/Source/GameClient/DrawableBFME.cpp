...
// readable body of ?clearAndSetModelConditionFlags@Drawable@@QAEXABV?$BitFlags@$0HF@@@0@Z: game/GameEngine/Source/GameClient/Drawable.cpp
// readable body of ?enableAmbientSoundFromScript@Drawable@@QAEX_N@Z: game/GameEngine/Source/GameClient/Drawable.cpp
// readable body of ?friend_clearSelected@Drawable@@QAEXXZ: game/GameEngine/Source/GameClient/Drawable.cpp
// readable body of ?friend_setSelected@Drawable@@QAEXXZ: game/GameEngine/Source/GameClient/Drawable.cpp
// readable body of ?getBarrelCount@Drawable@@QBEHW4WeaponSlotType@@@Z: game/GameEngine/Source/GameClient/Drawable.cpp
// readable body of ?getProjectileLaunchOffset@Drawable@@QBE_NW4WeaponSlotType@@HPAVMatrix3D@@W4WhichTurretType@@PAUCoord3D@@3@Z: game/GameEngine/Source/GameClient/Drawable.cpp
//
