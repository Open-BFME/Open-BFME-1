...
// stlport
// readable body of ?selectFriends@SelectionTranslator@@AAE_NPAVDrawable@@PAVGameMessage@@_N@Z: game/GameEngine/Source/GameClient/MessageStream/SelectionXlat.cpp
