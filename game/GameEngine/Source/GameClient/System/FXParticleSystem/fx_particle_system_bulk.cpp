...
// another translation unit, resolved via targets/game/reverse/symbols.csv.
...
void ParticleSystemTemplate::parse(INI *ini, void *data, void *store, const void *userData)
{
    (void)store;
    (void)userData;

    typedef void (*ParseProc)(INI *, void *, void *, const void *);
    struct Field
    {
        const char *token;
        ParseProc parse;
    ...
    // This is the retail callback table.  The random-variable parser is
