// cl: /O2
// Retail RVA 0x005DBC50. Scalar destructor ILT 0x00044E2C routes to the
...
CylindricalTemplate *MakeCylindricalTemplateArray()
{
    return new CylindricalTemplate[2];
}

void DeleteCylindricalTemplateArray(CylindricalTemplate *array)
{
    delete[] array;
}
}
