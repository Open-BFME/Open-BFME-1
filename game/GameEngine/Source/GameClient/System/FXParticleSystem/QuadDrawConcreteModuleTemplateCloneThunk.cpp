...
// Open-BFME5: QuadDrawModuleTemplate ConcreteModuleTemplate::clone
...
template <>
class ConcreteModuleTemplate<QuadDrawTag> : public QuadDrawModuleTemplate
{
public:
...
QuadDrawModuleTemplate *ConcreteModuleTemplate<QuadDrawTag>::clone() const
{
	return new ConcreteModuleTemplate<QuadDrawTag>(*this);
}
