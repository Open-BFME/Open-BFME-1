...
class ModelConditionSoundSelectorClientBehavior : public ClientUpdateModule, public SoundSelectorInterface
{
public:
...
{
	return new ModelConditionSoundSelectorClientBehavior(thing, moduleData);
}
