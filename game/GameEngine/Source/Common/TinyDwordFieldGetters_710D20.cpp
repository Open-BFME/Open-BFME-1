...
// `unsigned int C::get() { return m_value; }`.  The disp32 form
// (opcode 8B 81) rather than disp8 is forced by every offset here being
...
BFME_DWORD_FIELD_GETTER( Rva00710D20, 0xF0 )
