...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00093D80,
...
// at 0x00032335 -- the tree is the map's first member, so `this` needs no
...
struct Rva00093D80Key
{
	unsigned char m_data[4];
};

struct Rva00093D80Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00093D80Key, Rva00093D80Value> Rva00093D80Entry;

template class map<Rva00093D80Key, Rva00093D80Value, less<Rva00093D80Key>, allocator<Rva00093D80Entry> >;
}
