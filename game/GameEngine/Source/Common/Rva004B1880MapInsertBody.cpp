...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x004B1880,
...
// at 0x0002FDDD -- the tree is the map's first member, so `this` needs no
...
typedef pair<const Rva004B1880Key, Rva004B1880Value> Rva004B1880Entry;

template class map<Rva004B1880Key, Rva004B1880Value, less<Rva004B1880Key>, allocator<Rva004B1880Entry> >;
}
