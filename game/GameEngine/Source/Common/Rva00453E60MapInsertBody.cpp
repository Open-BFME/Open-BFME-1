...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00453E60,
...
// at 0x0001944D -- the tree is the map's first member, so `this` needs no
...
struct Rva00453E60Key
{
	unsigned char m_data[4];
};

struct Rva00453E60Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00453E60Key, Rva00453E60Value> Rva00453E60Entry;

template class map<Rva00453E60Key, Rva00453E60Value, less<Rva00453E60Key>, allocator<Rva00453E60Entry> >;
}
