...
// 0x002E7C50, 342 bytes. The body carried only a machine byte-dump row and no name.
//
// The element type is not recoverable: the only named-shaped callee is the tail
// move's __uninitialized_copy at 0x002E3050, reached through the ILT at 0x0001BC93,
