...
// stlport
// Open-BFME7: out-of-line STLport copy-backward helper at retail 0x003B22E0.
...
class Rva003B22E0Handle
{
	void *m_data;
public:
	void assign(const Rva003B22E0Handle &other)
	{
		typedef void (Rva003B22E0Handle::*Fn)(const Rva003B22E0Handle &);
...
struct Gen_t_003b25a0_p128pod
{
	int m_pad0;
	UnicodeString m_str;
	Rva003B22E0Handle m_handle;
	int m_padc;
	int m_pad10;
	int m_a;
	int m_b;
	...
	Gen_t_003b25a0_p128pod &operator=(const Gen_t_003b25a0_p128pod &other)
	{
...
template Gen_t_003b25a0_p128pod *__copy_backward<Gen_t_003b25a0_p128pod *, Gen_t_003b25a0_p128pod *, int>(
	Gen_t_003b25a0_p128pod *, Gen_t_003b25a0_p128pod *, Gen_t_003b25a0_p128pod *,
