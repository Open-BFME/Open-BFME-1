...
// game/GameEngine/Source/Common/U4IniParseIntFlagSetters.cpp reads out, here
...
// pinned in targets/game/reverse/symbols.csv at the address it resolves to.  The `slotNN`
