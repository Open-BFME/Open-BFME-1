...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00669600,
...
// at 0x00007A4A -- the tree is the map's first member, so `this` needs no
...
struct Rva00669600Key
{
	unsigned char m_data[4];
};

struct Rva00669600Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00669600Key, Rva00669600Value> Rva00669600Entry;

template class map<Rva00669600Key, Rva00669600Value, less<Rva00669600Key>, allocator<Rva00669600Entry> >;
}
