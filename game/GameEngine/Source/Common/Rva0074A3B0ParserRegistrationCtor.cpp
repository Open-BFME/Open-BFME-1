// Retail 0x0074A3B0: full 146-byte HeightMapData registration constructor.
// Three stack arguments; context at +0x0C; base vptr 0x0107C7D0 and derived
// vptr 0x01121AFC. No caller names this derived class: retain its address.
...
Rva0074A3B0ParserRegistration::Rva0074A3B0ParserRegistration(
...
{
    Rva0074A3B0ParserRegistration *self = this;
    self->m_0c = context;
    self->m_vftable = (void *)0x01121AFC;
}
