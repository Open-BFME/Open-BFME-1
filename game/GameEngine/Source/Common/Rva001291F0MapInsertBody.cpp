...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x001291F0,
...
// at 0x0000228E -- the tree is the map's first member, so `this` needs no
...
struct Rva001291F0Key
{
	unsigned char m_data[4];
};

struct Rva001291F0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva001291F0Key, Rva001291F0Value> Rva001291F0Entry;

template class map<Rva001291F0Key, Rva001291F0Value, less<Rva001291F0Key>, allocator<Rva001291F0Entry> >;
}
