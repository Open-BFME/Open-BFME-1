...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x000C0940,
...
// at 0x00036F70 -- the tree is the map's first member, so `this` needs no
...
struct Rva000C0940Key
{
	unsigned char m_data[4];
};

struct Rva000C0940Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva000C0940Key, Rva000C0940Value> Rva000C0940Entry;

template class map<Rva000C0940Key, Rva000C0940Value, less<Rva000C0940Key>, allocator<Rva000C0940Entry> >;
}
