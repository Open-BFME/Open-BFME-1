...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x0019BC70,
...
// at 0x0000A4E8 -- the tree is the map's first member, so `this` needs no
...
typedef pair<const Rva0019BC70Key, Rva0019BC70Value> Rva0019BC70Entry;

template class map<Rva0019BC70Key, Rva0019BC70Value, less<Rva0019BC70Key>, allocator<Rva0019BC70Entry> >;
}
