...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00344180,
...
// at 0x00040034 -- the tree is the map's first member, so `this` needs no
...
struct Rva00344180Key
{
	unsigned char m_data[4];
};

struct Rva00344180Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00344180Key, Rva00344180Value> Rva00344180Entry;

template class map<Rva00344180Key, Rva00344180Value, less<Rva00344180Key>, allocator<Rva00344180Entry> >;
}
