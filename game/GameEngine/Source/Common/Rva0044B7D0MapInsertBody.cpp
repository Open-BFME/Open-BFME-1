...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x0044B7D0,
...
// at 0x00014376 -- the tree is the map's first member, so `this` needs no
...
struct Rva0044B7D0Key
{
	unsigned char m_data[4];
};

struct Rva0044B7D0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva0044B7D0Key, Rva0044B7D0Value> Rva0044B7D0Entry;

template class map<Rva0044B7D0Key, Rva0044B7D0Value, less<Rva0044B7D0Key>, allocator<Rva0044B7D0Entry> >;
}
