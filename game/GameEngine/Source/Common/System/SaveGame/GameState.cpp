...
// ------------------------------------------------------------------------------------------------
// ?findBlockInfoByToken@GameState@@AAEPAUSnapshotBlock@1@VAsciiString@@W4SnapshotType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameState_ctor_Thunk.cpp
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameStateDtorThunk.cpp
...
// ------------------------------------------------------------------------------------------------
// ?init@GameState@@UAEXXZ matched 1368 bytes (Open-BFME5)
// Byte-matched C++ body: GameStateInit.cpp (RVA0x001112D0).

// ------------------------------------------------------------------------------------------------
/** Reset */
// ------------------------------------------------------------------------------------------------a
// byte-exact reconstruction: game/GameEngine/Source/Common/GameState_resetMethodThunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/GameState_addSnapshotBlock_Thunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameState_findNextSaveFilename_Thunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameStateSaveGameThunk.cpp
...
/** A mission save */
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/GameState_missionSave_Thunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameStateLoadGameThunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameStateRealMapPathToPortableMapPathThunk.cpp
...
// ------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/System/SaveGame/GameStatePortableMapPathToRealMapPathThunk.cpp
...
/** Save game to xfer or load game using xfer */
// ------------------------------------------------------------------------------------------------
// ?xferSaveData@GameState@@AAEXPAVXfer@@W4SnapshotType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?addPostProcessSnapshot@GameState@@QAEXPAVSnapshot@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?xfer@GameState@@MAEXPAVXfer@@@Z present-unmatched
