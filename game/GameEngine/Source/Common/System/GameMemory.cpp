...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_CHECKPOINTING
// ?getNext@BlockCheckpointInfo@@ present-unmatched
inline BlockCheckpointInfo *BlockCheckpointInfo::getNext() { return m_next; }
// ?debugSetFreepoint@BlockCheckpointInfo@@ present-unmatched
...
#ifdef MEMORYPOOL_STACKTRACE
// ?getStacktraceInfo@BlockCheckpointInfo@@ present-unmatched
...
*/
// ?getUserDataNoDbg@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?getUserData@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?getNextFreeBlock@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?setNextFreeBlock@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?getNextRawBlock@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?setNextRawBlock@MemoryPoolSingleBlock@@ present-unmatched
...
#ifdef MEMORYPOOL_DEBUG
// ?debugIgnoreLeaksForThisBlock@MemoryPoolSingleBlock@@ present-unmatched
...
/**
	accessor
*/
// ?debugGetLiteralTagString@MemoryPoolSingleBlock@@ present-unmatched
...
/**
	accessor
*/
// ?debugGetLogicalSize@MemoryPoolSingleBlock@@ present-unmatched
...
/**
	accessor
*/
// ?debugGetWastedSize@MemoryPoolSingleBlock@@ present-unmatched
...
#ifdef MEMORYPOOL_DEBUG
// ?debugSetWastedSize@MemoryPoolSingleBlock@@ present-unmatched
...
/**
	accessor
*/
// ?debugGetCheckpointInfo@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugSetCheckpointInfo@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugResetCheckpoint@MemoryPoolSingleBlock@@ present-unmatched
...
// ----------------------------------------------------------------------------
/// accessor
// ?getNextInList@MemoryPoolBlob@@ present-unmatched
...
/// accessor
// ?getUsedBlockCount@MemoryPoolBlob@@ present-unmatched
inline Int MemoryPoolBlob::getUsedBlockCount() { return m_usedBlocksInBlob; }
/// accessor
// ?getTotalBlockCount@MemoryPoolBlob@@ present-unmatched
...
// ?shouldBeInReport@BlockCheckpointInfo@@ present-unmatched
...
*/
// ?initBlock@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?removeBlockFromList@MemoryPoolSingleBlock@@ present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_DEBUG
// ?debugSingleBlockReportLeak@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugVerifyBlock@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugMarkBlockAsFree@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugCheckUnderrun@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugCheckOverrun@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ?debugFillInWalls@MemoryPoolSingleBlock@@ present-unmatched
...
*/
// ??1MemoryPoolBlob@@ present-unmatched
MemoryPoolBlob::~MemoryPoolBlob()
{
...
*/
// ?initBlob@MemoryPoolBlob@@ present-unmatched
...
*/
// ?addBlobToList@MemoryPoolBlob@@ present-unmatched
...
*/
// ?removeBlobFromList@MemoryPoolBlob@@ present-unmatched
...
*/
// ?allocateSingleBlock@MemoryPoolBlob@@ present-unmatched
...
*/
// ?freeSingleBlock@MemoryPoolBlob@@ present-unmatched
...
*/
// ?debugMemoryVerifyBlob@MemoryPoolBlob@@ present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_DEBUG
// ?debugBlobReportLeaks@MemoryPoolBlob@@ present-unmatched
...
*/
// ?debugIsBlockInBlob@MemoryPoolBlob@@ present-unmatched
...
*/
// ?debugResetCheckpoints@MemoryPoolBlob@@ present-unmatched
...
*/
// ??0Checkpointable@@ present-unmatched
...
*/
// ??1Checkpointable@@ present-unmatched
Checkpointable::~Checkpointable()
{
...
*/
// ?debugAddCheckpointInfo@Checkpointable@@ present-unmatched
...
*/
// ?debugCheckpointReport@Checkpointable@@ present-unmatched
...
*/
// ?debugResetCheckpoints@Checkpointable@@ present-unmatched
...
/**
	...
	set of blocks.
*/
// ?init@MemoryPool@@ present-unmatched
...
*/
// byte-exact reconstruction: game/GameEngine/Source/Common/MemoryPoolDestructor.cpp
...
/**
	...
	frequently).
*/
// ?createBlob@MemoryPool@@ present-unmatched
...
/**
	...
	to this pool.
*/
// ?freeBlob@MemoryPool@@ present-unmatched
...
*/
// ?allocateBlockDoNotZeroImplementation@MemoryPool@@ present-unmatched
...
/**
	...
	function will never return null.
*/
// ?allocateBlockImplementation@MemoryPool@@ present-unmatched
...
*/
// byte-exact reconstruction: game/Libraries/Source/WWVegas/WWLib/BitFlagsBBCountInverseIntersectionThunk.cpp
...
//-----------------------------------------------------------------------------
// ?countBlobsInPool@MemoryPool@@ present-unmatched
...
/**
	...
	in odd situations.
*/
// ?releaseEmpties@MemoryPool@@ present-unmatched
...
*/
// ?reset@MemoryPool@@ present-unmatched
...
*/
// ?addToList@MemoryPool@@ present-unmatched
...
*/
// ?removeFromList@MemoryPool@@ present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_DEBUG
// ?debugPoolReportLeaks@MemoryPool@@ present-unmatched
...
*/
// ?debugMemoryVerifyPool@MemoryPool@@ present-unmatched
...
*/
// ?debugIsBlockInPool@MemoryPool@@ present-unmatched
...
*/
// ?debugGetBlockTagString@MemoryPool@@ present-unmatched
...
*/
// ?debugResetCheckpoints@MemoryPool@@ present-unmatched
...
*/
// ??0DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?init@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ??1DynamicMemoryAllocator@@ present-unmatched
DynamicMemoryAllocator::~DynamicMemoryAllocator()
{
...
*/
// ?findPoolForSize@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?addToList@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?removeFromList@DynamicMemoryAllocator@@ present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_DEBUG
// ?debugIgnoreLeaksForThisBlock@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?allocateBytesDoNotZeroImplementation@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?allocateBytesImplementation@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?freeBytes@DynamicMemoryAllocator@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ?getActualAllocationSize@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?reset@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugIsPoolInDma@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugIsBlockInDma@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugGetBlockTagString@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugMemoryVerifyDma@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugResetCheckpoints@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugCalcRawBlockBytes@DynamicMemoryAllocator@@ present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_DEBUG
// ?debugDmaReportLeaks@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?debugDmaInfoReport@DynamicMemoryAllocator@@ present-unmatched
...
*/
// ?init@MemoryPoolFactory@@ present-unmatched
...
*/
// ??1MemoryPoolFactory@@ present-unmatched
MemoryPoolFactory::~MemoryPoolFactory()
{
...
*/
// byte-exact reconstruction: game/GameEngine/Source/Common/NameKeyGenerator.cpp
...
*/
// ?findMemoryPool@MemoryPoolFactory@@ present-unmatched
...
*/
// ?destroyMemoryPool@MemoryPoolFactory@@ present-unmatched
...
*/
// ?createDynamicMemoryAllocator@MemoryPoolFactory@@ present-unmatched
...
*/
// ?destroyDynamicMemoryAllocator@MemoryPoolFactory@@ present-unmatched
...
*/
// ?reset@MemoryPoolFactory@@ present-unmatched
...
*/
// ?adjustTotals@MemoryPoolFactory@@ present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef MEMORYPOOL_DEBUG
// ?debugSetInitFillerIndex@MemoryPoolFactory@@ present-unmatched
...
/**
	...
	pools and dmas.
*/
// ?debugMemoryVerify@MemoryPoolFactory@@ present-unmatched
...
/**
	...
	by this factory.
*/
// ?debugIsBlockInAnyPool@MemoryPoolFactory@@ present-unmatched
...
*/
// ?debugGetBlockTagString@MemoryPoolFactory@@ present-unmatched
...
*/
// ?debugSetCheckpoint@MemoryPoolFactory@@ present-unmatched
...
*/
// ?debugResetCheckpoints@MemoryPoolFactory@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ?memoryPoolUsageReport@MemoryPoolFactory@@ present-unmatched
...
*/
// ?debugMemoryReport@MemoryPoolFactory@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ?allocate@STLSpecialAlloc@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ?deallocate@STLSpecialAlloc@@ present-unmatched
