// cl: /Igame/GameEngine/Source/Common/System /DNDEBUG /MD /EHsc /Igame/GameEngine/Include/Precompiled /Igame/GameEngine/Include/Common/INI /Igame/GameEngine/Include/Common /Igame/Libraries/Source/WWVegas/WWMath /Igame/Libraries/Source/WWVegas/WWLib
// stlport
/*
...
//-----------------------------------------------------------------------------
// ?GeometryInfo::set present-unmatched
...
// ?GeometryInfo::setMaxHeightAbovePosition present-unmatched
...
// ?GeometryInfo::getZDeltaToCenterPosition present-unmatched
...
//=============================================================================
// given an object with this geom, located at 'pos', where is the "center" of the geometry?
// ?GeometryInfo::getCenterPosition present-unmatched
...
//=============================================================================
// ?GeometryInfo::get2DBounds present-unmatched
...
//=============================================================================
// ?GeometryInfo::clipPointToFootprint present-unmatched
...
//=============================================================================
// ?GeometryInfo::isPointInFootprint present-unmatched
...
//=============================================================================
// ?GeometryInfo::makeRandomOffsetWithinFootprint present-unmatched
...
//=============================================================================
// ?GeometryInfo::makeRandomOffsetOnPerimeter present-unmatched
...
//=============================================================================
// ?GeometryInfo::getFootprintArea present-unmatched
...
//=============================================================================
// ?GeometryInfo::tweakExtents present-unmatched
...
#if defined(_DEBUG) || defined(_INTERNAL)
//=============================================================================
// ?GeometryInfo::getDescriptiveString present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?GeometryInfo::crc present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?GeometryInfo::xfer present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?GeometryInfo::loadPostProcess present-unmatched
