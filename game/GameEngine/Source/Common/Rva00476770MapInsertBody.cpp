...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00476770,
...
// at 0x0003335C -- the tree is the map's first member, so `this` needs no
...
struct Rva00476770Key
{
	unsigned char m_data[4];
};

struct Rva00476770Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00476770Key, Rva00476770Value> Rva00476770Entry;

template class map<Rva00476770Key, Rva00476770Value, less<Rva00476770Key>, allocator<Rva00476770Entry> >;
}
