...
// targets are pinned in targets/game/reverse/symbols.csv by the addresses their REL32s
...
// upstream layout: inputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Tools/WW3D/pluglib/WWmatrix3.h
class Matrix3
{
};
