...
// Address-derived model for the retail static cdecl INI field callback at 0x005C7C70.
...
public:
	...
	const char *m_name;
	const char *m_key;
	Rva005C7C70Factory *m_next;
};

class Rva005C7C70ModuleTemplate
{
public:
	virtual void destroy(unsigned int flags);
};

class Rva005C7C70Parse
{
public:
	static void parse(INI *ini, void *data, void *store, const void *userData);
};

// ?parse@Rva005C7C70Parse@@SAXPAVINI@@PAX1PBX@Z
void Rva005C7C70Parse::parse(INI *ini, void *data, void *, const void *)
{
	...
	void *old = *reinterpret_cast<void **>((char *)data + 0xAC);
	if (old)
