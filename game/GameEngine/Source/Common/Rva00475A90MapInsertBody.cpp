...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00475A90,
...
// at 0x00017B0C -- the tree is the map's first member, so `this` needs no
...
struct Rva00475A90Key
{
	unsigned char m_data[4];
};

struct Rva00475A90Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00475A90Key, Rva00475A90Value> Rva00475A90Entry;

template class map<Rva00475A90Key, Rva00475A90Value, less<Rva00475A90Key>, allocator<Rva00475A90Entry> >;
}
