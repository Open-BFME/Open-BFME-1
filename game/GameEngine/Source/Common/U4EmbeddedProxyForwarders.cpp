...
// game/GameEngine/Source/Common/U4ElementScanLoops.cpp's scans, whose
...
// game/GameEngine/Source/Common/U4ElementScanLoops.cpp; `firstNamed` is
// 0x00606D60, pinned in targets/game/reverse/symbols.csv.  Declared and not included so that
