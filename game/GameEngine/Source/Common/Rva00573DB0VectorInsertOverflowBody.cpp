...
// 0x00573DB0, 314 bytes. The body carried only a machine byte-dump row and no name.
//
// The element type is not recoverable from this body or its callees: both bulk
// phases go to that TU's own copies of the 12-byte-element helpers (0x00570880
// and 0x005708D0, through the ILTs at 0x00032FBF and 0x0002932F), and the
...
template class vector<Rva00573DB0Element, allocator<Rva00573DB0Element> >;
}
