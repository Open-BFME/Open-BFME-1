...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00406AE0,
...
// at 0x00018D7C -- the tree is the map's first member, so `this` needs no
...
struct Rva00406AE0Key
{
	unsigned char m_data[4];
};

struct Rva00406AE0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00406AE0Key, Rva00406AE0Value> Rva00406AE0Entry;

template class map<Rva00406AE0Key, Rva00406AE0Value, less<Rva00406AE0Key>, allocator<Rva00406AE0Entry> >;
}
