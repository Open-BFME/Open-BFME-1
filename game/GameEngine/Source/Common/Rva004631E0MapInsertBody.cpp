...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x004631E0,
...
// at 0x00037AE7 -- the tree is the map's first member, so `this` needs no
...
struct Rva004631E0Key
{
	unsigned char m_data[4];
};

struct Rva004631E0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva004631E0Key, Rva004631E0Value> Rva004631E0Entry;

template class map<Rva004631E0Key, Rva004631E0Value, less<Rva004631E0Key>, allocator<Rva004631E0Entry> >;
}
