...
// auto-vectorization -- see targets/game/reverse/attempts/0x009c2320.cpp for the full
	...
	int stride, int selector, int *filterTable)
{
	...
	__asm {
		...
		paddb mm1, mm0
		paddb mm1, mm0
		paddusb mm1, qword ptr [Vp6FilterConst88A0]
		paddb mm0, qword ptr [Vp6FilterConst8870]
		psubusb mm1, qword ptr [Vp6FilterConst88A0]
