...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00225C90,
...
// at 0x00030698 -- the tree is the map's first member, so `this` needs no
...
struct Rva00225C90Key
{
	unsigned char m_data[4];
};

struct Rva00225C90Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00225C90Key, Rva00225C90Value> Rva00225C90Entry;

template class map<Rva00225C90Key, Rva00225C90Value, less<Rva00225C90Key>, allocator<Rva00225C90Entry> >;
}
