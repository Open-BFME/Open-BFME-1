...
// stlport
// readable body of ?load@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseAccelerationReal@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseAndTranslateLabel@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseAngularVelocityReal@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseArmorTemplate@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseAsciiString@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseAudioEventRTS@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseCoord2D@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseCoord3D@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseDamageFX@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseDamageTypeFlags@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseDeathTypeFlags@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseDurationReal@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseDurationUnsignedInt@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseDurationUnsignedShort@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseFXList@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseGameClientRandomVariable@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseICoord2D@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseMappedImage@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseObjectCreationList@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseParticleSystemTemplate@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseQuotedAsciiString@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseSpecialPowerTemplate@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseThingTemplate@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseUpgradeTemplate@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseVelocityReal@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseVeterancyLevelFlags@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?parseWeaponTemplate@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?readLine@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
// readable body of ?unPrepFile@INI@@: game/GameEngine/Source/Common/INI/INI_stl.cpp
...
// Body in game/masm_dumps/loadDirectory_INI_QAEXVAsciiString_NW4INILoadType_PAVXfer_Z_853F10.asm (exact 700B retail @ 0x00853F10).
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/INI/INIPrepFileThunk.cpp
...
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/RTS/INIParseDynamicAudioEventRTSThunk.cpp
...
// emits it, and inputs/reference/shims/gameaudio for the AudioManager vtable, whose
