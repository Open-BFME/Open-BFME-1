...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x0008EF50,
...
// at 0x00045A7F -- the tree is the map's first member, so `this` needs no
...
struct Rva0008EF50Key
{
	unsigned char m_data[4];
};

struct Rva0008EF50Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva0008EF50Key, Rva0008EF50Value> Rva0008EF50Entry;

template class map<Rva0008EF50Key, Rva0008EF50Value, less<Rva0008EF50Key>, allocator<Rva0008EF50Entry> >;
}
