...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x002271A0,
...
// at 0x00011D3D -- the tree is the map's first member, so `this` needs no
...
struct Rva002271A0Key
{
	unsigned char m_data[4];
};

struct Rva002271A0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva002271A0Key, Rva002271A0Value> Rva002271A0Entry;

template class map<Rva002271A0Key, Rva002271A0Value, less<Rva002271A0Key>, allocator<Rva002271A0Entry> >;
}
