...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00635520,
...
// at 0x0002AE46 -- the tree is the map's first member, so `this` needs no
...
struct Rva00635520Key
{
	unsigned char m_data[4];
};

struct Rva00635520Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00635520Key, Rva00635520Value> Rva00635520Entry;

template class map<Rva00635520Key, Rva00635520Value, less<Rva00635520Key>, allocator<Rva00635520Entry> >;
}
