...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x000C1CE0,
...
// at 0x00047D4D -- the tree is the map's first member, so `this` needs no
...
struct Rva000C1CE0Key
{
	unsigned char m_data[4];
};

struct Rva000C1CE0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva000C1CE0Key, Rva000C1CE0Value> Rva000C1CE0Entry;

template class map<Rva000C1CE0Key, Rva000C1CE0Value, less<Rva000C1CE0Key>, allocator<Rva000C1CE0Entry> >;
}
