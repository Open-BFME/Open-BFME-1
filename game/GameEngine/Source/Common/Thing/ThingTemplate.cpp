...
// ------------------------------------------------------------------------------------------------
// ?getNuggetWithTag@ModuleInfo@@QBEPBUNugget@1@ABVAsciiString@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?clearCopiedFromDefaultEntries@ModuleInfo@@ present-unmatched
...
// Body in game/masm_dumps/_sa__parseModuleName_ThingTemplate__KAXPAVINI__PAX1PBX_1458A0.asm (exact 772B retail @ 0x001458A0).
//-------------------------------------------------------------------------------------------------
// ?parseIntList@ThingTemplate@@KAXPAVINI@@PAX1PBX@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/ThingTemplate_parsePrerequisites_Thunk.cpp
...
//-------------------------------------------------------------------------------------------------
// ?OverrideableByLikeKind@ThingTemplate@@KAXPAVINI@@PAX1PBX@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/ThingTemplate_parseArmorTemplateSet_Thunk.cpp
...
//-------------------------------------------------------------------------------------------------
// ?parseWeaponTemplateSet@ThingTemplate@@KAXPAVINI@@PAX1PBX@Z present-unmatched
...
// ?parseMaxSimultaneous@ThingTemplate@@KAXPAVINI@@PAX1PBX@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??0ThingTemplate@@QAE@XZ present-unmatched
...
struct BfmeThingTemplateStringData
{
	Int m_refs;
...
{
public:
	Bool isEmpty() const { return m_data == NULL || m_data->m_length == 0; }
	void set( const char *text, Int length );

private:
	BfmeThingTemplateStringData *m_data;
};

struct BfmeThingTemplateShadowLayout
{
	char m_prefix[ 0x4c ];
	BfmeThingTemplateString m_shadowTextureName;
	char m_between[ 0x10 ];
	BfmeThingTemplateShadowSelector m_selector;
};

void ThingTemplate::validateAudio()
{
	BfmeThingTemplateShadowLayout *layout =
		reinterpret_cast<BfmeThingTemplateShadowLayout *>( this );

	if (layout->m_shadowTextureName.isEmpty())
	{
		if (layout->m_selector.usePluralShadowName())
			layout->m_shadowTextureName.set( "shadows", 7 );
		else
			layout->m_shadowTextureName.set( "shadow", 6 );
	}
}

//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/ThingTemplate_validateMethodThunk.cpp
...
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/promoted__setCopiedFromDefault_ThingTemplate_QAEXXZ_0013FDB0.cpp
...
//-------------------------------------------------------------------------------------------------
// ??1ThingTemplate@@MAE@XZ present-unmatched
ThingTemplate::~ThingTemplate()
{
...
//=============================================================================
// ?resolveNames@ThingTemplate@@QAEXXZ present-unmatched
...
// ?canPossiblyHaveAnyWeapon@ThingTemplate@@QBE_NXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?getSkillPointValue@ThingTemplate@@QBEHH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?getBuildFacilityTemplate@ThingTemplate@@QBEPBV1@PBVPlayer@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getPerUnitFX@ThingTemplate@@QBEPBVFXList@@ABVAsciiString@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getPerUnitSound@ThingTemplate@@QBEPBVAudioEventRTS@@ABVAsciiString@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getMaxSimultaneousOfType@ThingTemplate@@QBEIXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calcCostToBuild@ThingTemplate@@QBEHPBVPlayer@@@Z present-unmatched
...
/** NOTE that we're not paying attention to m_override here, instead the portions
	...
	* attention to the override values */
//-------------------------------------------------------------------------------------------------
// Matched via game/masm_dumps/ThingTemplate_calcTimeToBuild.asm @ 0x00144AB0 (619B).
