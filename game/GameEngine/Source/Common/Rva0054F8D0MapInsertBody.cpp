...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x0054F8D0,
...
// at 0x00033D5C -- the tree is the map's first member, so `this` needs no
...
struct Rva0054F8D0Key
{
	unsigned char m_data[4];
};

struct Rva0054F8D0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva0054F8D0Key, Rva0054F8D0Value> Rva0054F8D0Entry;

template class map<Rva0054F8D0Key, Rva0054F8D0Value, less<Rva0054F8D0Key>, allocator<Rva0054F8D0Entry> >;
}
