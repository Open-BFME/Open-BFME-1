...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x004767C0,
...
// at 0x0000FB41 -- the tree is the map's first member, so `this` needs no
...
struct Rva004767C0Key
{
	unsigned char m_data[4];
};

struct Rva004767C0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva004767C0Key, Rva004767C0Value> Rva004767C0Entry;

template class map<Rva004767C0Key, Rva004767C0Value, less<Rva004767C0Key>, allocator<Rva004767C0Entry> >;
}
