...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00690320,
...
// at 0x0003DC21 -- the tree is the map's first member, so `this` needs no
...
struct Rva00690320Key
{
	unsigned char m_data[4];
};

struct Rva00690320Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00690320Key, Rva00690320Value> Rva00690320Entry;

template class map<Rva00690320Key, Rva00690320Value, less<Rva00690320Key>, allocator<Rva00690320Entry> >;
}
