...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00063870,
...
// at 0x0000A529 -- the tree is the map's first member, so `this` needs no
...
struct Rva00063870Key
{
	unsigned char m_data[4];
};

struct Rva00063870Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00063870Key, Rva00063870Value> Rva00063870Entry;

template class map<Rva00063870Key, Rva00063870Value, less<Rva00063870Key>, allocator<Rva00063870Entry> >;
}
