...
// Address-derived model for the retail static cdecl INI field callback at 0x005C7580.
...
public:
	...
	const char *m_name;
	const char *m_key;
	Rva005C7580Factory *m_next;
};

class Rva005C7580ModuleTemplate
{
public:
	virtual void destroy(unsigned int flags);
};

class Rva005C7580Parse
{
public:
	static void parse(INI *ini, void *data, void *store, const void *userData);
};

// ?parse@Rva005C7580Parse@@SAXPAVINI@@PAX1PBX@Z
void Rva005C7580Parse::parse(INI *ini, void *data, void *, const void *)
{
	...
	void *old = *reinterpret_cast<void **>((char *)data + 0xA0);
	if (old)
		((Rva005C7580ModuleTemplate *)old)->destroy(1);
	*reinterpret_cast<void **>((char *)data + 0xA0) = created;
}
