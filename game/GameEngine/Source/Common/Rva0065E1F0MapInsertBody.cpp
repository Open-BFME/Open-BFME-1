...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x0065E1F0,
...
// at 0x00030B43 -- the tree is the map's first member, so `this` needs no
...
struct Rva0065E1F0Key
{
	unsigned char m_data[4];
};

struct Rva0065E1F0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva0065E1F0Key, Rva0065E1F0Value> Rva0065E1F0Entry;

template class map<Rva0065E1F0Key, Rva0065E1F0Value, less<Rva0065E1F0Key>, allocator<Rva0065E1F0Entry> >;
}
