// cl: /DNDEBUG /DWIN32 /D_WINDOWS /D_STLP_USE_STATIC_LIB /MD /EHsc /Iinputs/reference/shims/stlp_nodealloc
// stlport
...
// inputs/reference/shims/bfmekindof/Common/KindOf.h: KINDOF_STRUCTURE is bit 7
enum KindOfType
{
	KINDOF_STRUCTURE = 7
};
