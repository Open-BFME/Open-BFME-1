...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x001DAE10,
...
// at 0x0001F389 -- the tree is the map's first member, so `this` needs no
...
struct Rva001DAE10Key
{
	unsigned char m_data[4];
};

struct Rva001DAE10Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva001DAE10Key, Rva001DAE10Value> Rva001DAE10Entry;

template class map<Rva001DAE10Key, Rva001DAE10Value, less<Rva001DAE10Key>, allocator<Rva001DAE10Entry> >;
}
