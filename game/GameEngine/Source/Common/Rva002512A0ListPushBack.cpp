...
// stlport
// Retail at 0x002512A0.  STLport list<8-byte>::push_back: 16-byte node via
...
struct Rva002512A0Elem
{
	void *m_a;
	void *m_b;
};

class Rva002512A0List
{
public:
	void push_back(Rva002512A0Elem const &value);

private:
	_STL::list<Rva002512A0Elem> m_list;
};

void Rva002512A0List::push_back(Rva002512A0Elem const &value)
{
