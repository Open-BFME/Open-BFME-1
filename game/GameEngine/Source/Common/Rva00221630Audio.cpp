// cl: /DNDEBUG /MD /EHsc
// Open-BFME6: 0x00221630. Once a frame, copy an AudioEventRTS, stamp the
// object id, and queue it on TheAudio.
...
// ?bfmePlay@Gen_00221630@@QAEXXZ
void Gen_00221630::bfmePlay()
{
	...
	if (frame != m_stamp)
	{
		if (m_audioBase != 0)
		{
			AudioEventRTS event(*(const AudioEventRTS *)(m_audioBase + 0xA4));
			char *obj = m_object;
