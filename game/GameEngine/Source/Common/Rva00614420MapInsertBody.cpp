...
// at 0x00046A47 -- the tree is the map's first member, so `this` needs no
...
struct Rva00614420Key
{
	unsigned char m_data[4];
};

struct Rva00614420Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00614420Key, Rva00614420Value> Rva00614420Entry;

template class map<Rva00614420Key, Rva00614420Value, less<Rva00614420Key>, allocator<Rva00614420Entry> >;
}
