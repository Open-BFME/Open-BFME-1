...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x0007DEE0,
...
// at 0x00039423 -- the tree is the map's first member, so `this` needs no
...
struct Rva0007DEE0Key
{
	unsigned char m_data[4];
};

struct Rva0007DEE0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva0007DEE0Key, Rva0007DEE0Value> Rva0007DEE0Entry;

template class map<Rva0007DEE0Key, Rva0007DEE0Value, less<Rva0007DEE0Key>, allocator<Rva0007DEE0Entry> >;
}
