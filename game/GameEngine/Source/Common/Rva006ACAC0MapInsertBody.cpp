...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x006ACAC0,
...
// at 0x0000F7D6 -- the tree is the map's first member, so `this` needs no
...
struct Rva006ACAC0Key
{
	unsigned char m_data[4];
};

struct Rva006ACAC0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva006ACAC0Key, Rva006ACAC0Value> Rva006ACAC0Entry;

template class map<Rva006ACAC0Key, Rva006ACAC0Value, less<Rva006ACAC0Key>, allocator<Rva006ACAC0Entry> >;
}
