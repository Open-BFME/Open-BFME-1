...
// 0x0076B160, 314 bytes. The body carried only a machine byte-dump row and no name.
//
// The element type is not recoverable from this body or its callees: both bulk
// phases go to that TU's own copies of the 12-byte-element helpers (0x007615E0
// and 0x0075E8B0, through the ILTs at 0x00021247 and 0x00044094), and the
...
template class vector<Rva0076B160Element, allocator<Rva0076B160Element> >;
}
