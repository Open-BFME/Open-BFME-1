...
// upstream body: inputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/GlobalData.cpp (~GlobalData)
...
// releaseBuffer@StringBase<G> in retail (targets/game/reverse/symbols.csv:
...
// thunk retail calls at this member's cleanup site (targets/game/reverse/symbols.csv),
...
private:
	...
	AttributeModifierAuraUpdateModuleDataMemberC m_attrEdc;									// +0xedc (4)
	unsigned char m_padEe0[0x11e0 - 0xee0];
	Rva00026AB2Vec12 m_vec11e0;									// +0x11e0 (0xc)
	unsigned char m_pad11ec[0x1200 - 0x11ec];
	BFMERetailAsciiString m_s1200, m_s1204;					// +0x1200, +0x1204
	Rva00026AB2Vec12 m_vec1208;									// +0x1208 (0xc)
	unsigned char m_pad1214[0x121c - 0x1214];
	AttributeModifierAuraUpdateModuleDataMemberC m_attr121c;								// +0x121c (4)
