...
// Open-BFME5: STLport map::insert(iterator, const value_type &), retail 0x00146AB0,
...
// at 0x00009462 -- the tree is the map's first member, so `this` needs no
...
struct Rva00146AB0Key
{
	unsigned char m_data[4];
};

struct Rva00146AB0Value
{
	unsigned char m_data[4];
};
...
typedef pair<const Rva00146AB0Key, Rva00146AB0Value> Rva00146AB0Entry;

template class map<Rva00146AB0Key, Rva00146AB0Value, less<Rva00146AB0Key>, allocator<Rva00146AB0Entry> >;
}
