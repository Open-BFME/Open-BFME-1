...
public:
	...
	// SHIM-PATCHED for VC7.1: a default argument on a function TYPEDEF is VC6-only (C2383 in VC7.1)
	...
	// BFME added three virtual slots here, shifting getWidth/getHeight from 0x20/0x24 to 0x2c/0x30
	virtual void bfmeDisplaySlot0( void ) = 0;
	virtual void bfmeDisplaySlot1( void ) = 0;
	virtual void bfmeDisplaySlot2( void ) = 0;
