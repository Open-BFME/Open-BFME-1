...
// The exact retail constructor is emitted by W3DRopeDrawCtor.cpp.
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// byte-exact reconstruction: game/GameEngine/Source/Common/W3DRopeDrawDestructorThunk.cpp
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1W3DRopeDraw@@MAE@XZ present-unmatched
...
void W3DRopeDraw::doDrawModule(const Matrix3D* transformMtx)
{
	...
	if (!m_segments.empty())
	{
		...
		const Coord3D* pos = ((const BFMERopeDrawable *)getDrawable())->getPosition();
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@W3DRopeDraw@@MAEXXZ present-unmatched
