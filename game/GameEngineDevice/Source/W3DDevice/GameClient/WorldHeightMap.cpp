...
// byte-exact reconstruction: game/GameEngine/Source/Common/MapObjectCtorThunk.cpp
...
// byte-exact reconstruction: game/GameEngine/Source/Common/MapObject_verifyValidUniqueIDMethodThunk.cpp
...
// ?fastAssignAllUniqueIDs@MapObject@@SAXXZ present-unmatched
...
// ?setThingTemplate@MapObject@@QAEXPBVThingTemplate@@@Z present-unmatched
...
// ?setName@MapObject@@QAEXVAsciiString@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getThingTemplate@MapObject@@QBEPBVThingTemplate@@XZ present-unmatched
...
//
// ??1WorldHeightMap@@UAE@XZ present-unmatched
...
*/
// ??0WorldHeightMap@@ present-unmatched
...
*/
// ?getFlipState@WorldHeightMap@@QBE_NHH@Z present-unmatched
...
*/
// ?setFlipState@WorldHeightMap@@QAEXHH_N@Z present-unmatched
...
*/
// ?clearFlipStates@WorldHeightMap@@QAEXXZ present-unmatched
...
//////////////////////////////////////////////////////////////////////////////m_SeismicUpdateFlag
// ?getSeismicUpdateFlag@WorldHeightMap@@QBE_NHH@Z present-unmatched
...
// ?setSeismicUpdateFlag@WorldHeightMap@@QAEXHH_N@Z present-unmatched
...
// ?clearSeismicUpdateFlags@WorldHeightMap@@QAEXXZ present-unmatched
...
// ?getSeismicZVelocity@WorldHeightMap@@UBEMHH@Z present-unmatched
...
// ?setSeismicZVelocity@WorldHeightMap@@UAEXHHM@Z present-unmatched
...
// ?fillSeismicZVelocities@WorldHeightMap@@QAEXM@Z present-unmatched
...
// ?getBilinearSampleSeismicZVelocity@WorldHeightMap@@UAEMHH@Z present-unmatched
...
*/
// ?getCliffState@WorldHeightMap@@QBE_NHH@Z present-unmatched
...
//=============================================================================
// ?setCliffState@WorldHeightMap@@IAEXHH_N@Z present-unmatched
...
// INI table binds the Weather key there (targets/game/reverse/field_names.csv).
...
*		
*/
// ?ParseLightingDataChunk@WorldHeightMap@@KA_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX@Z matched 1724 bytes (Open-BFME5)
__declspec(naked) Bool WorldHeightMap::ParseLightingDataChunk(DataChunkInput &, DataChunkInfo *, void *)
{
	__asm
	{
		__emit 0x83;
...
*		
*/
// ?ParseObjectsDataChunk@WorldHeightMap@@KA_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX@Z present-unmatched
...
*		
*/
// ?ParseHeightMapData@WorldHeightMap@@IAE_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX@Z present-unmatched
...
*		
*/
// byte-exact reconstruction: game/GameEngine/Source/GameLogic/Map/TerrainLogic.cpp
...
*		
*/
// ?ParseObjectDataChunk@WorldHeightMap@@KA_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX@Z present-unmatched
...
*		
*/
// ?ParseObjectData@WorldHeightMap@@IAE_NAAVDataChunkInput@@PAUDataChunkInfo@@PAX_N@Z present-unmatched
...
*/
// ?updateTileTexturePositions@WorldHeightMap@@IAEHPAH@Z present-unmatched
...
*/
// ?getAlphaUVData@WorldHeightMap@@QAEXHHQAM0QAEPA_N_N@Z present-unmatched
...
// ?setTextureLOD@WorldHeightMap@@QAEXH@Z present-unmatched
...
// ?getTerrainTexture@WorldHeightMap@@QAEPAVTextureClass@@XZ present-unmatched
...
// ?getAlphaTerrainTexture@WorldHeightMap@@QAEPAVTextureClass@@XZ present-unmatched
...
// ?getEdgeTerrainTexture@WorldHeightMap@@QAEPAVTextureClass@@XZ present-unmatched
...
// ?getFlatTexture@WorldHeightMap@@QAEPAVTerrainTextureClass@@HHHH@Z present-unmatched
...
// ?setDrawOrg@WorldHeightMap@@QAE_NHH@Z present-unmatched
...
// ?getTextureClass@WorldHeightMap@@QAEHHH_N@Z present-unmatched
...
// ?initCliffFlagsFromHeights@WorldHeightMap@@IAEXXZ present-unmatched
...
// ?setCellCliffFlagFromHeights@WorldHeightMap@@IAEXHH@Z present-unmatched
...
/** Gets global texture class. */
// ?getTextureClassFromNdx@WorldHeightMap@@IAEHH@Z present-unmatched
...
// ?getTextureFromIndex@WorldHeightMap@@QAE?AUTXTextureClass@@H@Z present-unmatched
...
// inputs/reference/shims/pathfind's identical fix. TU-scoped to just this function:
