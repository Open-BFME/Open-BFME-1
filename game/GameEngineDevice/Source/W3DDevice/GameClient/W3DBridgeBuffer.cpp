...
/** Frees objects.  */
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/W3DBridgeDestructor.cpp
...
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/W3DBridgeClearBridge.cpp
...
struct Rva006D7EA0GlobalDataView
{
	char m_prefix[0xA04];
	Coord3D m_terrainLightPos[4];
	char m_paddingA34[0x24];
	Int m_numGlobalLights;
};

class Rva006D7EA0MeshModelView
{
	char m_prefix[0x28];
	Int m_vertexCount;
																...
																MeshClass *pMesh, RefRenderObjListIterator *pLightsIterator)
{
	...
	Int i;
	Rva006D7EA0MeshModelView *model = (Rva006D7EA0MeshModelView *)pMesh->Peek_Model();
	...
	for (Int lightIndex=0; lightIndex < ((const Rva006D7EA0GlobalDataView *)TheWritableGlobalData)->m_numGlobalLights; lightIndex++)
	{
		lightPos = &((const Rva006D7EA0GlobalDataView *)TheWritableGlobalData)->m_terrainLightPos[lightIndex];
...
//		__asm {int 3}; //see if it really needs normalization!!
	...
	const Vector2 *uvs = ((Rva006D7EA0MeshModelView *)pMesh->Peek_Model())->Get_UV_Array_By_Index(0);
...
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/W3DScene/W3DBridgeBufferLoadThunk.cpp
...
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/W3DBridgeBufferDestructor.cpp
...
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/W3DBridgeBuffer_addBridge_Thunk.cpp
