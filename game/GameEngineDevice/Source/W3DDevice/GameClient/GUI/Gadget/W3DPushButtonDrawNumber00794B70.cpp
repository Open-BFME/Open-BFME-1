// ?DrawNumber00794B70@@YAXPAVGameWindow@@PAVWinInstanceData@@PAUPushButtonData@@@Z
// Retail 0x00794B70 (359 bytes).  W3DGadgetPushButtonDraw at 0x00794D30 calls
// this body through the incremental-link thunk at RVA 0x000327A4 when the push
// button's flag at +0x28 is 1.  Nothing in the image or in the Zero Hour source
// names the routine, so the address stays in the name.  The body formats the
// button's integer at +0x2c with L"%d" into the button's DisplayString at +0x30
// and draws it at the bottom right of the button.
...
void DrawNumber00794B70( GameWindow *window,
