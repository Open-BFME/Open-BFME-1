// cl: /DNDEBUG /MD /EHsc
// Retail 0x007D9240, filter vtable 0x01128BD0 slot 5.
// Slots 0/2/4 resolve to matched ScreenMotionBlurFilter init/preRender/setup.
class StringClass {
 char *m_Buffer;
...
class ScreenMotionBlurFilter { protected: virtual int set(FilterModes); };
