...
//=============================================================================
// ??0W3DTreeTextureClass@@ present-unmatched
...
//=============================================================================
// ?update@W3DTreeTextureClass@@ present-unmatched
...
//=============================================================================
// ?setLOD@W3DTreeTextureClass@@ present-unmatched
...
//=============================================================================
// ?Apply@W3DTreeTextureClass@@ present-unmatched
...
struct BFMETreeAllocateView
{
	...
	char m_unreconstructed_0000b8[0x110 - 0xb8];
	Int m_curNumTreeVertices[20];
	Int m_curNumTreeIndices[20];
	char m_unreconstructed_0001b0[0x2a9904 - 0x1b0];
...
it's sortKey */
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/Gen_0071C0E0_W3DTreeBuffer_UpdateSway.cpp
...
//=============================================================================
// ?sort@W3DTreeBuffer@@ present-unmatched
...
//=============================================================================
// ?updateTexture@W3DTreeBuffer@@IAEXXZ present-unmatched
...
*/
// ?setTextureLOD@W3DTreeBuffer@@QAEXH@Z present-unmatched
...
//=============================================================================
// ?loadTreesInVertexAndIndexBuffers@W3DTreeBuffer@@IAEXPAV?$RefMultiListIterator@VRenderObjClass@@@@@Z present-unmatched
...
//=============================================================================
// ?updateVertexBuffer@W3DTreeBuffer@@IAEXXZ present-unmatched
...
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/Rva007206E0W3DTreeBufferDestructor.cpp
...
for the trees. */
//=============================================================================
// ??0W3DTreeBuffer@@QAE@XZ present-unmatched
W3DTreeBuffer::W3DTreeBuffer(void)
{
...
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/W3DTreeBuffer_unitMoved_Thunk.cpp
...
{
	BFMETreeAllocateView *self = reinterpret_cast<BFMETreeAllocateView *>(this);
	...
	reinterpret_cast<Rva006D6050 *>(&self->m_treeTexture)->init(1, 1, 0x15, 1, 1, 0);
	TextureBaseClass *treeTexture = reinterpret_cast<TextureBaseClass *>(&self->m_treeTexture);
	...
	{
		Int result = BfmeVertexShaderLoader::LoadAndCreateD3DShader("shaders\\Trees.vso", reinterpret_cast<unsigned long *>(&self->m_resource1));
		if (result < zero)
			return;
	}
	{
		Int result = BfmeShaderLoader::LoadAndCreateD3DShader("shaders\\Trees.pso", reinterpret_cast<unsigned long *>(&self->m_resource0));
		if (result < zero)
			return;
	}
	{
		Int result = BfmeVertexShaderLoader::LoadAndCreateD3DShader("shaders\\Trees_darken.vso", reinterpret_cast<unsigned long *>(&self->m_resource2));
		if (result < zero)
			return;
	}
	{
		Int result = BfmeVertexShaderLoader::LoadAndCreateD3DShader("shaders\\Trees_lighten.vso", reinterpret_cast<unsigned long *>(&self->m_resource3));
		if (result < zero)
			return;
	}
}
...
//=============================================================================
// ?removeTreesForConstruction@W3DTreeBuffer@@QAEXPBUCoord3D@@ABVGeometryInfo@@M@Z present-unmatched
...
//=============================================================================
// ?addTreeType@W3DTreeBuffer@@QAEHPBVW3DTreeDrawModuleData@@@Z present-unmatched
...
//=============================================================================
// ?addTree@W3DTreeBuffer@@QAEXW4DrawableID@@UCoord3D@@MMMPBVW3DTreeDrawModuleData@@@Z present-unmatched
...
//=============================================================================
// ?updateTreePosition@W3DTreeBuffer@@QAE_NW4DrawableID@@UCoord3D@@M@Z present-unmatched
...
//=============================================================================
// ?drawTrees@W3DTreeBuffer@@QAEXPAVCameraClass@@PAV?$RefMultiListIterator@VRenderObjClass@@@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?applyTopplingForce@W3DTreeBuffer@@IAEXPAUTTree@@PBUCoord3D@@MI@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?updateTopplingTree@W3DTreeBuffer@@IAEXPAUTTree@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@W3DTreeBuffer@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@W3DTreeBuffer@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@W3DTreeBuffer@@MAEXXZ present-unmatched
