...
//=============================================================================
// ?freeIndexVertexBuffers@HeightMapRenderObjClass@@IAEXXZ present-unmatched
...
/** Frees the w3d resources used to draw the terrain. */
//=============================================================================
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/HeightMapRenderObjClass_freeMapResources.cpp
...
//=============================================================================
// ?doTheDynamicLight@HeightMapRenderObjClass@@IAEIPAUVertexFormatXYZDUV2@@0PAVVector3@@1QAPAVW3DDynamicLight@@H@Z present-unmatched
...
//=============================================================================
// ?getXWithOrigin@HeightMapRenderObjClass@@IAEHH@Z present-unmatched
...
is confusing, but it makes sliding the map 10x faster.  */
//=============================================================================
// ?getYWithOrigin@HeightMapRenderObjClass@@IAEHH@Z present-unmatched
...
*/
//=============================================================================
// ?updateVB@HeightMapRenderObjClass@@IAEHPAVDX8VertexBufferClass@@PADHHHHHHPAVWorldHeightMap@@PAV?$RefMultiListIterator@VRenderObjClass@@@@@Z present-unmatched
...
*/
// ?updateVBForLight@HeightMapRenderObjClass@@IAEHPAVDX8VertexBufferClass@@PADHHHHHHQAPAVW3DDynamicLight@@H@Z present-unmatched
...
// ?updateVBForLightOptimized@HeightMapRenderObjClass@@IAEHPAVDX8VertexBufferClass@@PADHHHHHHQAPAVW3DDynamicLight@@H@Z present-unmatched
...
*/
// ?doPartialUpdate@HeightMapRenderObjClass@@UAEXABUIRegion2D@@PAVWorldHeightMap@@PAV?$RefMultiListIterator@VRenderObjClass@@@@@Z present-unmatched
...
The vertex coordinates and texture coordinates, as well as static lighting are updated.
*/
// ?updateBlock@HeightMapRenderObjClass@@UAEHHHHHPAVWorldHeightMap@@PAV?$RefMultiListIterator@VRenderObjClass@@@@@Z present-unmatched
...
//=============================================================================
// byte-exact reconstruction: game/GameEngine/Source/Common/HeightMapRenderObjClassDestructorThunk.cpp
...
//=============================================================================
// ??0HeightMapRenderObjClass@@QAE@XZ present-unmatched
HeightMapRenderObjClass::HeightMapRenderObjClass(void):
m_extraBlendTilePositions(NULL),
...
//=============================================================================
// ?adjustTerrainLOD@HeightMapRenderObjClass@@UAEXH@Z present-unmatched
...
//=============================================================================
// ?ReleaseResources@HeightMapRenderObjClass@@UAEXXZ present-unmatched
...
//=============================================================================
// ?ReAcquireResources@HeightMapRenderObjClass@@UAEXXZ present-unmatched
...
//=============================================================================
// ?reset@HeightMapRenderObjClass@@UAEXXZ present-unmatched
...
//=============================================================================
// ?oversizeTerrain@HeightMapRenderObjClass@@UAEXH@Z present-unmatched
...
//=============================================================================
// ?initHeightData@HeightMapRenderObjClass@@UAEHHHPAVWorldHeightMap@@PAV?$RefMultiListIterator@VRenderObjClass@@@@_N@Z present-unmatched
...
//=============================================================================
// ?On_Frame_Update@HeightMapRenderObjClass@@UAEXXZ present-unmatched
...
//=============================================================================
// ?staticLightingChanged@HeightMapRenderObjClass@@UAEXXZ present-unmatched
...
is rendered. */
//=============================================================================
// ?updateCenter@HeightMapRenderObjClass@@UAEXPAVCameraClass@@PAV?$RefMultiListIterator@VRenderObjClass@@@@@Z present-unmatched
...
// ?Render@HeightMapRenderObjClass@@ present-unmatched
...
// ?renderTerrainPass@HeightMapRenderObjClass@@ present-unmatched
...
// ?renderExtraBlendTiles@HeightMapRenderObjClass@@ present-unmatched
