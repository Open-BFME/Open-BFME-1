...
//
// W3DTreeBuffer destructor, retail 0x00736590 (260 bytes): the scalar deleting destructor at
// 0x007366F0 is slot 0 of vtable 0x01121608, whose name getter returns "W3DTreeBuffer".
//
...
#pragma comment(linker, "/alternatename:?loadPostProcess@W3DTreeBuffer@@UAEXXZ=?j_0001a7d5@@YAXXZ")
#pragma comment(linker, "/alternatename:?getSnapshotName@W3DTreeBuffer@@UBEPBDXZ=?j_000312be@@YAXXZ")
#pragma comment(linker, "/alternatename:?xfer@W3DTreeBuffer@@UAEXPAVXfer@@@Z=?j_00049481@@YAXXZ")
...
// ??1W3DTreeBuffer@@UAE@XZ
W3DTreeBuffer::~W3DTreeBuffer(void)
{
	typedef void (W3DTreeBuffer::*FreeThunk)(void);
	union {
		void (*function)(void);
		FreeThunk member;
	} freeCast;
