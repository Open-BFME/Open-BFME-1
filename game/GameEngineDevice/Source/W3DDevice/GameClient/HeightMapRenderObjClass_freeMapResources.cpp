// cl: /DNDEBUG /MD /EHsc
// readable body of ?freeMapResources@HeightMapRenderObjClass@@UAEHXZ: game/GameEngineDevice/Source/W3DDevice/GameClient/HeightMap.cpp
...
//
// The W3DTerrainBackground tile array at +0x30D8 goes first, between a bare radar-reset lock and
...
// upstream layout: inputs/reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngineDevice/Include/W3DDevice/GameClient/HeightMap.h
...
private:
	...
	W3DTerrainBackground *m_tiles;			// +0x30D8
...
Int HeightMapRenderObjClass::freeMapResources(void)
{
	...
	if (m_bfmeIndices)
	{
		deleteTerrainIndexArray(m_bfmeIndices);
