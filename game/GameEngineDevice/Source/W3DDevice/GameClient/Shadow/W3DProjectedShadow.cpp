...
Bool W3DProjectedShadowManager::init( void )
{
	...
	// BFME stops here: the retail body @0x7AF630 returns straight after storing
	// the camera, with no SpecialRenderInfoClass allocated.
...
*/
// ?queueDecal@W3DProjectedShadowManager@@ present-unmatched
...
// ?renderShadows@W3DProjectedShadowManager@@QAEHAAVRenderInfoClass@@@Z matched 1333 bytes (Open-BFME5)
__declspec(naked) Int W3DProjectedShadowManager::renderShadows(RenderInfoClass &)
{
	__asm
	{
		__emit 0x83;
...
// byte-exact reconstruction: game/GameEngineDevice/Source/W3DDevice/GameClient/Shadow/W3DProjectedShadowUpdateTextureThunk.cpp
