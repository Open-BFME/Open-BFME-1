...
`targets/game/reverse/carved.csv` independently records 523 for this body. Keep both facts
...
`game/` source is byte-identical in the new snapshot. Keep same-file edits,
