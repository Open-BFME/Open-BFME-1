...
`game/GameEngine/Source/Common/Rva0036BD50ShroudGate.cpp` compiled to 96/96 matching bytes with five aligned relocations. The strict `tools/add_match.py` scoped gate resolved all five against existing symbols. No new pin or semantic class assertion was needed.
