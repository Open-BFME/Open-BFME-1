...
// seven absolute switch targets at 0x00879C48, then 25 selector bytes at
// 0x00879C64. The 893-byte region ends at 0x00879C7D (three INT3 bytes).
// Remaining mismatch: +0x206 and +0x20C exchange mantissa[1]/mantissa[3]
// loads in the inlined IsMantissaZero reduction. No semantic difference.
// Key correction: arithmetic is outside the unequal-exponent else branch.
// This bank includes the existing TU so its static helper ABI stays reproducible.
/*
** emfloat.c
