...
/** Rebuild the render sentence(s) when our text or font has changed, and
	* report through needNewPolys whether the caller must redo the texture
	* quads.  Returns FALSE if there is no text to draw at all. */
//=============================================================================
// ?checkForChangedTextData@W3DDisplayString@@ 0x006F4F50
...
// BFME's retail Render2DSentenceClass::Draw_Sentence takes four gradient-
// corner colors (?Draw_Sentence@Render2DSentenceClass@@QAEXHHHH@Z, still a
// dump) rather than the vendored ZH single-uint32 overload; reinterpreting
// m_textRenderer's address through this minimal shim reaches that method
// without touching the shared vendored header.
