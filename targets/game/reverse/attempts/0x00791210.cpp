// ?W3DGadgetHorizontalSliderImageDrawA@@YAXPAVGameWindow@@PAVWinInstanceData@@@Z
// partial score=0.84 date=2026-09-15
...
// ?W3DGadgetHorizontalSliderImageDrawA@@YAXPAVGameWindow@@PAVWinInstanceData@@@Z
class Rva00791210GameWindow
{
public:
	const Image *getEnabledImage( Int index )
	{
		return *(const Image **)((unsigned char *)this + 0x48 + index * 0xC);
	}
...
const Image *(*Rva00791210KeepHiliteCenter)( GameWindow * ) = &GadgetSliderGetHiliteImageCenter;
const Image *(*Rva00791210KeepHiliteRight)( GameWindow * ) = &GadgetSliderGetHiliteImageRight;
const Image *(*Rva00791210KeepHiliteSmallCenter)( GameWindow * ) = &GadgetSliderGetHiliteImageSmallCenter;
																				 ...
																				 WinInstanceData *instData )
{
	...
	if( BitTest( window->winGetStatus(), WIN_STATUS_ENABLED ) == FALSE )
	{
		...
		leftImageRight = leftImageLeft					= ((Rva00791210GameWindow *)window)->getDisabledImage( 0 );
		rightImageRight = rightImageLeft				= ((Rva00791210GameWindow *)window)->getDisabledImage( 1 );
	...
	else //if( BitTest( instData->getState(), WIN_STATE_HILITED ) )
	{
		...
		leftImageLeft					= ((Rva00791210GameWindow *)window)->getHiliteImage( 0 );
		rightImageLeft				= ((Rva00791210GameWindow *)window)->getHiliteImage( 1 );
		centerImageLeft				= ((Rva00791210GameWindow *)window)->getHiliteImage( 2 );
		smallCenterImageLeft	= ((Rva00791210GameWindow *)window)->getHiliteImage( 3 );

		leftImageRight					= ((Rva00791210GameWindow *)window)->getEnabledImage( 0 );
		rightImageRight				= ((Rva00791210GameWindow *)window)->getEnabledImage( 1 );
		centerImageRight				= ((Rva00791210GameWindow *)window)->getEnabledImage( 2 );
		smallCenterImageRight	= ((Rva00791210GameWindow *)window)->getEnabledImage( 3 );
	...
	for( i = 0; i < pieces; i++ )
	{
		...
		((Rva00791210Display *)TheDisplay)->setClipRegion(&clipLeft);
		TheWindowManager->winDrawImage( centerImageLeft, 
																		start.x, start.y,
																		end.x, end.y );
		((Rva00791210Display *)TheDisplay)->setClipRegion(&clipRight);
	...
	((Rva00791210Display *)TheDisplay)->enableClipping(FALSE);
