...
`game/GameEngine/Include/GameLogic/TerrainLogic.h` and
`game/GameEngine/Source/GameLogic/Map/TerrainLogic.cpp` are named
`TerrainLogic::findFarthestEdgePoint(const Coord3D*) const` and have this
behavior and ABI.

`game/GameEngine/Source/Common/BfmeConv1270.cpp` already reproduces all 151
