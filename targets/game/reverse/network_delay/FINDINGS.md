...
- `game/GameEngine/Source/GameNetwork/native_network.cpp` contains the first byte-matched BFME-native
...
- `game/GameEngine/Source/GameNetwork/native_network_callback.cpp` contains `BFMENetworkRegisteredCallback`
  at `0x0065C260`.
- `game/GameEngine/Source/GameNetwork/native_network_dispatcher.cpp` contains `BFMENetworkBackend::dispatchEvents`
  at `0x0065CA50` and its EH catch thunk at `0x0065D6F3`.
- `game/GameEngine/Source/GameNetwork/native_netcommandmsg.cpp` contains the BFME command type `7`
...
- `game/GameEngine/Source/GameNetwork/native_connection_timing.cpp` contains the first byte-matched BFME
...
- `game/GameEngine/Source/GameNetwork/native_network_interface.cpp` contains the native BFME `Network`
...
Carried by `inputs/reference/shims/disconnectmanager`. `turnOffScreen` (`0x0066B270`)
...
`inputs/reference/shims/framedata`.
...
thunk was pinned explicitly in targets/game/reverse/symbols.csv.
