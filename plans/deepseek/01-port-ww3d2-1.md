# Agent `port-ww3d2-1`: port WW3D2 group 1 (aabtree.cpp … decalmsh.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-ww3d2-1`**
(use it for `PROGRESS-port-ww3d2-1.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-ww3d2-1.md`.
