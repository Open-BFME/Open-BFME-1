# Agent `port-ww3d2-6`: port WW3D2 group 6 (stripoptimizer.cpp … ww3dformat.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-ww3d2-6`**
(use it for `PROGRESS-port-ww3d2-6.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-ww3d2-6.md`.
