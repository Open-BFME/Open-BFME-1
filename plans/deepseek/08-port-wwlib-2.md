# Agent `port-wwlib-2`: port WWLib group 2 (LaunchWeb.cpp … regexpr.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-wwlib-2`**
(use it for `PROGRESS-port-wwlib-2.md` and `--author` checks).

## Your territory — own ONLY these

Reference directory: `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWLib/`
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-wwlib-2.md`.
