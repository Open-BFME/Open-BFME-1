# Agent `port-wwlib-1`: port WWLib group 1 (_convert.cpp … keyboard.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-wwlib-1`**
(use it for `PROGRESS-port-wwlib-1.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-wwlib-1.md`.
