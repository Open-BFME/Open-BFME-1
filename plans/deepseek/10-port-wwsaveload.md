# Agent `port-wwsaveload`: port WWSaveLoad (save/load, persist, definitions)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-wwsaveload`**
(use it for `PROGRESS-port-wwsaveload.md` and `--author` checks).

## Your territory — own ONLY these

Reference directory: `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWSaveLoad/`
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-wwsaveload.md`.
