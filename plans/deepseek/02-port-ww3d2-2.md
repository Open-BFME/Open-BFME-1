# Agent `port-ww3d2-2`: port WW3D2 group 2 (decalsys.cpp … hcanim.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-ww3d2-2`**
(use it for `PROGRESS-port-ww3d2-2.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-ww3d2-2.md`.
