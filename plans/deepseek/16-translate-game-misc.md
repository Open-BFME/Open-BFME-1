# Agent `translate-game-misc`: translate assorted game classes asm → C++

**Read `plans/deepseek/README.md` first.** Your agent name is **`translate-game-misc`**. Your
**exclusive** file ownership:

- `src/game/xfer.cpp`  (~5)
- `src/game/memory_pool.cpp`  (~5)
- `src/game/ascii_string.cpp`  (~2)
- `src/game/game_client_random_variable.cpp`  (~1)
- `src/game/debug.cpp`  (~1)
...
4. Commit via the README's SAFE PUSH RITUAL. Update `PROGRESS-translate-game-misc.md`.
