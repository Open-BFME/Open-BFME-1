# Agent `port-wwlib-3`: port WWLib group 3 (registry.cpp … xsurface.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-wwlib-3`**
(use it for `PROGRESS-port-wwlib-3.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-wwlib-3.md`.
