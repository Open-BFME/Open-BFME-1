# Agent `port-ww3d2-5`: port WW3D2 group 5 (render2dsentence.cpp … streakRender.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-ww3d2-5`**
(use it for `PROGRESS-port-ww3d2-5.md` and `--author` checks).

## Your territory — own ONLY these

Reference directory: `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WW3D2/`
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-ww3d2-5.md`.
