# Agent `port-ww3d2-3`: port WW3D2 group 3 (hlod.cpp … meshgeometry.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-ww3d2-3`**
(use it for `PROGRESS-port-ww3d2-3.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-ww3d2-3.md`.
