# Agent `translate-stringbase`: translate StringBase asm → C++

**Read `plans/deepseek/README.md` first.** Your agent name is **`translate-stringbase`**. Your
**exclusive** file ownership:

- `src/game/string_base.cpp`  (~69 naked blocks; the remainder is the hard allocator/mutex/compare tier)
...
4. Commit via the README's SAFE PUSH RITUAL. Update `PROGRESS-translate-stringbase.md`.
