# Agent `port-ww3d2-4`: port WW3D2 group 4 (meshmatdesc.cpp … render2d.cpp)
...
rules. This file is your **exclusive territory**. Your agent name is **`port-ww3d2-4`**
(use it for `PROGRESS-port-ww3d2-4.md` and `--author` checks).
...
8. Commit via the README's **SAFE PUSH RITUAL**. Update `PROGRESS-port-ww3d2-4.md`.
