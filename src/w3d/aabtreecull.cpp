...
**
*************************************************************************/
// ?AABTreeCullSystemClass::AABTreeCullSystemClass absent-from-retail
...
// ?AABTreeCullSystemClass::Add_Object_Internal absent-from-retail
...
// ?AABTreeCullSystemClass::Remove_Object_Internal absent-from-retail
...
// ?AABTreeCullSystemClass::Update_Culling absent-from-retail
...
// ?AABTreeCullSystemClass::Collect_Objects absent-from-retail
...
// ?AABTreeCullSystemClass::Partition_Node_Count absent-from-retail
int AABTreeCullSystemClass::Partition_Node_Count(void) const
{
	return Partition_Node_Count_Recursive(RootNode);
}

// ?AABTreeCullSystemClass::Partition_Tree_Depth absent-from-retail
...
// ?AABTreeCullSystemClass::Object_Count absent-from-retail
int AABTreeCullSystemClass::Object_Count(void) const
{
	return ObjectCount;
}

// ?AABTreeCullSystemClass::Partition_Node_Count_Recursive absent-from-retail
...
// ?AABTreeCullSystemClass::Partition_Tree_Depth_Recursive absent-from-retail
...
// ?AABTreeCullSystemClass::Add_Object_Recursive absent-from-retail
...
// ?AABTreeCullSystemClass::Add_Loaded_Object absent-from-retail
...
// ?AABTreeCullSystemClass::Re_Partition absent-from-retail
...
// ?AABTreeCullSystemClass::Update_Bounding_Boxes absent-from-retail
void AABTreeCullSystemClass::Update_Bounding_Boxes(void)
{
	Update_Bounding_Boxes_Recursive(RootNode);
}

// ?AABTreeCullSystemClass::Get_Bounding_Box absent-from-retail
...
// ?AABTreeCullSystemClass::Get_Node_Bounds absent-from-retail
...
// ?AABTreeCullSystemClass::Reset_Statistics absent-from-retail
...
// ?AABTreeCullSystemClass::Get_Statistics absent-from-retail
const AABTreeCullSystemClass::StatsStruct & AABTreeCullSystemClass::Get_Statistics(void)
{
	return Stats;
}

// ?AABTreeCullSystemClass::Collect_Objects_Recursive absent-from-retail
...
// ?AABTreeCullSystemClass::Update_Bounding_Boxes_Recursive absent-from-retail
...
// ?AABTreeCullSystemClass::Load absent-from-retail
...
// ?AABTreeCullSystemClass::Load_Nodes absent-from-retail
...
// ?AABTreeCullSystemClass::Save absent-from-retail
...
// ?AABTreeCullSystemClass::Save_Nodes absent-from-retail
...
// ?AABTreeCullSystemClass::Load_Object_Linkage absent-from-retail
...
// ?AABTreeCullSystemClass::Save_Object_Linkage absent-from-retail
...
// ?AABTreeCullSystemClass::Re_Index_Nodes absent-from-retail
...
// ?AABTreeCullSystemClass::Re_Index_Nodes_Recursive absent-from-retail
...
**
*************************************************************************/
// ?AABTreeNodeClass::AABTreeNodeClass absent-from-retail
...
// ?AABTreeNodeClass::Compute_Bounding_Box absent-from-retail
...
// ?AABTreeNodeClass::Compute_Local_Bounding_Box absent-from-retail
...
// ?AABTreeNodeClass::Compute_Volume absent-from-retail
float AABTreeNodeClass::Compute_Volume(void)
{
	return Box.Volume();
}

// ?AABTreeNodeClass::Add_Object absent-from-retail
...
// ?AABTreeNodeClass::Remove_Object absent-from-retail
...
// ?AABTreeNodeClass::Transfer_Objects absent-from-retail
...
// ?AABTreeNodeClass::Object_Count absent-from-retail
...
// ?AABTreeNodeClass::Peek_Object absent-from-retail
...
// ?AABTreeNodeClass::Partition absent-from-retail
...
// ?AABTreeNodeClass::Split_Objects absent-from-retail
...
// ?AABTreeIterator::AABTreeIterator absent-from-retail
...
// ?AABTreeIterator::Reset absent-from-retail
void AABTreeIterator::Reset(void)
{
	CurNodeIndex = 0;
}

// ?AABTreeIterator::Enter_Parent absent-from-retail
...
// ?AABTreeIterator::Enter_Sibling absent-from-retail
...
// ?AABTreeIterator::Has_Front_Child absent-from-retail
...
// ?AABTreeIterator::Enter_Front_Child absent-from-retail
...
// ?AABTreeIterator::Has_Back_Child absent-from-retail
...
// ?AABTreeIterator::Enter_Back_Child absent-from-retail
...
// ?AABTreeIterator::Get_Current_Node_Index absent-from-retail
int AABTreeIterator::Get_Current_Node_Index(void)
{
	return CurNodeIndex;
}

// ?AABTreeIterator::Get_Current_Box absent-from-retail
void AABTreeIterator::Get_Current_Box(AABoxClass * set_box)
{
	Tree->Get_Node_Bounds(CurNodeIndex,set_box);	
}

// ?AABTreeIterator::validate absent-from-retail
