...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1FontLibrary@@UAE@XZ present-unmatched
FontLibrary::~FontLibrary( void )
{
...
//-------------------------------------------------------------------------------------------------
// ?init@FontLibrary@@UAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reset@FontLibrary@@UAEXXZ present-unmatched
...
/** Get a font from our list, if we don't have that font loaded we will
	* attempt to load it */
//-------------------------------------------------------------------------------------------------
// ?getFont@FontLibrary@@QAEPAVGameFont@@VAsciiString@@H_N@Z present-unmatched
