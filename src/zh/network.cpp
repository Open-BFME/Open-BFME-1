 ...
 * The constructor.
 */
// ??0Network@@QAE@XZ present-unmatched
Network::Network()
{
 ...
 * The destructor.
 */
// ??1Network@@UAE@XZ present-unmatched
Network::~Network()
{
	deinit();
}
 ...
 */
// ?deinit@Network@@QAE_NXZ present-unmatched
 ...
 */
// ?reset@Network@@UAEXXZ present-unmatched
void Network::reset() {
	init();
}
 ...
 */
// ?init@Network@@UAEXXZ present-unmatched
void Network::init()
{
	if (!deinit())
	{
...
// ?setSawCRCMismatch@Network@@UAEXXZ present-unmatched
 ...
 */
// ?parseUserList@Network@@UAEXPBVGameInfo@@@Z present-unmatched
 ...
 */
// ?startGame@Network@@UAEXXZ present-unmatched
 ...
 */
// ?setLocalAddress@Network@@UAEXII@Z present-unmatched
 ...
 */
// ?initTransport@Network@@UAEXXZ present-unmatched
...
// ?attachTransport@Network@@UAEXPAVTransport@@@Z present-unmatched
 ...
 */
// ?isTransferCommand@Network@@IAE_NPAVGameMessage@@@Z present-unmatched
 ...
 */
// ?GetCommandsFromCommandList@Network@@IAEXXZ present-unmatched
...
// ?getExecutionFrame@Network@@UAEHXZ present-unmatched
 ...
 */
// ?processCommand@Network@@IAE_NPAVGameMessage@@@Z present-unmatched
 ...
 */
// ?AllCommandsReady@Network@@IAE_NI@Z present-unmatched
 ...
 */
// ?RelayCommandsToCommandList@Network@@IAEXI@Z present-unmatched
 ...
 */
// ?processFrameSynchronizedNetCommand@Network@@IAEXPAVNetCommandRef@@@Z present-unmatched
...
// ?processRunAheadCommand@Network@@IAEXPAVNetRunAheadCommandMsg@@@Z present-unmatched
...
// ?processDestroyPlayerCommand@Network@@IAEXPAVNetDestroyPlayerCommandMsg@@@Z present-unmatched
 ...
 */
// ?update@Network@@UAEXXZ present-unmatched
...
// ?liteupdate@Network@@UAEXXZ present-unmatched
...
// ?endOfGameCheck@Network@@IAEXXZ present-unmatched
...
// ?timeForNewFrame@Network@@IAE_NXZ present-unmatched
 ...
 */
// ?isFrameDataReady@Network@@UAE_NXZ present-unmatched
 ...
 */
// ?getIncomingBytesPerSecond@Network@@UAEMXZ present-unmatched
 ...
 */
// ?getIncomingPacketsPerSecond@Network@@UAEMXZ present-unmatched
 ...
 */
// ?getOutgoingBytesPerSecond@Network@@UAEMXZ present-unmatched
 ...
 */
// ?getOutgoingPacketsPerSecond@Network@@UAEMXZ present-unmatched
 ...
 */
// ?getUnknownBytesPerSecond@Network@@UAEMXZ present-unmatched
 ...
 */
// ?getUnknownPacketsPerSecond@Network@@UAEMXZ present-unmatched
 ...
 */
// ?getPacketArrivalCushion@Network@@UAEIXZ present-unmatched
 ...
 */
// ?sendChat@Network@@UAEXVUnicodeString@@H@Z present-unmatched
 ...
 */
// ?sendDisconnectChat@Network@@UAEXVUnicodeString@@@Z present-unmatched
void Network::sendDisconnectChat(UnicodeString text) {
	m_conMgr->sendDisconnectChat(text);
}

// send a file.  woohoo.
// ?sendFile@Network@@UAEXVAsciiString@@EG@Z present-unmatched
...
// send a file.  woohoo.
// ?sendFileAnnounce@Network@@UAEGVAsciiString@@E@Z present-unmatched
...
// ?getFileTransferProgress@Network@@UAEHHVAsciiString@@@Z present-unmatched
Int Network::getFileTransferProgress(Int playerID, AsciiString path)
{
	return m_conMgr->getFileTransferProgress(playerID, path);
}

// ?areAllQueuesEmpty@Network@@UAE_NXZ present-unmatched
 ...
 */
// ?quitGame@Network@@UAEXXZ present-unmatched
...
// ?selfDestructPlayer@Network@@UAEXH@Z present-unmatched
 ...
 */
// ?voteForPlayerDisconnect@Network@@UAEXH@Z present-unmatched
...
// ?updateLoadProgress@Network@@UAEXH@Z present-unmatched
...
// ?loadProgressComplete@Network@@UAEXXZ present-unmatched
...
// ?sendTimeOutGameStart@Network@@UAEXXZ present-unmatched
...
// ?getLocalPlayerID@Network@@UAEIXZ present-unmatched
...
// ?getPlayerName@Network@@UAE?AVUnicodeString@@H@Z present-unmatched
...
// ?getNumPlayers@Network@@UAEHXZ present-unmatched
...
// ?getSlotAverageFPS@Network@@UAEHH@Z present-unmatched
...
#if defined(_DEBUG) || defined(_INTERNAL)
// ?toggleNetworkOn@Network@@ present-unmatched
...
// ?notifyOthersOfCurrentFrame@Network@@UAEXXZ present-unmatched
...
// ?notifyOthersOfNewFrame@Network@@UAEXI@Z present-unmatched
