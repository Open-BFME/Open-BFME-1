...
SCAFFOLD_NOTE = re.compile(r"\s*gen-dump\s*(?:$|[;,])")
...
def is_scaffold_row(row):
    ...
    # such as "gen-dump conversion; ..." on a row of real C++, is not the marker.
    return bool(SCAFFOLD_NOTE.match(row.get("notes") or ""))
