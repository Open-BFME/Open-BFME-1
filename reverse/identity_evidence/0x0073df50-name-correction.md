...
Evidence: the audit is recorded in reverse/re_attempts.log at 0x0073DF50; docs/naming_evidence.md requires address-bearing names when a shape is known but identity is not. The ret 8 boundary and the +0x104 field access do not establish the owner name.
