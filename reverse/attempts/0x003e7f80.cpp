// ?iterateCellsAlongLine@Pathfinder@@QAEHABUICoord2D@@0W4PathfindLayerEnum@@PAURva003E7F80Struct@@@Z
// partial score=0.851 date=2026-09-19
// cl: /DNDEBUG /MD
...
#pragma comment(linker, "/alternatename:?examine@Rva003E7F80Struct@@QAEHPAVPathfindCell@@0HH@Z=?examine@Rva003E5820Info@@QAEHPAVPathfindCell@@0HH@Z")
	...
	Rva003E7F80Struct *userData )
{
	...
	for (Int curpixel = 0; curpixel < numpixels; curpixel++)
	{
		...
		Int ret = userData->examine( from, to, x, y );
		if (ret != 0)
			return ret;
