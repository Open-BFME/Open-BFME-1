// ?iterateCellsAlongLine@Pathfinder@@QAEHABUICoord2D@@0W4PathfindLayerEnum@@PAUExamineCellsStruct@@@Z
// partial score=0.94 date=2026-09-19
// cl: /DNDEBUG /MD /EHs-c-
//
// Retail 0x003E2F30 is the cell-space line walk used while
// Pathfinder::examineNeighboringCells checks the direct route to a goal cell.
// The caller builds ExamineCellsStruct and retail invokes its four-argument
// cell callback through ILT 0x00010532, which reaches 0x003E0DD0.
...
#pragma comment(linker, "/alternatename:?cellCallback@ExamineCellsStruct@@QAEHPAVPathfindCell@@0HH@Z=?j_00010532@@YAXXZ")
