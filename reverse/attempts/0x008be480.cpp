...
class BfmeDerived1286 : public BfmeBase1286
{
public:
	~BfmeDerived1286();
...
private:
	...
	int m_value60;
	int m_value64;
	BfmeHeapString1286 *volatile m_heapString68;
	char m_padding6c[0x74 - 0x6c];
	unsigned char m_flags74;
};

BfmeDerived1286::~BfmeDerived1286()
{
	m_vtable = &g_bfmeDerived1286Vtable;
	BfmeHeapString1286 *heapString = m_heapString68;
	m_value24 = 0;
	m_value64 = 0;
	m_value60 = 0;
	if (heapString != 0) {
