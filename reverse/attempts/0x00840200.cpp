...
// Open-BFME5: _STL::basic_streambuf<char> xsgetn / xsputn / _M_xsputnc
// FILE*-specialized streambuf (STLport 4.5.3): _M_get at +4, _M_put at +8.
// xsgetn@0x840050 and xsputn@0x840150 landed exact.
// _M_xsputnc@0x840200 is a register-assignment near-miss (edi/ebp swap, 183 vs 178).
...
int basic_streambuf<char, char_traits<char> >::_M_xsputnc(char_type c, int n)
{
	...
	while (result < n)
	{
		...
		{
			int_type r = overflow((unsigned char)c);
			if (r == eofv)
				break;
			++result;
		}
