...
// The callback return value is unused by Player::iterateObjects.  The parent
// lane is correcting the separately reviewed body/ledger return type to int;
// this declaration keeps the current ledger resolvable while that integration
// lands independently.
extern void paralyzeTroop( Object *obj, void *userData );
