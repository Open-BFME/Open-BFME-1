...
public:
	...
	{
		return m_bfmeData == 0 || *(unsigned short *)(m_bfmeData + 4) == 0;
	}

	char *m_bfmeData;
};

extern void j_0001c792(void);
extern void j_0002b3e6(void);
extern void j_0003e531(void);
extern void j_0003c3d0(void);
extern void j_00033186(void);
extern void j_000279b7(void);
extern void j_0004959e(void);
extern void j_00036264(void);
extern void j_0001713e(void);
...
{
public:
	__forceinline AsciiString *rva003ad1a0(AsciiString *result)
	{
		typedef AsciiString *(BfmeElem40::*Function)(AsciiString *);
		union
		{
			void (*raw)(void);
			Function member;
		...
		fn.raw = j_000279b7;
		return (this->*fn.member)(result);
	}

	__forceinline AsciiString *rva003ad1d0(AsciiString *result)
	{
		typedef AsciiString *(BfmeElem40::*Function)(AsciiString *);
		union
		{
	...
	__forceinline AsciiString *rva003ad200(AsciiString *result)
	{
		typedef AsciiString *(BfmeElem40::*Function)(AsciiString *);
		union
		{
	...
	__forceinline AsciiString *rva003ad230(AsciiString *result)
	{
		typedef AsciiString *(BfmeElem40::*Function)(AsciiString *);
		union
		{
	...
	__forceinline ICoord2D *rva003ac9d0(ICoord2D *result)
	{
		typedef ICoord2D *(BfmeElem40::*Function)(ICoord2D *);
		union
		{
			void (*raw)(void);
			Function member;
	...
	AsciiString m_bfmeAt08;
	AsciiString m_bfmeAt0C;
	ICoord2D m_bfmeAt10;
	AsciiString m_bfmeAt18;
	unsigned char m_bfmeFlag1C;
	unsigned char m_bfmeFlag1D;
	char m_bfmePad1E[0x02];
	BfmePairWI m_bfmeAt20;
};

class BfmeElem40Vector
{
public:
...
public:
	...
	__forceinline void callJ0003E531(int value)
	{
		typedef void (Glo012F1028Type::*Function)(int);
		union
		{
			void (*raw)(void);
			Function member;
		...
		fn.raw = j_0003e531;
		(this->*fn.member)(value);
	}

	__forceinline void callJ00033186(ICoord2D pair,
		const AsciiString *first, bool flag, const AsciiString *second)
	{
		typedef void (Glo012F1028Type::*Function)(ICoord2D,
			const AsciiString *, bool, const AsciiString *);
		union
		{
			void (*raw)(void);
			Function member;
		...
		fn.raw = j_00033186;
		(this->*fn.member)(pair, first, flag, second);
	}

	__forceinline void callRva003BD9C0(AsciiString *first,
		AsciiString *second, Rva003BDA10Pair *pair)
	{
		typedef void (Glo012F1028Type::*Function)(AsciiString *,
			AsciiString *, Rva003BDA10Pair *);
		union
		{
			void (*raw)(void);
			Function member;
		...
		fn.raw = j_00036264;
		(this->*fn.member)(first, second, pair);
	}

	__forceinline void callJ0001713E(Rva003BDA10Pair *pair,
		AsciiString *name, void *extra)
	{
		typedef void (Glo012F1028Type::*Function)(Rva003BDA10Pair *,
			AsciiString *, void *);
		union
		{
			void (*raw)(void);
		...
		fn.raw = j_0001713e;
		(this->*fn.member)(pair, name, extra);
	}
};
...
void Glo012F1024Item::j_000250d6(void)
{
	...
	BfmeElem40Vector *records =
		(BfmeElem40Vector *)((char *)this + 0x14);
	for (Int index = 0, offset = 0;
			index < records->bfmeSize() / (Int)sizeof(BfmeElem40);
			++index, offset += sizeof(BfmeElem40))
	{
		BfmeElem40 *element =
			(BfmeElem40 *)(records->m_bfmeBegin + offset);
		AsciiString first;
		element->rva003ad230(&first);

		if (!first.bfmeEmpty())
		{
			if (element->m_bfmeFlag1D != 0)
			{
				AsciiString second;
				element->rva003ad1d0(&second);
				global->callJ0003E531((int)second);
			}
			else
			{
				AsciiString second;
				element->rva003ad1d0(&second);
				AsciiString again;
				element->rva003ad230(&again);
				ICoord2D position;
				element->rva003ac9d0(&position);
				global->callJ00033186(position, &again,
					element->m_bfmeFlag1C, &second);
			}
		}
		else
		{
			AsciiString fallback;
			element->rva003ad1a0(&fallback);
			if (!fallback.bfmeEmpty())
			{
				AsciiString name;
				element->rva003ad200(&name);
				AsciiString again;
				element->rva003ad1a0(&again);
				global->callRva003BD9C0(&again, &name,
					(Rva003BDA10Pair *)&element->m_bfmeAt20);
			}
			else
			{
				AsciiString name;
