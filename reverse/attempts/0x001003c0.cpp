...
extern void j_00003b52();
extern void j_0001ec2c();
extern void j_00024d70();
extern void j_000307e7();
extern void j_0003251f();
extern void j_000478ca();
extern GameLogic *TheBfmeGameLogic;

class BfmeSellFinalOverrideCall
{
};

typedef const Overridable *(BfmeSellFinalOverrideCall::*BfmeSellFinalOverrideFunction)() const;

class BfmeSellKindOfCall
{
};

class BfmeSellTemplateKind : public Overridable
{
public:
...
{
public:
	const BfmeSellTemplateKind *getTemplate() const
	{
		const BfmeSellTemplateKind *thingTemplate =
			*(const BfmeSellTemplateKind **)((const unsigned char *)this + 4);
		if (thingTemplate == NULL)
			return NULL;
		if (*(BfmeSellTemplateKind **)((unsigned char *)thingTemplate + 4) != NULL)
		{
			BfmeSellTemplateKind *nextTemplate =
				*(BfmeSellTemplateKind **)((unsigned char *)thingTemplate + 4);
			union
			{
				void *raw;
				BfmeSellFinalOverrideFunction member;
			} finalOverride;
			finalOverride.raw = (void *)j_000022bb;
			thingTemplate = (const BfmeSellTemplateKind *)
				(reinterpret_cast<const BfmeSellFinalOverrideCall *>(nextTemplate)->*
					finalOverride.member)();
		}
	...
	Bool isKindOf(KindOfType type) const
	{
		return getTemplate()->isKindOf(type);
	}
};

class BfmeSellStatusCall
{
};

class BfmeSellDeselectCall
{
};

class BfmeSellProductionCall
{
};

class BfmeSellDrawableCall
{
};

class BfmeSellIdleCall
{
};

class BfmeSellContainCall
{
public:
	virtual void slot00();
	virtual void slot01();
...
class BfmeSellProductionInterfaceCall
{
public:
	virtual void slot00();
	virtual void slot01();
...
typedef Bool (BfmeSellKindOfCall::*BfmeSellKindOfFunction)(KindOfType);
typedef void (BfmeSellStatusCall::*BfmeSellStatusFunction)(
	const ObjectStatusMaskType &, Bool);
typedef void (BfmeSellDeselectCall::*BfmeSellDeselectFunction)(
	Object *, PlayerMaskType, Bool);
typedef ProductionUpdateInterface *
	(BfmeSellProductionCall::*BfmeSellProductionFunction)();
...
void BuildAssistant::sellObject( Object *obj )
{
	...
	if (reinterpret_cast<BfmeSellThing *>(obj)->isKindOf(KINDOF_STRUCTURE) == FALSE)
		return;

	{
		...
		{
			void *raw;
			BfmeSellKindOfFunction member;
		} kindOf;
		kindOf.raw = (void *)j_0003251f;
		if ((reinterpret_cast<BfmeSellKindOfCall *>(obj)->*
			kindOf.member)((KindOfType)0x99) != FALSE)
			return;
	}
	...
	*(Real *)((unsigned char *)obj + 0x220) = 99.9f;
	register ObjectSellInfo *allocated =
		(ObjectSellInfo *)::operator new(sizeof(ObjectSellInfo));
	if (allocated != NULL)
	{
		allocated->m_id = (ObjectID)0;
		allocated->m_sellFrame = 0;
		*(void **)allocated = (void *)0x010860c0;
	}
	sellInfo = allocated;
	sellInfo->m_id = *(ObjectID *)((unsigned char *)obj + 0x74);
	sellInfo->m_sellFrame = TheBfmeGameLogic->getFrame();
	m_sellList.push_front(sellInfo);

	unsigned int statusWords[3];
	statusWords[0] = 0;
	statusWords[2] = 0;
	statusWords[1] = 0;
	statusWords[1] |= 0x80008;
	{
		union
		{
			void *raw;
			BfmeSellStatusFunction member;
		} setStatus;
		setStatus.raw = (void *)j_000307e7;
		(reinterpret_cast<BfmeSellStatusCall *>(obj)->*setStatus.member)(
			*(ObjectStatusMaskType *)statusWords, TRUE);
	}
	{
		union
		{
			void *raw;
			BfmeSellDeselectFunction member;
		} deselect;
		deselect.raw = (void *)j_0001ec2c;
		(reinterpret_cast<BfmeSellDeselectCall *>(TheBfmeGameLogic)->*
			deselect.member)(obj, PLAYERMASK_ALL, TRUE);
	}
	...
	if (draw != NULL)
	{
		...
		{
			void *raw;
			BfmeSellDrawableFunction member;
		} animation;
		animation.raw = (void *)j_000478ca;
		(reinterpret_cast<BfmeSellDrawableCall *>(draw)->*
			animation.member)(7);
	}
	...
	ProductionUpdateInterface *production;
	{
		...
		{
			void *raw;
			BfmeSellProductionFunction member;
		} getProduction;
		getProduction.raw = (void *)j_00003b52;
		production = (reinterpret_cast<BfmeSellProductionCall *>(obj)->*
			getProduction.member)();
	}
	if (production != NULL)
		reinterpret_cast<BfmeSellProductionInterfaceCall *>(production)->
			cancelAndRefundAllProduction();

	AIUpdateInterface *ai =
		*(AIUpdateInterface **)((unsigned char *)obj + 0x204);
	if (ai != NULL)
	{
		union
		{
			void *raw;
			BfmeSellIdleFunction member;
		} idle;
		idle.raw = (void *)j_00024d70;
		(reinterpret_cast<BfmeSellIdleCall *>((unsigned char *)ai + 0x20)->*
			idle.member)(CMD_FROM_AI);
	}

	ContainModuleInterface *contain =
		*(ContainModuleInterface **)((unsigned char *)obj + 0x1fc);
	if (contain != NULL)
		reinterpret_cast<BfmeSellContainCall *>(contain)->onSelling();
