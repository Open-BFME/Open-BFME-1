...
extern const void *BfmeAptScreenInGameChatControlVftable[];
extern void *g_inGameChatScreen;
...
public:
	void showAptScreen( const AsciiString &name,
		InGameChatShowHolder callback );
	void showAptScreenWithArg( const AsciiString &name, void *argument,
		InGameChatArgHolder callback );
};

void inGameChatSetAptScreenRef( const AsciiString &name,
	InGameChatRefHolder callback );
