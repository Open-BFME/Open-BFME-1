// ?parseAmbientStreamDefinition@INI@@SAXPAV1@@Z
// partial score=0.88 date=2026-09-10
// cl: /O2 /Ob1 /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /Ireference/shims/iniexception

// Retail 0x000B1590 is the BFME INI parser for AmbientStream.  Its identity is
// anchored by the block's retail literals and the shared 21-field table at
// 0x010813F8; the AudioManager calls are the same BFME reference-return ABI as
// the neighboring AudioEvent, DialogEvent, StreamedSound and MusicTrack parsers.
