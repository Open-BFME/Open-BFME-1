// ?GameSpyPlayerInfoOverlayInit@@YAXPAVWindowLayout@@PAX@Z
...
//-------------------------------------------------------------------------------------------------
// ?GameSpyPlayerInfoOverlaySystem@@YA?AW4WindowMsgHandledType@@PAVGameWindow@@III@Z matched 816 bytes (Open-BFME5)
__declspec(naked) WindowMsgHandledType GameSpyPlayerInfoOverlaySystem(GameWindow *, UnsignedInt, WindowMsgData, WindowMsgData)
{
	__asm
	{
		__emit 0x6a;
