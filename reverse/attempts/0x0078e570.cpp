// ?drawBorder@Rva0078E570@@UAEXPAVGameWindow@@@Z
...
// The native UnicodeString return-value ABI is required here. The existing
// GameWindow::winGetText ledger entry resolves to the different receiver layout
// at 0x005CB9F0 (+4). This body calls ILT 0x00007E82 -> 0x00479B80 (+0x30).
// Do not land until that callee identity/pin conflict is repaired independently.
            ...
            case 0x40: { // GWS_ENTRY_FIELD
                ...
                if (((Rva00478520 *)window)->call()) {
                    ...
                    ((Rva0078E570ManagerSlots *)TheWindowManager)->getTextSize(
                        window->winGetFont(), window->winGetText(), &textWidth, 0, 0);
                    width -= textWidth + 6;
                    x += textWidth + 6;
                }
