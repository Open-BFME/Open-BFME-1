// ?_Deinit@DynamicVBAccessClass@@SAXXZ
...
{
	void Reset(void *source, void *origin);
	char body[0x40];
};

extern VertexBufferClass *BfmeDynamicVertexBuffers[15];
extern void *BfmeDynamicSlotSources[15];
extern bool BfmeDynamicVertexBufferInUse[15];
extern unsigned short BfmeDynamicVertexBufferSizes[15];
extern unsigned short BfmeDynamicVertexBufferOffsets[15];
extern BFMEDynamicVBSlot BfmeDynamicVBSlots[15];
extern SortingVertexBufferClass *BfmeDynamicSortingVertexBuffer;
extern bool BfmeDynamicSortingVertexBufferInUse;
extern unsigned short BfmeDynamicSortingVertexBufferSize;
extern unsigned short BfmeDynamicSortingVertexBufferOffset;
...
void DynamicVBAccessClass::_Deinit()
{
	for (unsigned i = 0; i < 15; ++i) {
		REF_PTR_RELEASE(BfmeDynamicVertexBuffers[i]);
		BfmeDynamicVertexBufferInUse[i] = false;
		BfmeDynamicVertexBufferSizes[i] = DEFAULT_VB_SIZE;
		BfmeDynamicVertexBufferOffsets[i] = 0;
		BfmeDynamicVBSlots[i].Reset(BfmeDynamicSlotSources[i], NULL);
	}

	REF_PTR_RELEASE(BfmeDynamicSortingVertexBuffer);
	BfmeDynamicSortingVertexBufferInUse = false;
	BfmeDynamicSortingVertexBufferSize = 0;
	BfmeDynamicSortingVertexBufferOffset = 0;
}
