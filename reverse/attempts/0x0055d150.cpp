// ??0BfmeAptScreenOnlineShell@@QAE@PAX@Z
...
// OnlineShell.apt, retail 0x0055D150, object 0x280 bytes.  The constructor is
// reached by the OnlineShell.apt factory at 0x00104C40 and installs the two
// APT interface views before registering the screen callbacks.
class __declspec(novtable) __multiple_inheritance BfmeAptScreenOnlineShell
	: public _bfme_AptGameWindow, public BfmeAptFunctorMarker
{
public:
...
BfmeAptScreenOnlineShell::BfmeAptScreenOnlineShell( void *context )
	: _bfme_AptGameWindow( context ), m_current( 0 ),
	  m_fileName( "OnlineLogin" )
{
	...
	*(const void ***)( (char *)this + 0x218 ) = (const void **)0x01108F44;
	...
	if( g_bfmeFlagMG == 0 )
	{
		...
		CampaignReviewRegistry *registry =
			(CampaignReviewRegistry *)( (char *)this + 0x218 );
		OnlineShellMethodBits methodBits;

		{
			methodBits.m_words[ 0 ] = 0x0044253C;
			methodBits.m_words[ 1 ] = 0;
			AsciiString name( "AptOnline::OnInitialized" );
			Rva0055CA70FunctorHolder holder(
				FunctorBinding( methodBits.m_method, (FunctorTarget *)this ) );
			registry->showAptScreen( name,
				*(CampaignReviewShowHolder *)(void *)&holder );
		}

		{
			methodBits.m_words[ 0 ] = 0x0040A58D;
			methodBits.m_words[ 1 ] = 0;
		...
		{
			methodBits.m_words[ 0 ] = 0x004074F0;
			methodBits.m_words[ 1 ] = 0;
		...
		{
			methodBits.m_words[ 0 ] = 0x00446402;
			methodBits.m_words[ 1 ] = 0;
		...
		{
			methodBits.m_words[ 0 ] = 0x004384C9;
			methodBits.m_words[ 1 ] = 0;
		...
		{
			methodBits.m_words[ 0 ] = 0x0042BA1C;
			methodBits.m_words[ 1 ] = 0;
			AsciiString name( "OnlineShellStartScreen" );
			Rva0055CAE0FunctorHolder holder(
				FunctorBinding( methodBits.m_method, (FunctorTarget *)this ) );
			registry->showAptScreenWithArg( name, (void *)0,
				*(CampaignReviewArgHolder *)(void *)&holder );
		}

		{
			...
			Rva0055CAE0FunctorHolder holder(
				FunctorBinding( methodBits.m_method, (FunctorTarget *)this ) );
			registry->showAptScreenWithArg( name, (void *)1,
				*(CampaignReviewArgHolder *)(void *)&holder );
		}
	}
