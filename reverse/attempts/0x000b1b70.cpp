// ?parseMusicTrackDefinition@INI@@SAXPAV1@@Z
// partial score=0.92 date=2026-09-16
// cl: /O2 /Ob1 /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /Ireference/shims/iniexception
//
// Retail 0x000B1B70 is INI::parseMusicTrackDefinition.  The INI block registry
// names it: BFME keeps the registry as a linked list of 12-byte rows whose head
// is the global at VA 0x0130CE50, and the row at 0x012A829C pairs the block
// name 'MusicTrack' with this address.
//
...
// Retail 0x000B1B70 is INI::parseMusicTrackDefinition from
...
void INI::parseMusicTrackDefinition(INI *ini)
{
	if (ini->getLoadType() == 2)
		throw INIException(3, (const char *)0x01081BC4);
