// ??0TightenPathStruct@@QAE@PAVPathfinder@@PAVObject@@PBVLocomotorSet@@W4PathfindLayerEnum@@PBUCoord3D@@@Z
// partial score=0.86 date=2026-09-01
// cl: /EHsc /GR-
...
struct TightenPathStruct
{
	...
	__declspec(noinline) TightenPathStruct(Pathfinder *pf, Object *o, const LocomotorSet *ls,
...
public:
	...
	void bfmeQuery(Object *obj, Int *radiusOut, Int *centerOut);
...
__declspec(noinline) TightenPathStruct::TightenPathStruct(Pathfinder *pf, Object *o,
	const LocomotorSet *ls, PathfindLayerEnum lay, const Coord3D *to) :
	pathfinder(pf),
	obj(o),
	locomotorSet(ls),
	layer(lay)
{
	...
	destPos.y = 0.0f;
	destPos.z = 0.0f;
	pathfinder->bfmeQuery(obj, &radius, &center);
	foundDest = false;
}
