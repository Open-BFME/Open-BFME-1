// ?d_009c2ce0@@YAXXZ
// partial score=0.9975 date=2026-09-22
// Rva009C2CE0: retail 0x009C2CE0..0x009C3626 (2374 bytes), hand-written MMX body.
...
void __cdecl Rva009C2CE0(const short *coeffs, const short *quant, short *out)
{
	__asm
	{
		push edx
