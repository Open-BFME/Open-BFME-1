// ?parseDialogDefinition@INI@@SAXPAV1@@Z
// partial score=0.88 date=2026-09-10
// cl: /O2 /Ob1 /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /Ireference/shims/iniexception

// Retail 0x000B1360 is INI::parseDialogDefinition from the BFME audio INI
// parser.  The block identity is anchored by DefaultDialog, the map.ini
// exception literal, and field table 0x010813F8.  The pointer virtuals below
// follow the independently matched AudioManager slot-70 declaration; the
// reference overloads preserve the source-level call syntax and inline away.
