...
//
// Retail 0x000B1360 is INI::parseDialogDefinition.  The INI block registry
...
// name 'DialogEvent' with this address.
//
...
// Retail 0x000B1360 is INI::parseDialogDefinition from
...
void INI::parseDialogDefinition(INI *ini)
{
	if (ini->getLoadType() == 2)
		throw INIException(3, (const char *)0x01081AA4);
