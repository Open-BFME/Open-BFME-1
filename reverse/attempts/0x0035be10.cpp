...
// twin reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/
...
public:
	...
	virtual BfmeAwakenLog *slot38( const void * );
	virtual void slot3C();
	virtual void slot40();
	virtual void slot44();
	virtual void slot48();
...
extern "C" bool __cdecl _bfme_debugReportingEnabled();
extern "C" void __cdecl _bfme_debugRecordCallsite( int );
...
bool __cdecl ScriptList::ParseScriptListDataChunk( DataChunkInput &file, DataChunkInfo *info, void *userData )
{
	...
	if( !(pInfo->numLists < 0x20) )
	{
		if( _bfme_debugReportingEnabled() )
		{
			...
			TheBfmeAwakenDebug->slot6C( 0, 0 )->slot38( (const void *)0x010E8CBC )->slot34( 0x20 )->slot4C( 2 );
		}
		return false;
	}
	...
	pInfo->readLists[cur] = newList;
	pInfo->numLists = 1 + *(volatile int *)&pInfo->numLists;
