...
// ?populateBuddyGames@@YAXXZ
// Retail 0x0062CCE0, 551 bytes. This is the canonical GeneralsMD body; the
// BFME dump's surrounding matched set::insert and clearBuddyGames boundaries
// establish the same TU and static BuddyGameSet ownership.
...
// Body in LobbyUtils_insertGame.asm (exact 1487B retail @ 0x0062DB90).
// Drift candidate 0x0062DA40 was INSIDE matched GrabWindowInfo (0x62D810/713).
Int insertGame( GameWindow *win, GameSpyStagingRoom *game, Bool showMap );
