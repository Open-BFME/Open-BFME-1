// ?iterateCellsAlongLine@Pathfinder@@AAEHABUICoord2D@@0W4PathfindLayerEnum@@PAUGroundPathPassableInfo@@@Z
// partial score=0.94 date=2026-09-18
// cl: /DNDEBUG /MD
//
// Pathfinder::iterateCellsAlongLine for GroundPathPassableInfo at retail
// 0x003E33F0. The private overload and its caller identify this body.
...
Int Pathfinder::iterateCellsAlongLine( const ICoord2D &start,
	...
	GroundPathPassableInfo *userData )
{
	...
	for (Int curpixel = 0; curpixel < numpixels; curpixel++)
	{
		...
		Int ret = ((GroundPathPassableStruct *)userData)->cellCallback(
			from, to, x, y);
		if (ret != 0)
			return ret;
