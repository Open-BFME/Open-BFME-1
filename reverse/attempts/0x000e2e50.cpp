...
// partial score=0.91 date=2026-09-15
// cl: /DNDEBUG /MD /EHsc /D_STLP_USE_STATIC_LIB /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Include /ICode/Libraries/Source/WWVegas/WWLib
// stlport
...
public:
	static __forceinline void retain( void *data ) throw()
	{
		if ( data != 0 )
		{
			PlayerTemplateSoundObject *object =
				(PlayerTemplateSoundObject *)data;
	...
	~PlayerTemplateSoundEvent() throw() {}
