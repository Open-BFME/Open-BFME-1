...
class Rva006E6C10 {
    char data[0x30];
public: Rva006E6C10(); void init(); void setFont(GameFont *);
};
...
void Rva00938620(AsciiString, AsciiString);
void Rva009EBC00(int);
void Rva00908E50(bool);
...
void W3DDisplay::init(void)
{
    ...
    d->slot34(32);
    {
        ...
        if (d->slot40()) Rva00908E50(false); else clipCursorToClient();
    }
