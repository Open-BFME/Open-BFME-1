...
// partial score=0.89 date=2026-09-01
...
extern void *g_optionsScreenLayout;
...
extern OptionsVersionView *g_optionsVersion;
...
void optionsSetAptScreenRef( const AsciiString &name,
	OptionsInitHolder callback );
	...
	: _bfme_AptGameWindow( context )
{
	...
	*(const void ***)( (char *)this + 0x218 ) =
	...
	m_field258 = 0;
	m_field25C = 0;
	((OptionPreferences *)( (char *)this + 0x260 ))->initialize();
	int *fields274 = m_fields274;
	fields274[ 0 ] = 0;
	fields274[ 1 ] = 0;
	fields274[ 2 ] = 0;
	fields274[ 3 ] = 0;
	...
	if( g_optionsScreenLayout == 0 )
	{
		...
		AsciiString name( "APT:VersionNum" );
		g_theWindowManager->bfme_setAptText( name, version );
	}
}
