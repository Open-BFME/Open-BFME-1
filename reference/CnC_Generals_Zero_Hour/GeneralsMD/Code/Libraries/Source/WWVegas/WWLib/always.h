...
// ----------------------------------------------------------------------------
// Open-BFME: BFME kept the W3D memory pools (retail $E static-init counts
// include the pool statics below) but built W3DMPO as an empty base: retail
// HLod/OBBox ctors store only the RenderObj+MultiList vtables, i.e. W3DMPO
// contributed no vptr. Force this variant in the active branch (the ZH
// glueEnforcer virtual is dropped — it would add a bogus vtable slot).
