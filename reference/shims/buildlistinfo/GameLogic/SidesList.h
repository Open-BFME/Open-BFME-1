...
*/
// BFME merges ZH's MemoryPoolObject and Snapshot into one base - the same
// fact TunnelTracker, TurretAI and Module all show - so BuildListInfo carries
// one vptr fewer and every member drops a dword: duplicate @0x36F6C0 reads
// five fields four bytes lower than this header puts them. deleteInstance
// comes from that merged base.
