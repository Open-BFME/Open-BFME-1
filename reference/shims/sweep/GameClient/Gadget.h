// Gadget.h -- BFME shadow shim. Verbatim ZH GeneralsMD header except two gadget
// messages inserted at the GLM/GCM boundary (see GLM_BFME_UNKNOWN_1/2 below).
/*
...
//	GLM_SET_TEXT, // Not used Removed just to make sure
	...
	GLM_GET_ITEM_DATA,
	GLM_SET_ITEM_DATA,
	GLM_BFME_UNKNOWN_1,	// BFME shadow shim: retail inserts two gadget messages here --
	GLM_BFME_UNKNOWN_2,	// GCM_ADD_ENTRY is 0x4022 in lotrbfme.exe vs 0x4020 in ZH. GLM block
						// unchanged (matched GLM_ADD_ENTRY/GLM_GET_TEXT pushes). Names unknown;
						// only the +2 shift of GCM_*/GEM_*/GPM_* is evidenced by retail code.
